...
namespace Pulumi.Ise.NetworkAccessAuthorizationGlobalException
{
    /// <summary>
    ...
    /// ```
    /// </summary>
    [IseResourceType("ise:NetworkAccessAuthorizationGlobalException/rule:Rule")]
    public partial class Rule : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("childrens")]
        public Output<ImmutableArray<Outputs.RuleChildren>> Childrens { get; private set; } = null!;
        ...
        public Rule(string name, RuleArgs? args = null, CustomResourceOptions? options = null)
            : base("ise:NetworkAccessAuthorizationGlobalException/rule:Rule", name, args ?? new RuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Rule(string name, Input<string> id, RuleState? state = null, CustomResourceOptions? options = null)
            : base("ise:NetworkAccessAuthorizationGlobalException/rule:Rule", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    {
        [Input("childrens")]
        private InputList<Inputs.RuleChildrenArgs>? _childrens;

        /// <summary>
        /// List of child conditions. `condition_type` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
        /// </summary>
        public InputList<Inputs.RuleChildrenArgs> Childrens
        {
            get => _childrens ?? (_childrens = new InputList<Inputs.RuleChildrenArgs>());
    ...
    {
        [Input("childrens")]
        private InputList<Inputs.RuleChildrenGetArgs>? _childrens;

        /// <summary>
        /// List of child conditions. `condition_type` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
        /// </summary>
        public InputList<Inputs.RuleChildrenGetArgs> Childrens
        {
            get => _childrens ?? (_childrens = new InputList<Inputs.RuleChildrenGetArgs>());
            set => _childrens = value;
        }
