...
namespace Pulumi.Ise.Allowed
{
    public static class GetProtocols
    {
        ...
        /// ```
        /// </summary>
        public static Task<GetProtocolsResult> InvokeAsync(GetProtocolsArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetProtocolsResult>("ise:Allowed/getProtocols:getProtocols", args ?? new GetProtocolsArgs(), options.WithDefaults());
        ...
        /// ```
        /// </summary>
        public static Output<GetProtocolsResult> Invoke(GetProtocolsInvokeArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetProtocolsResult>("ise:Allowed/getProtocols:getProtocols", args ?? new GetProtocolsInvokeArgs(), options.WithDefaults());
    }
