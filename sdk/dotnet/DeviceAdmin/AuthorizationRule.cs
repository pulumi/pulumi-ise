...
namespace Pulumi.Ise.DeviceAdmin
{
    ...
    /// ```
    /// </summary>
    [IseResourceType("ise:deviceadmin/authorizationRule:AuthorizationRule")]
    public partial class AuthorizationRule : global::Pulumi.CustomResource
    {
        ...
        public AuthorizationRule(string name, AuthorizationRuleArgs args, CustomResourceOptions? options = null)
            : base("ise:deviceadmin/authorizationRule:AuthorizationRule", name, args ?? new AuthorizationRuleArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private AuthorizationRule(string name, Input<string> id, AuthorizationRuleState? state = null, CustomResourceOptions? options = null)
            : base("ise:deviceadmin/authorizationRule:AuthorizationRule", name, state, MakeResourceOptions(options, id))
        {
        }
