...
namespace Pulumi.Ise.DeviceAdmin
{
    ...
    /// ```
    /// </summary>
    [IseResourceType("ise:deviceadmin/authorizationExceptionRule:AuthorizationExceptionRule")]
    public partial class AuthorizationExceptionRule : global::Pulumi.CustomResource
    {
        ...
        public AuthorizationExceptionRule(string name, AuthorizationExceptionRuleArgs args, CustomResourceOptions? options = null)
            : base("ise:deviceadmin/authorizationExceptionRule:AuthorizationExceptionRule", name, args ?? new AuthorizationExceptionRuleArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private AuthorizationExceptionRule(string name, Input<string> id, AuthorizationExceptionRuleState? state = null, CustomResourceOptions? options = null)
            : base("ise:deviceadmin/authorizationExceptionRule:AuthorizationExceptionRule", name, state, MakeResourceOptions(options, id))
        {
        }
