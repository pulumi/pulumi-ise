...
namespace Pulumi.Ise.DeviceAdmin
{
    public static class GetPolicySet
    {
        ...
        public static Task<GetPolicySetResult> InvokeAsync(GetPolicySetArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPolicySetResult>("ise:deviceadmin/getPolicySet:getPolicySet", args ?? new GetPolicySetArgs(), options.WithDefaults());
        ...
        public static Output<GetPolicySetResult> Invoke(GetPolicySetInvokeArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetPolicySetResult>("ise:deviceadmin/getPolicySet:getPolicySet", args ?? new GetPolicySetInvokeArgs(), options.WithDefaults());
