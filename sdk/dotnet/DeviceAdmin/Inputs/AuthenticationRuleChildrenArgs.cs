...
namespace Pulumi.Ise.DeviceAdmin.Inputs
{
    ...
    public sealed class AuthenticationRuleChildrenArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        {
            get => _childrens ?? (_childrens = new InputList<Inputs.AuthenticationRuleChildrenChildrenArgs>());
        ...
        public AuthenticationRuleChildrenArgs()
        {
        }
        public static new AuthenticationRuleChildrenArgs Empty => new AuthenticationRuleChildrenArgs();
    }
}
