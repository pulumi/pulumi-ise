...
namespace Pulumi.Ise.DeviceAdmin.Inputs
{
    ...
    public sealed class PolicySetChildrenGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("childrens")]
        private InputList<Inputs.PolicySetChildrenChildrenGetArgs>? _childrens;

        /// <summary>
        /// List of child conditions. `condition_type` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
        /// </summary>
        public InputList<Inputs.PolicySetChildrenChildrenGetArgs> Childrens
        {
            get => _childrens ?? (_childrens = new InputList<Inputs.PolicySetChildrenChildrenGetArgs>());
        ...
        public PolicySetChildrenGetArgs()
        {
        }
        public static new PolicySetChildrenGetArgs Empty => new PolicySetChildrenGetArgs();
    }
}
