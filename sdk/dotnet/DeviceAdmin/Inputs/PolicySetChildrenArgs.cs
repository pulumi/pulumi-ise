...
namespace Pulumi.Ise.DeviceAdmin.Inputs
{
    ...
    public sealed class PolicySetChildrenArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        {
            get => _childrens ?? (_childrens = new InputList<Inputs.PolicySetChildrenChildrenArgs>());
        ...
        public PolicySetChildrenArgs()
        {
        }
        public static new PolicySetChildrenArgs Empty => new PolicySetChildrenArgs();
    }
}
