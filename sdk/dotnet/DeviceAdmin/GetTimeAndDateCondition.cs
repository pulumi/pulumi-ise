...
namespace Pulumi.Ise.DeviceAdmin
{
    public static class GetTimeAndDateCondition
    {
        ...
        public static Task<GetTimeAndDateConditionResult> InvokeAsync(GetTimeAndDateConditionArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTimeAndDateConditionResult>("ise:deviceadmin/getTimeAndDateCondition:getTimeAndDateCondition", args ?? new GetTimeAndDateConditionArgs(), options.WithDefaults());
