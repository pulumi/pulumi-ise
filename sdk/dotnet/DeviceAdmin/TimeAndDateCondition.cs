...
namespace Pulumi.Ise.DeviceAdmin
{
    ...
    /// ```
    /// </summary>
    [IseResourceType("ise:deviceadmin/timeAndDateCondition:TimeAndDateCondition")]
    public partial class TimeAndDateCondition : global::Pulumi.CustomResource
    {
        ...
        public TimeAndDateCondition(string name, TimeAndDateConditionArgs? args = null, CustomResourceOptions? options = null)
            : base("ise:deviceadmin/timeAndDateCondition:TimeAndDateCondition", name, args ?? new TimeAndDateConditionArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private TimeAndDateCondition(string name, Input<string> id, TimeAndDateConditionState? state = null, CustomResourceOptions? options = null)
            : base("ise:deviceadmin/timeAndDateCondition:TimeAndDateCondition", name, state, MakeResourceOptions(options, id))
        {
        }
