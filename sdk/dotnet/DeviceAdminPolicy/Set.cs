...
namespace Pulumi.Ise.DeviceAdminPolicy
{
    ...
    /// ```
    /// </summary>
    [IseResourceType("ise:DeviceAdminPolicy/set:Set")]
    public partial class Set : global::Pulumi.CustomResource
    {
        ...
        public Set(string name, SetArgs args, CustomResourceOptions? options = null)
            : base("ise:DeviceAdminPolicy/set:Set", name, args ?? new SetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Set(string name, Input<string> id, SetState? state = null, CustomResourceOptions? options = null)
            : base("ise:DeviceAdminPolicy/set:Set", name, state, MakeResourceOptions(options, id))
        {
        }
