...
namespace Pulumi.Ise.Network
{
    ...
    /// ```
    /// </summary>
    [IseResourceType("ise:network/authorizationProfile:AuthorizationProfile")]
    public partial class AuthorizationProfile : global::Pulumi.CustomResource
    {
        ...
        public Output<ImmutableArray<Outputs.AuthorizationProfileAdvancedAttribute>> AdvancedAttributes { get; private set; } = null!;
        ...
        public AuthorizationProfile(string name, AuthorizationProfileArgs? args = null, CustomResourceOptions? options = null)
            : base("ise:network/authorizationProfile:AuthorizationProfile", name, args ?? new AuthorizationProfileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AuthorizationProfile(string name, Input<string> id, AuthorizationProfileState? state = null, CustomResourceOptions? options = null)
            : base("ise:network/authorizationProfile:AuthorizationProfile", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static AuthorizationProfile Get(string name, Input<string> id, AuthorizationProfileState? state = null, CustomResourceOptions? options = null)
        {
    ...
    public sealed class AuthorizationProfileArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.AuthorizationProfileAdvancedAttributeArgs>? _advancedAttributes;

        /// <summary>
        /// List of advanced attributes
        /// </summary>
        public InputList<Inputs.AuthorizationProfileAdvancedAttributeArgs> AdvancedAttributes
        {
            get => _advancedAttributes ?? (_advancedAttributes = new InputList<Inputs.AuthorizationProfileAdvancedAttributeArgs>());
    ...
    public sealed class AuthorizationProfileState : global::Pulumi.ResourceArgs
    {
        ...
        [Input("advancedAttributes")]
        private InputList<Inputs.AuthorizationProfileAdvancedAttributeGetArgs>? _advancedAttributes;

        /// <summary>
        /// List of advanced attributes
        /// </summary>
        public InputList<Inputs.AuthorizationProfileAdvancedAttributeGetArgs> AdvancedAttributes
        {
            get => _advancedAttributes ?? (_advancedAttributes = new InputList<Inputs.AuthorizationProfileAdvancedAttributeGetArgs>());
            set => _advancedAttributes = value;
        }
        ...
        public static new AuthorizationProfileState Empty => new AuthorizationProfileState();
    }
}
