...
namespace Pulumi.Ise.Network
{
    ...
    /// {
    ///     var example = new Ise.Network.DownloadableAcl("example", new()
    ///     {
    ///         Name = "MyACL",
    ...
    /// ```
    /// </summary>
    [IseResourceType("ise:network/downloadableAcl:DownloadableAcl")]
    public partial class DownloadableAcl : global::Pulumi.CustomResource
    {
        ...
        public DownloadableAcl(string name, DownloadableAclArgs args, CustomResourceOptions? options = null)
            : base("ise:network/downloadableAcl:DownloadableAcl", name, args ?? new DownloadableAclArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DownloadableAcl(string name, Input<string> id, DownloadableAclState? state = null, CustomResourceOptions? options = null)
            : base("ise:network/downloadableAcl:DownloadableAcl", name, state, MakeResourceOptions(options, id))
        {
        }
