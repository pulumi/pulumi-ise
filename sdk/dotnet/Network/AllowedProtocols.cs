...
namespace Pulumi.Ise.Network
{
    ...
    /// {
    ///     var example = new Ise.Network.AllowedProtocols("example", new()
    ///     {
    ///         Name = "Protocols1",
    ...
    /// ```
    /// </summary>
    [IseResourceType("ise:network/allowedProtocols:AllowedProtocols")]
    public partial class AllowedProtocols : global::Pulumi.CustomResource
    {
        ...
        public AllowedProtocols(string name, AllowedProtocolsArgs args, CustomResourceOptions? options = null)
            : base("ise:network/allowedProtocols:AllowedProtocols", name, args ?? new AllowedProtocolsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AllowedProtocols(string name, Input<string> id, AllowedProtocolsState? state = null, CustomResourceOptions? options = null)
            : base("ise:network/allowedProtocols:AllowedProtocols", name, state, MakeResourceOptions(options, id))
        {
        }
