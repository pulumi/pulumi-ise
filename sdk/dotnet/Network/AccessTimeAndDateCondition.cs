...
namespace Pulumi.Ise.Network
{
    ...
    /// {
    ///     var example = new Ise.Network.AccessTimeAndDateCondition("example", new()
    ///     {
    ///         Name = "Cond1",
    ...
    /// ```
    /// </summary>
    [IseResourceType("ise:network/accessTimeAndDateCondition:AccessTimeAndDateCondition")]
    public partial class AccessTimeAndDateCondition : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public AccessTimeAndDateCondition(string name, AccessTimeAndDateConditionArgs? args = null, CustomResourceOptions? options = null)
            : base("ise:network/accessTimeAndDateCondition:AccessTimeAndDateCondition", name, args ?? new AccessTimeAndDateConditionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AccessTimeAndDateCondition(string name, Input<string> id, AccessTimeAndDateConditionState? state = null, CustomResourceOptions? options = null)
            : base("ise:network/accessTimeAndDateCondition:AccessTimeAndDateCondition", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static AccessTimeAndDateCondition Get(string name, Input<string> id, AccessTimeAndDateConditionState? state = null, CustomResourceOptions? options = null)
        {
            return new AccessTimeAndDateCondition(name, id, state, options);
        }
    }

    public sealed class AccessTimeAndDateConditionArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Condition description
        /// </summary>
        ...
        public AccessTimeAndDateConditionArgs()
        {
        }
        public static new AccessTimeAndDateConditionArgs Empty => new AccessTimeAndDateConditionArgs();
    }

    public sealed class AccessTimeAndDateConditionState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Condition description
        /// </summary>
        ...
        public AccessTimeAndDateConditionState()
        {
        }
        public static new AccessTimeAndDateConditionState Empty => new AccessTimeAndDateConditionState();
    }
}
