...
namespace Pulumi.Ise.NetworkAccessPolicy
{
    public static class GetSet
    {
        ...
        public static Task<GetSetResult> InvokeAsync(GetSetArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSetResult>("ise:NetworkAccessPolicy/getSet:getSet", args ?? new GetSetArgs(), options.WithDefaults());
        ...
        public static Output<GetSetResult> Invoke(GetSetInvokeArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSetResult>("ise:NetworkAccessPolicy/getSet:getSet", args ?? new GetSetInvokeArgs(), options.WithDefaults());
    }
