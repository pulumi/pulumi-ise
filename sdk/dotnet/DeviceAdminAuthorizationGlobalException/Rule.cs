...
namespace Pulumi.Ise.DeviceAdminAuthorizationGlobalException
{
    ...
    /// ```
    /// </summary>
    [IseResourceType("ise:DeviceAdminAuthorizationGlobalException/rule:Rule")]
    public partial class Rule : global::Pulumi.CustomResource
    {
        ...
        public Rule(string name, RuleArgs? args = null, CustomResourceOptions? options = null)
            : base("ise:DeviceAdminAuthorizationGlobalException/rule:Rule", name, args ?? new RuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Rule(string name, Input<string> id, RuleState? state = null, CustomResourceOptions? options = null)
            : base("ise:DeviceAdminAuthorizationGlobalException/rule:Rule", name, state, MakeResourceOptions(options, id))
        {
        }
