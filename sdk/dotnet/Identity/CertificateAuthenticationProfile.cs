...
namespace Pulumi.Ise.Identity
{
    ...
    /// {
    ///     var example = new Ise.Identity.CertificateAuthenticationProfile("example", new()
    ///     {
    ///         Name = "CertProf1",
    ...
    /// ```
    /// </summary>
    [IseResourceType("ise:identity/certificateAuthenticationProfile:CertificateAuthenticationProfile")]
    public partial class CertificateAuthenticationProfile : global::Pulumi.CustomResource
    {
        ...
        public CertificateAuthenticationProfile(string name, CertificateAuthenticationProfileArgs? args = null, CustomResourceOptions? options = null)
            : base("ise:identity/certificateAuthenticationProfile:CertificateAuthenticationProfile", name, args ?? new CertificateAuthenticationProfileArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private CertificateAuthenticationProfile(string name, Input<string> id, CertificateAuthenticationProfileState? state = null, CustomResourceOptions? options = null)
            : base("ise:identity/certificateAuthenticationProfile:CertificateAuthenticationProfile", name, state, MakeResourceOptions(options, id))
        {
        }
