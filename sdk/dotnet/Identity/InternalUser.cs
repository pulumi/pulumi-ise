...
namespace Pulumi.Ise.Identity
{
    ...
    /// {
    ///     var example = new Ise.Identity.InternalUser("example", new()
    ///     {
    ///         Name = "UserTF",
    ///         Password = "Cisco123",
    ///         ChangePassword = true,
    ...
    /// ```
    /// </summary>
    [IseResourceType("ise:identity/internalUser:InternalUser")]
    public partial class InternalUser : global::Pulumi.CustomResource
    {
        ...
        public InternalUser(string name, InternalUserArgs args, CustomResourceOptions? options = null)
            : base("ise:identity/internalUser:InternalUser", name, args ?? new InternalUserArgs(), MakeResourceOptions(options, ""))
        {
        }

        private InternalUser(string name, Input<string> id, InternalUserState? state = null, CustomResourceOptions? options = null)
            : base("ise:identity/internalUser:InternalUser", name, state, MakeResourceOptions(options, id))
        {
        }
