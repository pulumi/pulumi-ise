...
namespace Pulumi.Ise.Identity
{
    ...
    /// {
    ///     var example = new Ise.Identity.Endpoint("example", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [IseResourceType("ise:identity/endpoint:Endpoint")]
    public partial class Endpoint : global::Pulumi.CustomResource
    {
        ...
        public Endpoint(string name, EndpointArgs args, CustomResourceOptions? options = null)
            : base("ise:identity/endpoint:Endpoint", name, args ?? new EndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Endpoint(string name, Input<string> id, EndpointState? state = null, CustomResourceOptions? options = null)
            : base("ise:identity/endpoint:Endpoint", name, state, MakeResourceOptions(options, id))
        {
        }
