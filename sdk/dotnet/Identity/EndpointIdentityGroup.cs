...
namespace Pulumi.Ise.Identity
{
    ...
    /// {
    ///     var example = new Ise.Identity.EndpointIdentityGroup("example", new()
    ///     {
    ///         Name = "Group1",
    ...
    /// ```
    /// </summary>
    [IseResourceType("ise:identity/endpointIdentityGroup:EndpointIdentityGroup")]
    public partial class EndpointIdentityGroup : global::Pulumi.CustomResource
    {
        ...
        public EndpointIdentityGroup(string name, EndpointIdentityGroupArgs? args = null, CustomResourceOptions? options = null)
            : base("ise:identity/endpointIdentityGroup:EndpointIdentityGroup", name, args ?? new EndpointIdentityGroupArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private EndpointIdentityGroup(string name, Input<string> id, EndpointIdentityGroupState? state = null, CustomResourceOptions? options = null)
            : base("ise:identity/endpointIdentityGroup:EndpointIdentityGroup", name, state, MakeResourceOptions(options, id))
        {
        }
