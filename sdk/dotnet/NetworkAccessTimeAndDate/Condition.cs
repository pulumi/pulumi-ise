...
namespace Pulumi.Ise.NetworkAccessTimeAndDate
{
    /// <summary>
    ...
    /// ```
    /// </summary>
    [IseResourceType("ise:NetworkAccessTimeAndDate/condition:Condition")]
    public partial class Condition : global::Pulumi.CustomResource
    {
        ...
        public Condition(string name, ConditionArgs? args = null, CustomResourceOptions? options = null)
            : base("ise:NetworkAccessTimeAndDate/condition:Condition", name, args ?? new ConditionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Condition(string name, Input<string> id, ConditionState? state = null, CustomResourceOptions? options = null)
            : base("ise:NetworkAccessTimeAndDate/condition:Condition", name, state, MakeResourceOptions(options, id))
        {
        }
