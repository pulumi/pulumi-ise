...
namespace Pulumi.Ise.TrustsecIpToSgt
{
    ...
    /// ```
    /// </summary>
    [IseResourceType("ise:TrustsecIpToSgt/mapping:Mapping")]
    public partial class Mapping : global::Pulumi.CustomResource
    {
        ...
        public Mapping(string name, MappingArgs? args = null, CustomResourceOptions? options = null)
            : base("ise:TrustsecIpToSgt/mapping:Mapping", name, args ?? new MappingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Mapping(string name, Input<string> id, MappingState? state = null, CustomResourceOptions? options = null)
            : base("ise:TrustsecIpToSgt/mapping:Mapping", name, state, MakeResourceOptions(options, id))
        {
        }
