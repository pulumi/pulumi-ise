...
namespace Pulumi.Ise.Downloadable
{
    ...
    /// ```
    /// </summary>
    [IseResourceType("ise:Downloadable/acl:Acl")]
    public partial class Acl : global::Pulumi.CustomResource
    {
        ...
        public Acl(string name, AclArgs args, CustomResourceOptions? options = null)
            : base("ise:Downloadable/acl:Acl", name, args ?? new AclArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Acl(string name, Input<string> id, AclState? state = null, CustomResourceOptions? options = null)
            : base("ise:Downloadable/acl:Acl", name, state, MakeResourceOptions(options, id))
        {
        }
