...
namespace Pulumi.Ise.DeviceAdminAuthorization
{
    public static class GetRule
    {
        ...
        public static Task<GetRuleResult> InvokeAsync(GetRuleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetRuleResult>("ise:DeviceAdminAuthorization/getRule:getRule", args ?? new GetRuleArgs(), options.WithDefaults());
        ...
        public static Output<GetRuleResult> Invoke(GetRuleInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetRuleResult>("ise:DeviceAdminAuthorization/getRule:getRule", args ?? new GetRuleInvokeArgs(), options.WithDefaults());
    }
