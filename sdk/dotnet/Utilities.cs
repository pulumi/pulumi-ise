...
namespace Pulumi.Ise
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Ise.version.txt");
    ...
    internal sealed class IseResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public IseResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
