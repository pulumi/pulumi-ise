...
namespace Pulumi.Ise.TrustSec
{
    ...
    /// ```
    /// </summary>
    [IseResourceType("ise:trustsec/securityGroup:SecurityGroup")]
    public partial class SecurityGroup : global::Pulumi.CustomResource
    {
        ...
        public SecurityGroup(string name, SecurityGroupArgs args, CustomResourceOptions? options = null)
            : base("ise:trustsec/securityGroup:SecurityGroup", name, args ?? new SecurityGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SecurityGroup(string name, Input<string> id, SecurityGroupState? state = null, CustomResourceOptions? options = null)
            : base("ise:trustsec/securityGroup:SecurityGroup", name, state, MakeResourceOptions(options, id))
        {
        }
