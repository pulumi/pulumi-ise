...
namespace Pulumi.Ise.NetworkAccess
{
    ...
    /// ```
    /// </summary>
    [IseResourceType("ise:networkaccess/authenticationRule:AuthenticationRule")]
    public partial class AuthenticationRule : global::Pulumi.CustomResource
    {
        ...
        public AuthenticationRule(string name, AuthenticationRuleArgs args, CustomResourceOptions? options = null)
            : base("ise:networkaccess/authenticationRule:AuthenticationRule", name, args ?? new AuthenticationRuleArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private AuthenticationRule(string name, Input<string> id, AuthenticationRuleState? state = null, CustomResourceOptions? options = null)
            : base("ise:networkaccess/authenticationRule:AuthenticationRule", name, state, MakeResourceOptions(options, id))
        {
        }
