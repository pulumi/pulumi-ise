...
namespace Pulumi.Ise.NetworkAccess
{
    public static class GetAllowedProtocols
    {
        ...
        public static Task<GetAllowedProtocolsResult> InvokeAsync(GetAllowedProtocolsArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAllowedProtocolsResult>("ise:networkaccess/getAllowedProtocols:getAllowedProtocols", args ?? new GetAllowedProtocolsArgs(), options.WithDefaults());
