...
namespace Pulumi.Ise.NetworkAccess
{
    ...
    /// ```
    /// </summary>
    [IseResourceType("ise:networkaccess/authorizationGlobalExceptionRuleUpdateRanks:AuthorizationGlobalExceptionRuleUpdateRanks")]
    public partial class AuthorizationGlobalExceptionRuleUpdateRanks : global::Pulumi.CustomResource
    {
        ...
        public AuthorizationGlobalExceptionRuleUpdateRanks(string name, AuthorizationGlobalExceptionRuleUpdateRanksArgs? args = null, CustomResourceOptions? options = null)
            : base("ise:networkaccess/authorizationGlobalExceptionRuleUpdateRanks:AuthorizationGlobalExceptionRuleUpdateRanks", name, args ?? new AuthorizationGlobalExceptionRuleUpdateRanksArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private AuthorizationGlobalExceptionRuleUpdateRanks(string name, Input<string> id, AuthorizationGlobalExceptionRuleUpdateRanksState? state = null, CustomResourceOptions? options = null)
            : base("ise:networkaccess/authorizationGlobalExceptionRuleUpdateRanks:AuthorizationGlobalExceptionRuleUpdateRanks", name, state, MakeResourceOptions(options, id))
        {
        }
