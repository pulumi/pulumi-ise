...
namespace Pulumi.Ise.NetworkAccess
{
    ...
    /// ```
    /// </summary>
    [IseResourceType("ise:networkaccess/authorizationRule:AuthorizationRule")]
    public partial class AuthorizationRule : global::Pulumi.CustomResource
    {
        ...
        public AuthorizationRule(string name, AuthorizationRuleArgs args, CustomResourceOptions? options = null)
            : base("ise:networkaccess/authorizationRule:AuthorizationRule", name, args ?? new AuthorizationRuleArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private AuthorizationRule(string name, Input<string> id, AuthorizationRuleState? state = null, CustomResourceOptions? options = null)
            : base("ise:networkaccess/authorizationRule:AuthorizationRule", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AuthorizationRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        {
            get => _childrens ?? (_childrens = new InputList<Inputs.AuthorizationRuleChildrenArgs>());
    ...
    public sealed class AuthorizationRuleState : global::Pulumi.ResourceArgs
    {
        ...
        {
            get => _childrens ?? (_childrens = new InputList<Inputs.AuthorizationRuleChildrenGetArgs>());
            set => _childrens = value;
        }
