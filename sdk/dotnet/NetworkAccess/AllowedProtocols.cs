...
namespace Pulumi.Ise.NetworkAccess
{
    ...
    /// ```
    /// </summary>
    [IseResourceType("ise:networkaccess/allowedProtocols:AllowedProtocols")]
    public partial class AllowedProtocols : global::Pulumi.CustomResource
    {
        ...
        public AllowedProtocols(string name, AllowedProtocolsArgs args, CustomResourceOptions? options = null)
            : base("ise:networkaccess/allowedProtocols:AllowedProtocols", name, args ?? new AllowedProtocolsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AllowedProtocols(string name, Input<string> id, AllowedProtocolsState? state = null, CustomResourceOptions? options = null)
            : base("ise:networkaccess/allowedProtocols:AllowedProtocols", name, state, MakeResourceOptions(options, id))
        {
        }
