...
namespace Pulumi.Ise.NetworkAccess
{
    ...
    /// ```
    /// </summary>
    [IseResourceType("ise:networkaccess/policySet:PolicySet")]
    public partial class PolicySet : global::Pulumi.CustomResource
    {
        ...
        public PolicySet(string name, PolicySetArgs args, CustomResourceOptions? options = null)
            : base("ise:networkaccess/policySet:PolicySet", name, args ?? new PolicySetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PolicySet(string name, Input<string> id, PolicySetState? state = null, CustomResourceOptions? options = null)
            : base("ise:networkaccess/policySet:PolicySet", name, state, MakeResourceOptions(options, id))
        {
        }
