...
namespace Pulumi.Ise.NetworkAccess
{
    ...
    /// ```
    /// </summary>
    [IseResourceType("ise:networkaccess/authorizationExceptionRuleUpdateRanks:AuthorizationExceptionRuleUpdateRanks")]
    public partial class AuthorizationExceptionRuleUpdateRanks : global::Pulumi.CustomResource
    {
        ...
        public AuthorizationExceptionRuleUpdateRanks(string name, AuthorizationExceptionRuleUpdateRanksArgs args, CustomResourceOptions? options = null)
            : base("ise:networkaccess/authorizationExceptionRuleUpdateRanks:AuthorizationExceptionRuleUpdateRanks", name, args ?? new AuthorizationExceptionRuleUpdateRanksArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private AuthorizationExceptionRuleUpdateRanks(string name, Input<string> id, AuthorizationExceptionRuleUpdateRanksState? state = null, CustomResourceOptions? options = null)
            : base("ise:networkaccess/authorizationExceptionRuleUpdateRanks:AuthorizationExceptionRuleUpdateRanks", name, state, MakeResourceOptions(options, id))
        {
        }
