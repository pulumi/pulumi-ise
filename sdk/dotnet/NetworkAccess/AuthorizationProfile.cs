...
namespace Pulumi.Ise.NetworkAccess
{
    ...
    /// ```
    /// </summary>
    [IseResourceType("ise:networkaccess/authorizationProfile:AuthorizationProfile")]
    public partial class AuthorizationProfile : global::Pulumi.CustomResource
    {
        ...
        public AuthorizationProfile(string name, AuthorizationProfileArgs? args = null, CustomResourceOptions? options = null)
            : base("ise:networkaccess/authorizationProfile:AuthorizationProfile", name, args ?? new AuthorizationProfileArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private AuthorizationProfile(string name, Input<string> id, AuthorizationProfileState? state = null, CustomResourceOptions? options = null)
            : base("ise:networkaccess/authorizationProfile:AuthorizationProfile", name, state, MakeResourceOptions(options, id))
        {
        }
