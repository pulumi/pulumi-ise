...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "ise:NetworkAccessAuthorizationGlobalException/rule:Rule":
...
pulumi.runtime.registerResourceModule("ise", "NetworkAccessAuthorizationGlobalException/rule", _module)
