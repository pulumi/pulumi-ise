 ...
 * ```
 */
export class Point extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PointState, opts?: pulumi.CustomResourceOptions): Point {
        return new Point(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'ise:ActiveDirectoryJoin/point:Point';

    /**
     * Returns true if the given object is an instance of Point.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Point {
     ...
     */
    public readonly attributes!: pulumi.Output<outputs.ActiveDirectoryJoin.PointAttribute[] | undefined>;
    /**
     ...
     * List of AD Groups
     */
    public readonly groups!: pulumi.Output<outputs.ActiveDirectoryJoin.PointGroup[] | undefined>;
    /**
     ...
     */
    public readonly rewriteRules!: pulumi.Output<outputs.ActiveDirectoryJoin.PointRewriteRule[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: PointArgs | PointState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as PointState | undefined;
            ...
            const args = argsOrState as PointArgs | undefined;
