...
export class Rule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'ise:DeviceAdminAuthorization/rule:Rule';
     ...
     */
    public readonly childrens!: pulumi.Output<outputs.DeviceAdminAuthorization.RuleChildren[] | undefined>;
    /**
...
export interface RuleState {
     ...
     * List of child conditions. `condition_type` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
     */
    childrens?: pulumi.Input<pulumi.Input<inputs.DeviceAdminAuthorization.RuleChildren>[]>;
    /**
     * Command sets enforce the specified list of commands that can be executed by a device administrator
     */
