...
export class Groups extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: GroupsState, opts?: pulumi.CustomResourceOptions): Groups {
        return new Groups(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'ise:ActiveDirectoryAdd/groups:Groups';
     ...
     * List of AD Groups
     */
    public readonly groups!: pulumi.Output<outputs.ActiveDirectoryAdd.GroupsGroup[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: GroupsArgs | GroupsState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as GroupsState | undefined;
            ...
            const args = argsOrState as GroupsArgs | undefined;
...
export interface GroupsState {
     ...
     * List of AD Groups
     */
    groups?: pulumi.Input<pulumi.Input<inputs.ActiveDirectoryAdd.GroupsGroup>[]>;
    /**
     * Active Directory Join Point ID
     */
