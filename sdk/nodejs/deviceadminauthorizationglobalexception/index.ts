...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "ise:DeviceAdminAuthorizationGlobalException/rule:Rule":
...
pulumi.runtime.registerResourceModule("ise", "DeviceAdminAuthorizationGlobalException/rule", _module)
