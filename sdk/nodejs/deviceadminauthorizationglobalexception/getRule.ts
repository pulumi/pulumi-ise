...
export function getRule(args?: GetRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetRuleResult> {
    ...
    return pulumi.runtime.invoke("ise:DeviceAdminAuthorizationGlobalException/getRule:getRule", {
        "id": args.id,
        "name": args.name,
    }, opts);
}
...
export interface GetRuleResult {
     ...
     */
    readonly childrens: outputs.DeviceAdminAuthorizationGlobalException.GetRuleChildren[];
    /**
