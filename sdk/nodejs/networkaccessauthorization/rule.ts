...
export class Rule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'ise:NetworkAccessAuthorization/rule:Rule';
     ...
     */
    public readonly childrens!: pulumi.Output<outputs.NetworkAccessAuthorization.RuleChildren[] | undefined>;
    /**
...
export interface RuleState {
     ...
     * List of child conditions. `condition_type` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
     */
    childrens?: pulumi.Input<pulumi.Input<inputs.NetworkAccessAuthorization.RuleChildren>[]>;
    /**
     * Dictionary attribute name
     */
