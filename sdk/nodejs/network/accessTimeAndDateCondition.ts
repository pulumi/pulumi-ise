 ...
 *
 * const example = new ise.network.AccessTimeAndDateCondition("example", {
 *     name: "Cond1",
 ...
 * ```
 */
export class AccessTimeAndDateCondition extends pulumi.CustomResource {
    /**
     * Get an existing AccessTimeAndDateCondition resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AccessTimeAndDateConditionState, opts?: pulumi.CustomResourceOptions): AccessTimeAndDateCondition {
        return new AccessTimeAndDateCondition(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'ise:network/accessTimeAndDateCondition:AccessTimeAndDateCondition';

    /**
     * Returns true if the given object is an instance of AccessTimeAndDateCondition.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AccessTimeAndDateCondition {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === AccessTimeAndDateCondition.__pulumiType;
    }
    ...
    /**
     * Create a AccessTimeAndDateCondition resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: AccessTimeAndDateConditionArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: AccessTimeAndDateConditionArgs | AccessTimeAndDateConditionState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as AccessTimeAndDateConditionState | undefined;
            ...
            const args = argsOrState as AccessTimeAndDateConditionArgs | undefined;
        ...
        super(AccessTimeAndDateCondition.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface AccessTimeAndDateConditionState {
    /**
     * Condition description
     */
 ...
 */
export interface AccessTimeAndDateConditionArgs {
    /**
     * Condition description
     */
    description?: pulumi.Input<string>;
