 ...
 *
 * const example = ise.network.getAuthorizationProfile({
...
export function getAuthorizationProfile(args?: GetAuthorizationProfileArgs, opts?: pulumi.InvokeOptions): Promise<GetAuthorizationProfileResult> {
    ...
    return pulumi.runtime.invoke("ise:network/getAuthorizationProfile:getAuthorizationProfile", {
        "id": args.id,
        "name": args.name,
    }, opts);
}
...
export interface GetAuthorizationProfileResult {
     ...
     */
    readonly advancedAttributes: outputs.network.GetAuthorizationProfileAdvancedAttribute[];
    /**
     * Agentless Posture.
     */
