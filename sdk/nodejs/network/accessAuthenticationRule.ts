 ...
 *
 * const example = new ise.network.AccessAuthenticationRule("example", {
 ...
 * ```
 */
export class AccessAuthenticationRule extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AccessAuthenticationRuleState, opts?: pulumi.CustomResourceOptions): AccessAuthenticationRule {
        return new AccessAuthenticationRule(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'ise:network/accessAuthenticationRule:AccessAuthenticationRule';

    /**
     * Returns true if the given object is an instance of AccessAuthenticationRule.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AccessAuthenticationRule {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === AccessAuthenticationRule.__pulumiType;
    }

    /**
     * List of child conditions. `condition_type` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
     */
    public readonly childrens!: pulumi.Output<outputs.network.AccessAuthenticationRuleChildren[] | undefined>;
    /**
     ...
     */
    constructor(name: string, args: AccessAuthenticationRuleArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: AccessAuthenticationRuleArgs | AccessAuthenticationRuleState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as AccessAuthenticationRuleState | undefined;
            ...
            const args = argsOrState as AccessAuthenticationRuleArgs | undefined;
        ...
        super(AccessAuthenticationRule.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface AccessAuthenticationRuleState {
    /**
     * List of child conditions. `condition_type` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
     */
    childrens?: pulumi.Input<pulumi.Input<inputs.network.AccessAuthenticationRuleChildren>[]>;
    /**
     * Dictionary attribute name
     */
 ...
 */
export interface AccessAuthenticationRuleArgs {
    /**
     * List of child conditions. `condition_type` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
     */
    childrens?: pulumi.Input<pulumi.Input<inputs.network.AccessAuthenticationRuleChildren>[]>;
