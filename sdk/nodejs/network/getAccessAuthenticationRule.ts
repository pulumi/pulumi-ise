 ...
 *
 * const example = ise.network.getAccessAuthenticationRule({
 *     id: "76d24097-41c4-4558-a4d0-a8c07ac08470",
 *     policySetId: "d82952cb-b901-4b09-b363-5ebf39bdbaf9",
 * });
 * ```
 */
export function getAccessAuthenticationRule(args: GetAccessAuthenticationRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetAccessAuthenticationRuleResult> {

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("ise:network/getAccessAuthenticationRule:getAccessAuthenticationRule", {
        "id": args.id,
        "name": args.name,
 ...
 */
export interface GetAccessAuthenticationRuleArgs {
    /**
 ...
 */
export interface GetAccessAuthenticationRuleResult {
    /**
     * List of child conditions. `conditionType` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
     */
    readonly childrens: outputs.network.GetAccessAuthenticationRuleChildren[];
    /**
 ...
 * ```
 */
export function getAccessAuthenticationRuleOutput(args: GetAccessAuthenticationRuleOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetAccessAuthenticationRuleResult> {
    return pulumi.output(args).apply((a: any) => getAccessAuthenticationRule(a, opts))
}

/**
 * A collection of arguments for invoking getAccessAuthenticationRule.
 */
export interface GetAccessAuthenticationRuleOutputArgs {
    /**
     * The id of the object
     */
