 ...
 *
 * const example = new ise.network.AccessAuthorizationGlobalExceptionRule("example", {
 *     name: "Rule1",
 *     "default": false,
 *     rank: 0,
 *     state: "enabled",
 ...
 * ```
 */
export class AccessAuthorizationGlobalExceptionRule extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AccessAuthorizationGlobalExceptionRuleState, opts?: pulumi.CustomResourceOptions): AccessAuthorizationGlobalExceptionRule {
        return new AccessAuthorizationGlobalExceptionRule(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'ise:network/accessAuthorizationGlobalExceptionRule:AccessAuthorizationGlobalExceptionRule';

    /**
     * Returns true if the given object is an instance of AccessAuthorizationGlobalExceptionRule.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AccessAuthorizationGlobalExceptionRule {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === AccessAuthorizationGlobalExceptionRule.__pulumiType;
    }

    /**
     * List of child conditions. `condition_type` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
     */
    public readonly childrens!: pulumi.Output<outputs.network.AccessAuthorizationGlobalExceptionRuleChildren[] | undefined>;
    /**
     ...
     */
    constructor(name: string, args?: AccessAuthorizationGlobalExceptionRuleArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: AccessAuthorizationGlobalExceptionRuleArgs | AccessAuthorizationGlobalExceptionRuleState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as AccessAuthorizationGlobalExceptionRuleState | undefined;
            ...
            const args = argsOrState as AccessAuthorizationGlobalExceptionRuleArgs | undefined;
        ...
        super(AccessAuthorizationGlobalExceptionRule.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface AccessAuthorizationGlobalExceptionRuleState {
    /**
     * List of child conditions. `condition_type` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
     */
    childrens?: pulumi.Input<pulumi.Input<inputs.network.AccessAuthorizationGlobalExceptionRuleChildren>[]>;
    /**
     * Dictionary attribute name
     */
 ...
 */
export interface AccessAuthorizationGlobalExceptionRuleArgs {
    /**
     * List of child conditions. `condition_type` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
     */
    childrens?: pulumi.Input<pulumi.Input<inputs.network.AccessAuthorizationGlobalExceptionRuleChildren>[]>;
