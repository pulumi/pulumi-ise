...
export class AuthorizationProfile extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'ise:network/authorizationProfile:AuthorizationProfile';
     ...
     */
    public readonly advancedAttributes!: pulumi.Output<outputs.network.AuthorizationProfileAdvancedAttribute[] | undefined>;
    /**
     * Agentless Posture.
     */
...
export interface AuthorizationProfileState {
     ...
     * List of advanced attributes
     */
    advancedAttributes?: pulumi.Input<pulumi.Input<inputs.network.AuthorizationProfileAdvancedAttribute>[]>;
    /**
     * Agentless Posture.
     */
