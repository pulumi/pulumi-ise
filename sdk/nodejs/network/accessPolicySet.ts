 ...
 *
 * const example = new ise.network.AccessPolicySet("example", {
 *     name: "PolicySet1",
 ...
 * ```
 */
export class AccessPolicySet extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AccessPolicySetState, opts?: pulumi.CustomResourceOptions): AccessPolicySet {
        return new AccessPolicySet(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'ise:network/accessPolicySet:AccessPolicySet';

    /**
     * Returns true if the given object is an instance of AccessPolicySet.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AccessPolicySet {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === AccessPolicySet.__pulumiType;
    }

    /**
     * List of child conditions. `condition_type` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
     */
    public readonly childrens!: pulumi.Output<outputs.network.AccessPolicySetChildren[] | undefined>;
    /**
     ...
     */
    constructor(name: string, args: AccessPolicySetArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: AccessPolicySetArgs | AccessPolicySetState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as AccessPolicySetState | undefined;
            ...
            const args = argsOrState as AccessPolicySetArgs | undefined;
        ...
        super(AccessPolicySet.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface AccessPolicySetState {
    /**
     * List of child conditions. `condition_type` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
     */
    childrens?: pulumi.Input<pulumi.Input<inputs.network.AccessPolicySetChildren>[]>;
    /**
     * Dictionary attribute name
     */
 ...
 */
export interface AccessPolicySetArgs {
    /**
     * List of child conditions. `condition_type` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
     */
    childrens?: pulumi.Input<pulumi.Input<inputs.network.AccessPolicySetChildren>[]>;
