 ...
 *
 * const example = new ise.network.AccessAuthorizationRule("example", {
 ...
 * ```
 */
export class AccessAuthorizationRule extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AccessAuthorizationRuleState, opts?: pulumi.CustomResourceOptions): AccessAuthorizationRule {
        return new AccessAuthorizationRule(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'ise:network/accessAuthorizationRule:AccessAuthorizationRule';

    /**
     * Returns true if the given object is an instance of AccessAuthorizationRule.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AccessAuthorizationRule {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === AccessAuthorizationRule.__pulumiType;
    }

    /**
     * List of child conditions. `condition_type` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
     */
    public readonly childrens!: pulumi.Output<outputs.network.AccessAuthorizationRuleChildren[] | undefined>;
    /**
     ...
     */
    constructor(name: string, args: AccessAuthorizationRuleArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: AccessAuthorizationRuleArgs | AccessAuthorizationRuleState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as AccessAuthorizationRuleState | undefined;
            ...
            const args = argsOrState as AccessAuthorizationRuleArgs | undefined;
        ...
        super(AccessAuthorizationRule.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface AccessAuthorizationRuleState {
    /**
     * List of child conditions. `condition_type` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
     */
    childrens?: pulumi.Input<pulumi.Input<inputs.network.AccessAuthorizationRuleChildren>[]>;
    /**
     * Dictionary attribute name
     */
 ...
 */
export interface AccessAuthorizationRuleArgs {
    /**
     * List of child conditions. `condition_type` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
     */
    childrens?: pulumi.Input<pulumi.Input<inputs.network.AccessAuthorizationRuleChildren>[]>;
