 ...
 *
 * const example = new ise.network.AccessAuthorizationExceptionRule("example", {
 ...
 * ```
 */
export class AccessAuthorizationExceptionRule extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AccessAuthorizationExceptionRuleState, opts?: pulumi.CustomResourceOptions): AccessAuthorizationExceptionRule {
        return new AccessAuthorizationExceptionRule(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'ise:network/accessAuthorizationExceptionRule:AccessAuthorizationExceptionRule';

    /**
     * Returns true if the given object is an instance of AccessAuthorizationExceptionRule.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AccessAuthorizationExceptionRule {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === AccessAuthorizationExceptionRule.__pulumiType;
    }

    /**
     * List of child conditions. `condition_type` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
     */
    public readonly childrens!: pulumi.Output<outputs.network.AccessAuthorizationExceptionRuleChildren[] | undefined>;
    /**
     ...
     */
    constructor(name: string, args: AccessAuthorizationExceptionRuleArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: AccessAuthorizationExceptionRuleArgs | AccessAuthorizationExceptionRuleState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as AccessAuthorizationExceptionRuleState | undefined;
            ...
            const args = argsOrState as AccessAuthorizationExceptionRuleArgs | undefined;
        ...
        super(AccessAuthorizationExceptionRule.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface AccessAuthorizationExceptionRuleState {
    /**
     * List of child conditions. `condition_type` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
     */
    childrens?: pulumi.Input<pulumi.Input<inputs.network.AccessAuthorizationExceptionRuleChildren>[]>;
    /**
     * Dictionary attribute name
     */
 ...
 */
export interface AccessAuthorizationExceptionRuleArgs {
    /**
     * List of child conditions. `condition_type` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
     */
    childrens?: pulumi.Input<pulumi.Input<inputs.network.AccessAuthorizationExceptionRuleChildren>[]>;
