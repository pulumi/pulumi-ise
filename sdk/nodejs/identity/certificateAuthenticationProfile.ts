 ...
 *
 * const example = new ise.identity.CertificateAuthenticationProfile("example", {
 *     name: "CertProf1",
...
export class CertificateAuthenticationProfile extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'ise:identity/certificateAuthenticationProfile:CertificateAuthenticationProfile';
