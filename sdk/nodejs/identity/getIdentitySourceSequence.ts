 ...
 *
 * const example = ise.identity.getIdentitySourceSequence({
...
export function getIdentitySourceSequence(args?: GetIdentitySourceSequenceArgs, opts?: pulumi.InvokeOptions): Promise<GetIdentitySourceSequenceResult> {
    ...
    return pulumi.runtime.invoke("ise:identity/getIdentitySourceSequence:getIdentitySourceSequence", {
        "id": args.id,
        "name": args.name,
    }, opts);
}
...
export interface GetIdentitySourceSequenceResult {
     ...
     */
    readonly id: string;
    readonly identitySources: outputs.identity.GetIdentitySourceSequenceIdentitySource[];
    /**
     * The name of the identity source sequence
     */
