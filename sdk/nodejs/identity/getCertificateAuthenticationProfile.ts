 ...
 *
 * const example = ise.identity.getCertificateAuthenticationProfile({
...
export function getCertificateAuthenticationProfile(args?: GetCertificateAuthenticationProfileArgs, opts?: pulumi.InvokeOptions): Promise<GetCertificateAuthenticationProfileResult> {
    ...
    return pulumi.runtime.invoke("ise:identity/getCertificateAuthenticationProfile:getCertificateAuthenticationProfile", {
        "id": args.id,
        "name": args.name,
    }, opts);
}
