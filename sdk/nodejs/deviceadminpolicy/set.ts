...
export class Set extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'ise:DeviceAdminPolicy/set:Set';
     ...
     */
    public readonly childrens!: pulumi.Output<outputs.DeviceAdminPolicy.SetChildren[] | undefined>;
    /**
...
export interface SetState {
     ...
     * List of child conditions. `condition_type` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
     */
    childrens?: pulumi.Input<pulumi.Input<inputs.DeviceAdminPolicy.SetChildren>[]>;
    /**
     * Dictionary attribute name
     */
