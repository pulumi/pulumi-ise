 ...
 * ```
 */
export class EgressMatrixCellDefault extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: EgressMatrixCellDefaultState, opts?: pulumi.CustomResourceOptions): EgressMatrixCellDefault {
        return new EgressMatrixCellDefault(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'ise:trustsec/egressMatrixCellDefault:EgressMatrixCellDefault';

    /**
     * Returns true if the given object is an instance of EgressMatrixCellDefault.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is EgressMatrixCellDefault {
    ...
    constructor(name: string, argsOrState?: EgressMatrixCellDefaultArgs | EgressMatrixCellDefaultState, opts?: pulumi.CustomResourceOptions) {
