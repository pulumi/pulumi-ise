 ...
 * ```
 */
export class AuthorizationExceptionRuleUpdateRanks extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AuthorizationExceptionRuleUpdateRanksState, opts?: pulumi.CustomResourceOptions): AuthorizationExceptionRuleUpdateRanks {
        return new AuthorizationExceptionRuleUpdateRanks(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'ise:deviceadmin/authorizationExceptionRuleUpdateRanks:AuthorizationExceptionRuleUpdateRanks';
     ...
     */
    public static isInstance(obj: any): obj is AuthorizationExceptionRuleUpdateRanks {
    ...
    declare public readonly rules: pulumi.Output<outputs.deviceadmin.AuthorizationExceptionRuleUpdateRanksRule[] | undefined>;
    ...
    constructor(name: string, argsOrState?: AuthorizationExceptionRuleUpdateRanksArgs | AuthorizationExceptionRuleUpdateRanksState, opts?: pulumi.CustomResourceOptions) {
