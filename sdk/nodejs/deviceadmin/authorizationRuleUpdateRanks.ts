...
export class AuthorizationRuleUpdateRanks extends pulumi.CustomResource {
    ...
    declare public readonly rules: pulumi.Output<outputs.deviceadmin.AuthorizationRuleUpdateRanksRule[] | undefined>;
...
export interface AuthorizationRuleUpdateRanksState {
    ...
    rules?: pulumi.Input<pulumi.Input<inputs.deviceadmin.AuthorizationRuleUpdateRanksRule>[] | undefined>;
}
