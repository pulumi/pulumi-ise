...
export class PolicySetUpdateRanks extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'ise:deviceadmin/policySetUpdateRanks:PolicySetUpdateRanks';
...
export interface PolicySetUpdateRanksState {
    policies?: pulumi.Input<pulumi.Input<inputs.deviceadmin.PolicySetUpdateRanksPolicy>[] | undefined>;
}
