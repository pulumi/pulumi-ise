...
export class AuthenticationRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'ise:deviceadmin/authenticationRule:AuthenticationRule';
     ...
     */
    declare public readonly childrens: pulumi.Output<outputs.deviceadmin.AuthenticationRuleChildren[] | undefined>;
    /**
...
export interface AuthenticationRuleState {
     ...
     * List of child conditions
     */
    childrens?: pulumi.Input<pulumi.Input<inputs.deviceadmin.AuthenticationRuleChildren>[] | undefined>;
    /**
     * Dictionary attribute name
     */
