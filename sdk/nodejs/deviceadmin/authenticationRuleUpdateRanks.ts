...
export class AuthenticationRuleUpdateRanks extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'ise:deviceadmin/authenticationRuleUpdateRanks:AuthenticationRuleUpdateRanks';
    ...
    declare public readonly rules: pulumi.Output<outputs.deviceadmin.AuthenticationRuleUpdateRanksRule[] | undefined>;
...
export interface AuthenticationRuleUpdateRanksState {
    ...
    rules?: pulumi.Input<pulumi.Input<inputs.deviceadmin.AuthenticationRuleUpdateRanksRule>[] | undefined>;
}
