 ...
 * ```
 */
export class AuthorizationRuleUpdateRank extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AuthorizationRuleUpdateRankState, opts?: pulumi.CustomResourceOptions): AuthorizationRuleUpdateRank {
        return new AuthorizationRuleUpdateRank(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'ise:networkaccess/authorizationRuleUpdateRank:AuthorizationRuleUpdateRank';
     ...
     */
    public static isInstance(obj: any): obj is AuthorizationRuleUpdateRank {
    ...
    constructor(name: string, argsOrState?: AuthorizationRuleUpdateRankArgs | AuthorizationRuleUpdateRankState, opts?: pulumi.CustomResourceOptions) {
