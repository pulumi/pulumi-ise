...
export class AuthorizationRuleUpdateRanks extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'ise:networkaccess/authorizationRuleUpdateRanks:AuthorizationRuleUpdateRanks';
    ...
    declare public readonly rules: pulumi.Output<outputs.networkaccess.AuthorizationRuleUpdateRanksRule[] | undefined>;
...
export interface AuthorizationRuleUpdateRanksState {
    ...
    rules?: pulumi.Input<pulumi.Input<inputs.networkaccess.AuthorizationRuleUpdateRanksRule>[] | undefined>;
}
