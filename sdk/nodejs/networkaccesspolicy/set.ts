...
export class Set extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'ise:NetworkAccessPolicy/set:Set';
     ...
     */
    public readonly childrens!: pulumi.Output<outputs.NetworkAccessPolicy.SetChildren[] | undefined>;
    /**
