...
export function getRule(args: GetRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetRuleResult> {
    ...
    return pulumi.runtime.invoke("ise:NetworkAccessAuthorizationException/getRule:getRule", {
        "id": args.id,
        "name": args.name,
...
export interface GetRuleResult {
     ...
     */
    readonly childrens: outputs.NetworkAccessAuthorizationException.GetRuleChildren[];
    /**
