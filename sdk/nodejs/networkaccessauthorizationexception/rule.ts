...
export class Rule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'ise:NetworkAccessAuthorizationException/rule:Rule';
     ...
     */
    public readonly childrens!: pulumi.Output<outputs.NetworkAccessAuthorizationException.RuleChildren[] | undefined>;
    /**
...
export interface RuleState {
     ...
     * List of child conditions. `condition_type` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
     */
    childrens?: pulumi.Input<pulumi.Input<inputs.NetworkAccessAuthorizationException.RuleChildren>[]>;
    /**
     * Dictionary attribute name
     */
