 ...
 * ```
 */
export class Protocols extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ProtocolsState, opts?: pulumi.CustomResourceOptions): Protocols {
        return new Protocols(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'ise:Allowed/protocols:Protocols';

    /**
     * Returns true if the given object is an instance of Protocols.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Protocols {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === Protocols.__pulumiType;
    }
    ...
    constructor(name: string, argsOrState?: ProtocolsArgs | ProtocolsState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ProtocolsState | undefined;
            ...
            const args = argsOrState as ProtocolsArgs | undefined;
        ...
        super(Protocols.__pulumiType, name, resourceInputs, opts);
    }
}
