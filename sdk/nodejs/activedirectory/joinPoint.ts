 ...
 * ```
 */
export class JoinPoint extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: JoinPointState, opts?: pulumi.CustomResourceOptions): JoinPoint {
        return new JoinPoint(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'ise:activeDirectory/joinPoint:JoinPoint';

    /**
     * Returns true if the given object is an instance of JoinPoint.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is JoinPoint {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === JoinPoint.__pulumiType;
    }
     ...
     */
    public readonly attributes!: pulumi.Output<outputs.activeDirectory.JoinPointAttribute[] | undefined>;
    /**
     ...
     * List of AD Groups
     */
    public readonly groups!: pulumi.Output<outputs.activeDirectory.JoinPointGroup[] | undefined>;
    /**
     ...
     */
    public readonly rewriteRules!: pulumi.Output<outputs.activeDirectory.JoinPointRewriteRule[] | undefined>;
    /**
     ...
     */
    constructor(name: string, args: JoinPointArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: JoinPointArgs | JoinPointState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as JoinPointState | undefined;
            ...
            const args = argsOrState as JoinPointArgs | undefined;
        ...
        super(JoinPoint.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface JoinPointState {
    /**
     * String that contains the names of the scopes that the active directory belongs to. Names are separated by comma. -
     * Default value: `Default_Scope`
     */
     ...
     * List of AD attributes
     */
    attributes?: pulumi.Input<pulumi.Input<inputs.activeDirectory.JoinPointAttribute>[]>;
    /**
     * Enable prevent AD account lockout for WIRELESS/WIRED/BOTH - Choices: `WIRELESS`, `WIRED`, `BOTH`
     */
     ...
     * List of AD Groups
     */
    groups?: pulumi.Input<pulumi.Input<inputs.activeDirectory.JoinPointGroup>[]>;
    /**
     * Identity Not In AD Behaviour - Choices: `REJECT`, `SEARCH_JOINED_FOREST`, `SEARCH_ALL`
     */
     ...
     * List of Rewrite rules
     */
    rewriteRules?: pulumi.Input<pulumi.Input<inputs.activeDirectory.JoinPointRewriteRule>[]>;
    /**
     * Schema - Choices: `ACTIVE_DIRECTORY`, `CUSTOM`
     */
 ...
 */
export interface JoinPointArgs {
    /**
     * String that contains the names of the scopes that the active directory belongs to. Names are separated by comma. -
     * Default value: `Default_Scope`
     */
