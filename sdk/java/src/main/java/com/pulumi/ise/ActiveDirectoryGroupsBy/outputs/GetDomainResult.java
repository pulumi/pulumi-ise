...
import com.pulumi.ise.ActiveDirectoryGroupsBy.outputs.GetDomainGroup;
...
public final class GetDomainResult {
     ...
     * 
     */
    private List<GetDomainGroup> groups;
    /**
     ...
     * 
     */
    public List<GetDomainGroup> groups() {
        return this.groups;
    }
    /**
     * @return The provider-assigned unique ID for this managed resource.
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder groups(List<GetDomainGroup> groups) {
            if (groups == null) {
              throw new MissingRequiredPropertyException("GetDomainResult", "groups");
            }
            this.groups = groups;
            return this;
        }
        public Builder groups(GetDomainGroup... groups) {
        ...
        public Builder joinPointId(String joinPointId) {
            if (joinPointId == null) {
              throw new MissingRequiredPropertyException("GetDomainResult", "joinPointId");
            }
