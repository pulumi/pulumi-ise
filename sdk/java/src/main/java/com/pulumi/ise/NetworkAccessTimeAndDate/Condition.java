...
import com.pulumi.ise.NetworkAccessTimeAndDate.inputs.ConditionState;
 ...
 * 
 */
@ResourceType(type="ise:NetworkAccessTimeAndDate/condition:Condition")
public class Condition extends com.pulumi.resources.CustomResource {
    ...
    public Condition(String name, @Nullable ConditionArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:NetworkAccessTimeAndDate/condition:Condition", name, args == null ? ConditionArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private Condition(String name, Output<String> id, @Nullable ConditionState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:NetworkAccessTimeAndDate/condition:Condition", name, state, makeResourceOptions(options, id));
    }
