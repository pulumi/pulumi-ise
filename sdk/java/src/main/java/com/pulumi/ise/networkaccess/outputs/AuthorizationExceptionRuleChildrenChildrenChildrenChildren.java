...
import com.pulumi.ise.networkaccess.outputs.AuthorizationExceptionRuleChildrenChildrenChildrenChildrenChildren;
...
@CustomType
public final class AuthorizationExceptionRuleChildrenChildrenChildrenChildren {
    /**
     ...
     * 
     */
    private @Nullable List<AuthorizationExceptionRuleChildrenChildrenChildrenChildrenChildren> childrens;
    /**
    ...
    private AuthorizationExceptionRuleChildrenChildrenChildrenChildren() {}
    /**
     * @return Dictionary attribute name
     * 
     */
     ...
     * 
     */
    public List<AuthorizationExceptionRuleChildrenChildrenChildrenChildrenChildren> childrens() {
    ...
    public static Builder builder(AuthorizationExceptionRuleChildrenChildrenChildrenChildren defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String operator;
        public Builder() {}
        public Builder(AuthorizationExceptionRuleChildrenChildrenChildrenChildren defaults) {
        ...
        @CustomType.Setter
        public Builder childrens(@Nullable List<AuthorizationExceptionRuleChildrenChildrenChildrenChildrenChildren> childrens) {

            this.childrens = childrens;
            return this;
        }
        public Builder childrens(AuthorizationExceptionRuleChildrenChildrenChildrenChildrenChildren... childrens) {
            return childrens(List.of(childrens));
        }
        @CustomType.Setter
        public Builder conditionType(String conditionType) {
            if (conditionType == null) {
              throw new MissingRequiredPropertyException("AuthorizationExceptionRuleChildrenChildrenChildrenChildren", "conditionType");
            }
        ...
        public AuthorizationExceptionRuleChildrenChildrenChildrenChildren build() {
            final var _resultValue = new AuthorizationExceptionRuleChildrenChildrenChildrenChildren();
