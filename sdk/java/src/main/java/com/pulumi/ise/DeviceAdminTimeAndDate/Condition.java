...
package com.pulumi.ise.DeviceAdminTimeAndDate;
...
import com.pulumi.ise.DeviceAdminTimeAndDate.inputs.ConditionState;
 ...
 * 
 */
@ResourceType(type="ise:DeviceAdminTimeAndDate/condition:Condition")
public class Condition extends com.pulumi.resources.CustomResource {
     ...
     */
    public Condition(String name, @Nullable ConditionArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public Condition(String name, @Nullable ConditionArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:DeviceAdminTimeAndDate/condition:Condition", name, args == null ? ConditionArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private Condition(String name, Output<String> id, @Nullable ConditionState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:DeviceAdminTimeAndDate/condition:Condition", name, state, makeResourceOptions(options, id));
    }
