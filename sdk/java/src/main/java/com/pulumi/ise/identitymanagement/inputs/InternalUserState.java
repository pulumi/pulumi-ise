...
public final class InternalUserState extends com.pulumi.resources.ResourceArgs {

    public static final InternalUserState Empty = new InternalUserState();
    ...
    private InternalUserState() {}

    private InternalUserState(InternalUserState $) {
    ...
    public static Builder builder(InternalUserState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InternalUserState();
        }

        public Builder(InternalUserState defaults) {
            $ = new InternalUserState(Objects.requireNonNull(defaults));
        }
        ...
        public InternalUserState build() {
            return $;
        }
    }
