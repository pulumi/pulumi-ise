...
public final class GetActiveDirectoryGroupsByDomainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetActiveDirectoryGroupsByDomainArgs Empty = new GetActiveDirectoryGroupsByDomainArgs();
    ...
    private GetActiveDirectoryGroupsByDomainArgs(GetActiveDirectoryGroupsByDomainArgs $) {
        this.domain = $.domain;
        this.filter = $.filter;
    ...
    public static Builder builder(GetActiveDirectoryGroupsByDomainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetActiveDirectoryGroupsByDomainArgs();
        }

        public Builder(GetActiveDirectoryGroupsByDomainArgs defaults) {
            $ = new GetActiveDirectoryGroupsByDomainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetActiveDirectoryGroupsByDomainArgs build() {
            if ($.domain == null) {
                throw new MissingRequiredPropertyException("GetActiveDirectoryGroupsByDomainArgs", "domain");
            }
            if ($.joinPointId == null) {
                throw new MissingRequiredPropertyException("GetActiveDirectoryGroupsByDomainArgs", "joinPointId");
            }
            return $;
        }
    }
