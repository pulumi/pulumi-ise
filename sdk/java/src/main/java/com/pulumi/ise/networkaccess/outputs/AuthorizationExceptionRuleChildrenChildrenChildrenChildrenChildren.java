...
import com.pulumi.ise.networkaccess.outputs.AuthorizationExceptionRuleChildrenChildrenChildrenChildrenChildrenChildren;
...
@CustomType
public final class AuthorizationExceptionRuleChildrenChildrenChildrenChildrenChildren {
    /**
     ...
     * 
     */
    private @Nullable List<AuthorizationExceptionRuleChildrenChildrenChildrenChildrenChildrenChildren> childrens;
    /**
    ...
    private AuthorizationExceptionRuleChildrenChildrenChildrenChildrenChildren() {}
    /**
     * @return Dictionary attribute name
     * 
     */
     ...
     * 
     */
    public List<AuthorizationExceptionRuleChildrenChildrenChildrenChildrenChildrenChildren> childrens() {
    ...
    public static Builder builder(AuthorizationExceptionRuleChildrenChildrenChildrenChildrenChildren defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String operator;
        public Builder() {}
        public Builder(AuthorizationExceptionRuleChildrenChildrenChildrenChildrenChildren defaults) {
        ...
        @CustomType.Setter
        public Builder childrens(@Nullable List<AuthorizationExceptionRuleChildrenChildrenChildrenChildrenChildrenChildren> childrens) {

            this.childrens = childrens;
            return this;
        }
        public Builder childrens(AuthorizationExceptionRuleChildrenChildrenChildrenChildrenChildrenChildren... childrens) {
            return childrens(List.of(childrens));
        }
        @CustomType.Setter
        public Builder conditionType(String conditionType) {
            if (conditionType == null) {
              throw new MissingRequiredPropertyException("AuthorizationExceptionRuleChildrenChildrenChildrenChildrenChildren", "conditionType");
            }
        ...
        public AuthorizationExceptionRuleChildrenChildrenChildrenChildrenChildren build() {
            final var _resultValue = new AuthorizationExceptionRuleChildrenChildrenChildrenChildrenChildren();
