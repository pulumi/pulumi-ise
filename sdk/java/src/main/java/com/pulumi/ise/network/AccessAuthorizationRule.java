...
import com.pulumi.ise.network.AccessAuthorizationRuleArgs;
import com.pulumi.ise.network.inputs.AccessAuthorizationRuleState;
import com.pulumi.ise.network.outputs.AccessAuthorizationRuleChildren;
 ...
 * import com.pulumi.core.Output;
 * import com.pulumi.ise.network.AccessAuthorizationRule;
 * import com.pulumi.ise.network.AccessAuthorizationRuleArgs;
 * import java.util.List;
 ...
 *         var example = new AccessAuthorizationRule(&#34;example&#34;, AccessAuthorizationRuleArgs.builder()        
 ...
 * 
 */
@ResourceType(type="ise:network/accessAuthorizationRule:AccessAuthorizationRule")
public class AccessAuthorizationRule extends com.pulumi.resources.CustomResource {
    /**
     * List of child conditions. `condition_type` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
     * 
     */
    @Export(name="childrens", refs={List.class,AccessAuthorizationRuleChildren.class}, tree="[0,1]")
    private Output</* @Nullable */ List<AccessAuthorizationRuleChildren>> childrens;

    /**
     * @return List of child conditions. `condition_type` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
     * 
     */
    public Output<Optional<List<AccessAuthorizationRuleChildren>>> childrens() {
     ...
     */
    public AccessAuthorizationRule(String name) {
        this(name, AccessAuthorizationRuleArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public AccessAuthorizationRule(String name, AccessAuthorizationRuleArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public AccessAuthorizationRule(String name, AccessAuthorizationRuleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:network/accessAuthorizationRule:AccessAuthorizationRule", name, args == null ? AccessAuthorizationRuleArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private AccessAuthorizationRule(String name, Output<String> id, @Nullable AccessAuthorizationRuleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:network/accessAuthorizationRule:AccessAuthorizationRule", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static AccessAuthorizationRule get(String name, Output<String> id, @Nullable AccessAuthorizationRuleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
