...
public final class AddGroupsState extends com.pulumi.resources.ResourceArgs {

    public static final AddGroupsState Empty = new AddGroupsState();
    ...
    private AddGroupsState() {}

    private AddGroupsState(AddGroupsState $) {
    ...
    public static Builder builder(AddGroupsState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(AddGroupsState defaults) {
            $ = new AddGroupsState(Objects.requireNonNull(defaults));
        }
