...
import com.pulumi.ise.Allowed.inputs.ProtocolsState;
 ...
 * 
 */
@ResourceType(type="ise:Allowed/protocols:Protocols")
public class Protocols extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public Protocols(String name) {
        this(name, ProtocolsArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public Protocols(String name, ProtocolsArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public Protocols(String name, ProtocolsArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:Allowed/protocols:Protocols", name, args == null ? ProtocolsArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Protocols(String name, Output<String> id, @Nullable ProtocolsState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:Allowed/protocols:Protocols", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static Protocols get(String name, Output<String> id, @Nullable ProtocolsState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
