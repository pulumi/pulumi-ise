...
public final class AccessDictionaryState extends com.pulumi.resources.ResourceArgs {

    public static final AccessDictionaryState Empty = new AccessDictionaryState();
    ...
    private AccessDictionaryState() {}

    private AccessDictionaryState(AccessDictionaryState $) {
    ...
    public static Builder builder(AccessDictionaryState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AccessDictionaryState();
        }

        public Builder(AccessDictionaryState defaults) {
            $ = new AccessDictionaryState(Objects.requireNonNull(defaults));
        }
        ...
        public AccessDictionaryState build() {
            return $;
        }
    }
