...
public final class SequenceState extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<List<SequenceIdentitySourceArgs>> identitySources;

    public Optional<Output<List<SequenceIdentitySourceArgs>>> identitySources() {
    ...
    public static final class Builder {
        ...
        public Builder identitySources(@Nullable Output<List<SequenceIdentitySourceArgs>> identitySources) {
