...
import com.pulumi.ise.networkaccess.outputs.AuthenticationRuleChildrenChildrenChildrenChildrenChildren;
...
@CustomType
public final class AuthenticationRuleChildrenChildrenChildrenChildren {
    /**
     ...
     * 
     */
    private @Nullable List<AuthenticationRuleChildrenChildrenChildrenChildrenChildren> childrens;
    /**
    ...
    private AuthenticationRuleChildrenChildrenChildrenChildren() {}
    /**
     * @return Dictionary attribute name
     * 
     */
     ...
     * 
     */
    public List<AuthenticationRuleChildrenChildrenChildrenChildrenChildren> childrens() {
    ...
    public static Builder builder(AuthenticationRuleChildrenChildrenChildrenChildren defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String operator;
        public Builder() {}
        public Builder(AuthenticationRuleChildrenChildrenChildrenChildren defaults) {
        ...
        @CustomType.Setter
        public Builder childrens(@Nullable List<AuthenticationRuleChildrenChildrenChildrenChildrenChildren> childrens) {

            this.childrens = childrens;
            return this;
        }
        public Builder childrens(AuthenticationRuleChildrenChildrenChildrenChildrenChildren... childrens) {
            return childrens(List.of(childrens));
        }
        @CustomType.Setter
        public Builder conditionType(String conditionType) {
            if (conditionType == null) {
              throw new MissingRequiredPropertyException("AuthenticationRuleChildrenChildrenChildrenChildren", "conditionType");
            }
        ...
        public AuthenticationRuleChildrenChildrenChildrenChildren build() {
            final var _resultValue = new AuthenticationRuleChildrenChildrenChildrenChildren();
