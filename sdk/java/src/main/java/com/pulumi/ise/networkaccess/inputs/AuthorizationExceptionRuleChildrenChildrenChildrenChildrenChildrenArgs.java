...
import com.pulumi.ise.networkaccess.inputs.AuthorizationExceptionRuleChildrenChildrenChildrenChildrenChildrenChildrenArgs;
...
public final class AuthorizationExceptionRuleChildrenChildrenChildrenChildrenChildrenArgs extends com.pulumi.resources.ResourceArgs {

    public static final AuthorizationExceptionRuleChildrenChildrenChildrenChildrenChildrenArgs Empty = new AuthorizationExceptionRuleChildrenChildrenChildrenChildrenChildrenArgs();
    ...
    private @Nullable Output<List<AuthorizationExceptionRuleChildrenChildrenChildrenChildrenChildrenChildrenArgs>> childrens;

    /**
     * @return List of child conditions
     * 
     */
    public Optional<Output<List<AuthorizationExceptionRuleChildrenChildrenChildrenChildrenChildrenChildrenArgs>>> childrens() {
    ...
    private AuthorizationExceptionRuleChildrenChildrenChildrenChildrenChildrenArgs() {}

    private AuthorizationExceptionRuleChildrenChildrenChildrenChildrenChildrenArgs(AuthorizationExceptionRuleChildrenChildrenChildrenChildrenChildrenArgs $) {
    ...
    public static Builder builder(AuthorizationExceptionRuleChildrenChildrenChildrenChildrenChildrenArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AuthorizationExceptionRuleChildrenChildrenChildrenChildrenChildrenArgs();
        }

        public Builder(AuthorizationExceptionRuleChildrenChildrenChildrenChildrenChildrenArgs defaults) {
            $ = new AuthorizationExceptionRuleChildrenChildrenChildrenChildrenChildrenArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder childrens(@Nullable Output<List<AuthorizationExceptionRuleChildrenChildrenChildrenChildrenChildrenChildrenArgs>> childrens) {
            $.childrens = childrens;
            return this;
        }
         ...
         * 
         */
        public Builder childrens(List<AuthorizationExceptionRuleChildrenChildrenChildrenChildrenChildrenChildrenArgs> childrens) {
         ...
         * 
         */
        public Builder childrens(AuthorizationExceptionRuleChildrenChildrenChildrenChildrenChildrenChildrenArgs... childrens) {
        ...
        public AuthorizationExceptionRuleChildrenChildrenChildrenChildrenChildrenArgs build() {
            if ($.conditionType == null) {
                throw new MissingRequiredPropertyException("AuthorizationExceptionRuleChildrenChildrenChildrenChildrenChildrenArgs", "conditionType");
            }
            return $;
        }
    }
