...
public final class PointState extends com.pulumi.resources.ResourceArgs {

    public static final PointState Empty = new PointState();
    ...
    public static Builder builder(PointState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(PointState defaults) {
            $ = new PointState(Objects.requireNonNull(defaults));
        }
