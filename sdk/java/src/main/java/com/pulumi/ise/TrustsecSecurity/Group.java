...
import com.pulumi.ise.TrustsecSecurity.inputs.GroupState;
 ...
 * 
 */
@ResourceType(type="ise:TrustsecSecurity/group:Group")
public class Group extends com.pulumi.resources.CustomResource {
    ...
    public Group(String name, GroupArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:TrustsecSecurity/group:Group", name, args == null ? GroupArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private Group(String name, Output<String> id, @Nullable GroupState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:TrustsecSecurity/group:Group", name, state, makeResourceOptions(options, id));
    }
