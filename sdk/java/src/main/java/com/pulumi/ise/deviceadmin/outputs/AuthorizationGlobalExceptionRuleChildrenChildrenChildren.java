...
import com.pulumi.ise.deviceadmin.outputs.AuthorizationGlobalExceptionRuleChildrenChildrenChildrenChildren;
...
@CustomType
public final class AuthorizationGlobalExceptionRuleChildrenChildrenChildren {
    /**
     ...
     * 
     */
    private @Nullable List<AuthorizationGlobalExceptionRuleChildrenChildrenChildrenChildren> childrens;
    /**
    ...
    private AuthorizationGlobalExceptionRuleChildrenChildrenChildren() {}
    /**
     * @return Dictionary attribute name
     * 
     */
     ...
     * 
     */
    public List<AuthorizationGlobalExceptionRuleChildrenChildrenChildrenChildren> childrens() {
    ...
    public static Builder builder(AuthorizationGlobalExceptionRuleChildrenChildrenChildren defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String operator;
        public Builder() {}
        public Builder(AuthorizationGlobalExceptionRuleChildrenChildrenChildren defaults) {
        ...
        @CustomType.Setter
        public Builder childrens(@Nullable List<AuthorizationGlobalExceptionRuleChildrenChildrenChildrenChildren> childrens) {

            this.childrens = childrens;
            return this;
        }
        public Builder childrens(AuthorizationGlobalExceptionRuleChildrenChildrenChildrenChildren... childrens) {
            return childrens(List.of(childrens));
        }
        @CustomType.Setter
        public Builder conditionType(String conditionType) {
            if (conditionType == null) {
              throw new MissingRequiredPropertyException("AuthorizationGlobalExceptionRuleChildrenChildrenChildren", "conditionType");
            }
        ...
        public AuthorizationGlobalExceptionRuleChildrenChildrenChildren build() {
            final var _resultValue = new AuthorizationGlobalExceptionRuleChildrenChildrenChildren();
