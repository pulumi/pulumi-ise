...
import com.pulumi.ise.DeviceAdminAuthorization.inputs.GetRulePlainArgs;
import com.pulumi.ise.DeviceAdminAuthorization.outputs.GetRuleResult;
import com.pulumi.ise.Utilities;
import java.util.concurrent.CompletableFuture;

public final class DeviceAdminAuthorizationFunctions {
    /**
    ...
    public static Output<GetRuleResult> getRule(GetRuleArgs args, InvokeOptions options) {
        return Deployment.getInstance().invoke("ise:DeviceAdminAuthorization/getRule:getRule", TypeShape.of(GetRuleResult.class), args, Utilities.withVersion(options));
    }
    /**
     * This data source can read the Device Admin Authorization Rule.
     * 
    ...
    public static CompletableFuture<GetRuleResult> getRulePlain(GetRulePlainArgs args, InvokeOptions options) {
        return Deployment.getInstance().invokeAsync("ise:DeviceAdminAuthorization/getRule:getRule", TypeShape.of(GetRuleResult.class), args, Utilities.withVersion(options));
    }
}
