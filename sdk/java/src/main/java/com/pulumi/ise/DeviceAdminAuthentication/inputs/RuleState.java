...
import com.pulumi.ise.DeviceAdminAuthentication.inputs.RuleChildrenArgs;
...
public final class RuleState extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param ifProcessFail Action to perform when ISE is unable to access the identity database - Choices: `REJECT`, `DROP`, `CONTINUE`
         * 
         * @return builder
         * 
         */
