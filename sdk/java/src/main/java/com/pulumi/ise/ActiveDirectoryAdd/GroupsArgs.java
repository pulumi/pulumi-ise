...
public final class GroupsArgs extends com.pulumi.resources.ResourceArgs {

    public static final GroupsArgs Empty = new GroupsArgs();
    ...
    public static Builder builder(GroupsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GroupsArgs defaults) {
            $ = new GroupsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GroupsArgs build() {
            if ($.domain == null) {
                throw new MissingRequiredPropertyException("GroupsArgs", "domain");
            }
            if ($.joinPointId == null) {
                throw new MissingRequiredPropertyException("GroupsArgs", "joinPointId");
            }
            return $;
        }
    }
