...
import com.pulumi.ise.identity.EndpointArgs;
import com.pulumi.ise.identity.inputs.EndpointState;
 ...
 * import com.pulumi.core.Output;
 * import com.pulumi.ise.identity.Endpoint;
 * import com.pulumi.ise.identity.EndpointArgs;
 ...
 * 
 */
@ResourceType(type="ise:identity/endpoint:Endpoint")
public class Endpoint extends com.pulumi.resources.CustomResource {
    ...
    public Endpoint(String name, EndpointArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:identity/endpoint:Endpoint", name, args == null ? EndpointArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private Endpoint(String name, Output<String> id, @Nullable EndpointState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:identity/endpoint:Endpoint", name, state, makeResourceOptions(options, id));
    }
