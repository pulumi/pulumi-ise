...
import com.pulumi.ise.network.inputs.AccessPolicySetChildrenChildrenArgs;
...
public final class AccessPolicySetChildrenArgs extends com.pulumi.resources.ResourceArgs {

    public static final AccessPolicySetChildrenArgs Empty = new AccessPolicySetChildrenArgs();
    ...
    private @Nullable Output<List<AccessPolicySetChildrenChildrenArgs>> childrens;

    /**
     * @return List of child conditions. `condition_type` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
     * 
     */
    public Optional<Output<List<AccessPolicySetChildrenChildrenArgs>>> childrens() {
    ...
    private AccessPolicySetChildrenArgs() {}

    private AccessPolicySetChildrenArgs(AccessPolicySetChildrenArgs $) {
    ...
    public static Builder builder(AccessPolicySetChildrenArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AccessPolicySetChildrenArgs();
        }

        public Builder(AccessPolicySetChildrenArgs defaults) {
            $ = new AccessPolicySetChildrenArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder childrens(@Nullable Output<List<AccessPolicySetChildrenChildrenArgs>> childrens) {
            $.childrens = childrens;
            return this;
        }
         ...
         * 
         */
        public Builder childrens(List<AccessPolicySetChildrenChildrenArgs> childrens) {
         ...
         * 
         */
        public Builder childrens(AccessPolicySetChildrenChildrenArgs... childrens) {
        ...
        public AccessPolicySetChildrenArgs build() {
            if ($.conditionType == null) {
                throw new MissingRequiredPropertyException("AccessPolicySetChildrenArgs", "conditionType");
            }
            return $;
        }
    }
