...
import com.pulumi.ise.TrustsecEgressMatrix.inputs.CellState;
 ...
 * 
 */
@ResourceType(type="ise:TrustsecEgressMatrix/cell:Cell")
public class Cell extends com.pulumi.resources.CustomResource {
    ...
    public Cell(String name, CellArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:TrustsecEgressMatrix/cell:Cell", name, args == null ? CellArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private Cell(String name, Output<String> id, @Nullable CellState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:TrustsecEgressMatrix/cell:Cell", name, state, makeResourceOptions(options, id));
    }
