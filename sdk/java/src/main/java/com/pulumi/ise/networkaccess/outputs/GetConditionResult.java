...
import com.pulumi.ise.networkaccess.outputs.GetConditionChildren;
    ...
    public static final class Builder {
        ...
        public Builder attributeName(String attributeName) {
            if (attributeName == null) {
              throw new MissingRequiredPropertyException("GetConditionResult", "attributeName");
            }
        ...
        public Builder attributeValue(String attributeValue) {
            if (attributeValue == null) {
              throw new MissingRequiredPropertyException("GetConditionResult", "attributeValue");
            }
            this.attributeValue = attributeValue;
            return this;
        }
        @CustomType.Setter
        public Builder childrens(List<GetConditionChildren> childrens) {
            if (childrens == null) {
              throw new MissingRequiredPropertyException("GetConditionResult", "childrens");
            }
            this.childrens = childrens;
            return this;
        }
        public Builder childrens(GetConditionChildren... childrens) {
            return childrens(List.of(childrens));
        }
        @CustomType.Setter
        public Builder conditionType(String conditionType) {
            if (conditionType == null) {
              throw new MissingRequiredPropertyException("GetConditionResult", "conditionType");
            }
        ...
        public Builder dictionaryName(String dictionaryName) {
            if (dictionaryName == null) {
              throw new MissingRequiredPropertyException("GetConditionResult", "dictionaryName");
            }
        ...
        public Builder dictionaryValue(String dictionaryValue) {
            if (dictionaryValue == null) {
              throw new MissingRequiredPropertyException("GetConditionResult", "dictionaryValue");
            }
        ...
        public Builder operator(String operator) {
            if (operator == null) {
              throw new MissingRequiredPropertyException("GetConditionResult", "operator");
            }
