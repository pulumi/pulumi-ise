...
import com.pulumi.ise.DeviceAdminAuthorizationGlobalException.inputs.RuleState;
import com.pulumi.ise.DeviceAdminAuthorizationGlobalException.outputs.RuleChildren;
 ...
 * 
 */
@ResourceType(type="ise:DeviceAdminAuthorizationGlobalException/rule:Rule")
public class Rule extends com.pulumi.resources.CustomResource {
    ...
    public Rule(String name, @Nullable RuleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:DeviceAdminAuthorizationGlobalException/rule:Rule", name, args == null ? RuleArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private Rule(String name, Output<String> id, @Nullable RuleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:DeviceAdminAuthorizationGlobalException/rule:Rule", name, state, makeResourceOptions(options, id));
    }
