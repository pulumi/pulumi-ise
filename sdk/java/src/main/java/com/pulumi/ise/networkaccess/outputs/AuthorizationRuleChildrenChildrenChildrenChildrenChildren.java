...
import com.pulumi.ise.networkaccess.outputs.AuthorizationRuleChildrenChildrenChildrenChildrenChildrenChildren;
...
@CustomType
public final class AuthorizationRuleChildrenChildrenChildrenChildrenChildren {
    /**
     ...
     * 
     */
    private @Nullable List<AuthorizationRuleChildrenChildrenChildrenChildrenChildrenChildren> childrens;
    /**
    ...
    private AuthorizationRuleChildrenChildrenChildrenChildrenChildren() {}
    /**
     * @return Dictionary attribute name
     * 
     */
     ...
     * 
     */
    public List<AuthorizationRuleChildrenChildrenChildrenChildrenChildrenChildren> childrens() {
    ...
    public static Builder builder(AuthorizationRuleChildrenChildrenChildrenChildrenChildren defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String operator;
        public Builder() {}
        public Builder(AuthorizationRuleChildrenChildrenChildrenChildrenChildren defaults) {
        ...
        @CustomType.Setter
        public Builder childrens(@Nullable List<AuthorizationRuleChildrenChildrenChildrenChildrenChildrenChildren> childrens) {

            this.childrens = childrens;
            return this;
        }
        public Builder childrens(AuthorizationRuleChildrenChildrenChildrenChildrenChildrenChildren... childrens) {
            return childrens(List.of(childrens));
        }
        @CustomType.Setter
        public Builder conditionType(String conditionType) {
            if (conditionType == null) {
              throw new MissingRequiredPropertyException("AuthorizationRuleChildrenChildrenChildrenChildrenChildren", "conditionType");
            }
        ...
        public AuthorizationRuleChildrenChildrenChildrenChildrenChildren build() {
            final var _resultValue = new AuthorizationRuleChildrenChildrenChildrenChildrenChildren();
