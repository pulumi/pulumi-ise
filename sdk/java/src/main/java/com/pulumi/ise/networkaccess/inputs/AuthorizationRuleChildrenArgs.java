...
import com.pulumi.ise.networkaccess.inputs.AuthorizationRuleChildrenChildrenArgs;
...
public final class AuthorizationRuleChildrenArgs extends com.pulumi.resources.ResourceArgs {

    public static final AuthorizationRuleChildrenArgs Empty = new AuthorizationRuleChildrenArgs();
    ...
    private @Nullable Output<List<AuthorizationRuleChildrenChildrenArgs>> childrens;

    /**
     * @return List of child conditions. `condition_type` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
     * 
     */
    public Optional<Output<List<AuthorizationRuleChildrenChildrenArgs>>> childrens() {
    ...
    private AuthorizationRuleChildrenArgs() {}

    private AuthorizationRuleChildrenArgs(AuthorizationRuleChildrenArgs $) {
    ...
    public static Builder builder(AuthorizationRuleChildrenArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AuthorizationRuleChildrenArgs();
        }

        public Builder(AuthorizationRuleChildrenArgs defaults) {
            $ = new AuthorizationRuleChildrenArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder childrens(@Nullable Output<List<AuthorizationRuleChildrenChildrenArgs>> childrens) {
            $.childrens = childrens;
            return this;
        }
         ...
         * 
         */
        public Builder childrens(List<AuthorizationRuleChildrenChildrenArgs> childrens) {
         ...
         * 
         */
        public Builder childrens(AuthorizationRuleChildrenChildrenArgs... childrens) {
        ...
        public AuthorizationRuleChildrenArgs build() {
            if ($.conditionType == null) {
                throw new MissingRequiredPropertyException("AuthorizationRuleChildrenArgs", "conditionType");
            }
            return $;
        }
    }
