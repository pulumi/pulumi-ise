...
package com.pulumi.ise.NetworkAccessTimeAndDate.outputs;
...
@CustomType
public final class GetConditionResult {
    /**
    ...
    public static Builder builder(GetConditionResult defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> weekDaysExceptions;
        public Builder() {}
        public Builder(GetConditionResult defaults) {
        ...
        public Builder description(String description) {
            if (description == null) {
              throw new MissingRequiredPropertyException("GetConditionResult", "description");
            }
        ...
        public Builder endDate(String endDate) {
            if (endDate == null) {
              throw new MissingRequiredPropertyException("GetConditionResult", "endDate");
            }
        ...
        public Builder endTime(String endTime) {
            if (endTime == null) {
              throw new MissingRequiredPropertyException("GetConditionResult", "endTime");
            }
        ...
        public Builder exceptionEndDate(String exceptionEndDate) {
            if (exceptionEndDate == null) {
              throw new MissingRequiredPropertyException("GetConditionResult", "exceptionEndDate");
            }
        ...
        public Builder exceptionEndTime(String exceptionEndTime) {
            if (exceptionEndTime == null) {
              throw new MissingRequiredPropertyException("GetConditionResult", "exceptionEndTime");
            }
        ...
        public Builder exceptionStartDate(String exceptionStartDate) {
            if (exceptionStartDate == null) {
              throw new MissingRequiredPropertyException("GetConditionResult", "exceptionStartDate");
            }
        ...
        public Builder exceptionStartTime(String exceptionStartTime) {
            if (exceptionStartTime == null) {
              throw new MissingRequiredPropertyException("GetConditionResult", "exceptionStartTime");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetConditionResult", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder isNegate(Boolean isNegate) {
            if (isNegate == null) {
              throw new MissingRequiredPropertyException("GetConditionResult", "isNegate");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetConditionResult", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder startDate(String startDate) {
            if (startDate == null) {
              throw new MissingRequiredPropertyException("GetConditionResult", "startDate");
            }
        ...
        public Builder startTime(String startTime) {
            if (startTime == null) {
              throw new MissingRequiredPropertyException("GetConditionResult", "startTime");
            }
        ...
        public Builder weekDays(List<String> weekDays) {
            if (weekDays == null) {
              throw new MissingRequiredPropertyException("GetConditionResult", "weekDays");
            }
        ...
        public Builder weekDaysExceptions(List<String> weekDaysExceptions) {
            if (weekDaysExceptions == null) {
              throw new MissingRequiredPropertyException("GetConditionResult", "weekDaysExceptions");
            }
        ...
        public GetConditionResult build() {
            final var _resultValue = new GetConditionResult();
