...
import com.pulumi.ise.NetworkAccessPolicy.inputs.SetChildrenArgs;
...
public final class SetArgs extends com.pulumi.resources.ResourceArgs {

    public static final SetArgs Empty = new SetArgs();
    ...
    private @Nullable Output<List<SetChildrenArgs>> childrens;

    /**
     * @return List of child conditions. `condition_type` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
     * 
     */
    public Optional<Output<List<SetChildrenArgs>>> childrens() {
    ...
    public static Builder builder(SetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(SetArgs defaults) {
            $ = new SetArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder childrens(@Nullable Output<List<SetChildrenArgs>> childrens) {
            $.childrens = childrens;
            return this;
        }
         ...
         * 
         */
        public Builder childrens(List<SetChildrenArgs> childrens) {
         ...
         * 
         */
        public Builder childrens(SetChildrenArgs... childrens) {
        ...
        public SetArgs build() {
            if ($.serviceName == null) {
                throw new MissingRequiredPropertyException("SetArgs", "serviceName");
            }
            return $;
        }
    }
