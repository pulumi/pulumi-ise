...
import com.pulumi.ise.tacacs.AllowedProtocolsArgs;
import com.pulumi.ise.tacacs.inputs.AllowedProtocolsState;
 ...
 * import com.pulumi.core.Output;
 * import com.pulumi.ise.tacacs.AllowedProtocols;
 * import com.pulumi.ise.tacacs.AllowedProtocolsArgs;
 ...
 * 
 */
@ResourceType(type="ise:tacacs/allowedProtocols:AllowedProtocols")
public class AllowedProtocols extends com.pulumi.resources.CustomResource {
    ...
    public AllowedProtocols(String name, AllowedProtocolsArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:tacacs/allowedProtocols:AllowedProtocols", name, args == null ? AllowedProtocolsArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private AllowedProtocols(String name, Output<String> id, @Nullable AllowedProtocolsState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:tacacs/allowedProtocols:AllowedProtocols", name, state, makeResourceOptions(options, id));
    }
