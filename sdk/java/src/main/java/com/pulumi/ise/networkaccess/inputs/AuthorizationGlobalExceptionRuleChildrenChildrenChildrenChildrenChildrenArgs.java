...
import com.pulumi.ise.networkaccess.inputs.AuthorizationGlobalExceptionRuleChildrenChildrenChildrenChildrenChildrenChildrenArgs;
...
public final class AuthorizationGlobalExceptionRuleChildrenChildrenChildrenChildrenChildrenArgs extends com.pulumi.resources.ResourceArgs {

    public static final AuthorizationGlobalExceptionRuleChildrenChildrenChildrenChildrenChildrenArgs Empty = new AuthorizationGlobalExceptionRuleChildrenChildrenChildrenChildrenChildrenArgs();
    ...
    private @Nullable Output<List<AuthorizationGlobalExceptionRuleChildrenChildrenChildrenChildrenChildrenChildrenArgs>> childrens;

    /**
     * @return List of child conditions
     * 
     */
    public Optional<Output<List<AuthorizationGlobalExceptionRuleChildrenChildrenChildrenChildrenChildrenChildrenArgs>>> childrens() {
    ...
    private AuthorizationGlobalExceptionRuleChildrenChildrenChildrenChildrenChildrenArgs() {}

    private AuthorizationGlobalExceptionRuleChildrenChildrenChildrenChildrenChildrenArgs(AuthorizationGlobalExceptionRuleChildrenChildrenChildrenChildrenChildrenArgs $) {
    ...
    public static Builder builder(AuthorizationGlobalExceptionRuleChildrenChildrenChildrenChildrenChildrenArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AuthorizationGlobalExceptionRuleChildrenChildrenChildrenChildrenChildrenArgs();
        }

        public Builder(AuthorizationGlobalExceptionRuleChildrenChildrenChildrenChildrenChildrenArgs defaults) {
            $ = new AuthorizationGlobalExceptionRuleChildrenChildrenChildrenChildrenChildrenArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param attributeValue Attribute value for condition
         * 
         * @return builder
         * 
         */
         ...
         * 
         */
        public Builder childrens(@Nullable Output<List<AuthorizationGlobalExceptionRuleChildrenChildrenChildrenChildrenChildrenChildrenArgs>> childrens) {
            $.childrens = childrens;
            return this;
        }
         ...
         * 
         */
        public Builder childrens(List<AuthorizationGlobalExceptionRuleChildrenChildrenChildrenChildrenChildrenChildrenArgs> childrens) {
         ...
         * 
         */
        public Builder childrens(AuthorizationGlobalExceptionRuleChildrenChildrenChildrenChildrenChildrenChildrenArgs... childrens) {
        ...
        public AuthorizationGlobalExceptionRuleChildrenChildrenChildrenChildrenChildrenArgs build() {
            if ($.conditionType == null) {
                throw new MissingRequiredPropertyException("AuthorizationGlobalExceptionRuleChildrenChildrenChildrenChildrenChildrenArgs", "conditionType");
            }
            return $;
        }
    }
