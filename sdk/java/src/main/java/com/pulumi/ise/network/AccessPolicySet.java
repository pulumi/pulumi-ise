...
import com.pulumi.ise.network.AccessPolicySetArgs;
import com.pulumi.ise.network.inputs.AccessPolicySetState;
import com.pulumi.ise.network.outputs.AccessPolicySetChildren;
 ...
 * import com.pulumi.core.Output;
 * import com.pulumi.ise.network.AccessPolicySet;
 * import com.pulumi.ise.network.AccessPolicySetArgs;
 * import java.util.List;
 ...
 *         var example = new AccessPolicySet(&#34;example&#34;, AccessPolicySetArgs.builder()        
 *             .name(&#34;PolicySet1&#34;)
 ...
 * 
 */
@ResourceType(type="ise:network/accessPolicySet:AccessPolicySet")
public class AccessPolicySet extends com.pulumi.resources.CustomResource {
    /**
     * List of child conditions. `condition_type` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
     * 
     */
    @Export(name="childrens", refs={List.class,AccessPolicySetChildren.class}, tree="[0,1]")
    private Output</* @Nullable */ List<AccessPolicySetChildren>> childrens;

    /**
     * @return List of child conditions. `condition_type` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
     * 
     */
    public Output<Optional<List<AccessPolicySetChildren>>> childrens() {
     ...
     */
    public AccessPolicySet(String name) {
        this(name, AccessPolicySetArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public AccessPolicySet(String name, AccessPolicySetArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public AccessPolicySet(String name, AccessPolicySetArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:network/accessPolicySet:AccessPolicySet", name, args == null ? AccessPolicySetArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private AccessPolicySet(String name, Output<String> id, @Nullable AccessPolicySetState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:network/accessPolicySet:AccessPolicySet", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static AccessPolicySet get(String name, Output<String> id, @Nullable AccessPolicySetState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
