...
import com.pulumi.ise.DeviceAdminAuthorizationException.inputs.GetRulePlainArgs;
import com.pulumi.ise.DeviceAdminAuthorizationException.outputs.GetRuleResult;
import com.pulumi.ise.Utilities;
import java.util.concurrent.CompletableFuture;

public final class DeviceAdminAuthorizationExceptionFunctions {
    /**
    ...
    public static Output<GetRuleResult> getRule(GetRuleArgs args, InvokeOptions options) {
        return Deployment.getInstance().invoke("ise:DeviceAdminAuthorizationException/getRule:getRule", TypeShape.of(GetRuleResult.class), args, Utilities.withVersion(options));
    }
    /**
     * This data source can read the Device Admin Authorization Exception Rule.
     * 
    ...
    public static CompletableFuture<GetRuleResult> getRulePlain(GetRulePlainArgs args, InvokeOptions options) {
        return Deployment.getInstance().invokeAsync("ise:DeviceAdminAuthorizationException/getRule:getRule", TypeShape.of(GetRuleResult.class), args, Utilities.withVersion(options));
    }
}
