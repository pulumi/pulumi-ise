...
package com.pulumi.ise.AllowedProtocols.outputs;
...
@CustomType
public final class GetTacacsResult {
    /**
     * @return Allow CHAP
     * 
     */
    ...
    public static Builder builder(GetTacacsResult defaults) {
    ...
    public static final class Builder {
        ...
        private String name;
        public Builder() {}
        public Builder(GetTacacsResult defaults) {
        ...
        public Builder allowChap(Boolean allowChap) {
            if (allowChap == null) {
              throw new MissingRequiredPropertyException("GetTacacsResult", "allowChap");
            }
        ...
        public Builder allowMsChapV1(Boolean allowMsChapV1) {
            if (allowMsChapV1 == null) {
              throw new MissingRequiredPropertyException("GetTacacsResult", "allowMsChapV1");
            }
        ...
        public Builder allowPapAscii(Boolean allowPapAscii) {
            if (allowPapAscii == null) {
              throw new MissingRequiredPropertyException("GetTacacsResult", "allowPapAscii");
            }
        ...
        public Builder description(String description) {
            if (description == null) {
              throw new MissingRequiredPropertyException("GetTacacsResult", "description");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetTacacsResult", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetTacacsResult", "name");
            }
            this.name = name;
            return this;
        }
        public GetTacacsResult build() {
            final var _resultValue = new GetTacacsResult();
