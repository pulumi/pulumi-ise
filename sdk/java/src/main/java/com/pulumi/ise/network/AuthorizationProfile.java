...
import com.pulumi.ise.network.AuthorizationProfileArgs;
import com.pulumi.ise.network.inputs.AuthorizationProfileState;
import com.pulumi.ise.network.outputs.AuthorizationProfileAdvancedAttribute;
 ...
 * import com.pulumi.core.Output;
 * import com.pulumi.ise.network.AuthorizationProfile;
 * import com.pulumi.ise.network.AuthorizationProfileArgs;
 ...
 * 
 */
@ResourceType(type="ise:network/authorizationProfile:AuthorizationProfile")
public class AuthorizationProfile extends com.pulumi.resources.CustomResource {
    ...
    public AuthorizationProfile(String name, @Nullable AuthorizationProfileArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:network/authorizationProfile:AuthorizationProfile", name, args == null ? AuthorizationProfileArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private AuthorizationProfile(String name, Output<String> id, @Nullable AuthorizationProfileState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:network/authorizationProfile:AuthorizationProfile", name, state, makeResourceOptions(options, id));
    }
