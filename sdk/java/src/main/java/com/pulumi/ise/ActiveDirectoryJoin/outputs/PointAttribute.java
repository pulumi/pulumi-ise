...
public final class PointAttribute {
    ...
    public static Builder builder(PointAttribute defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(PointAttribute defaults) {
        ...
        public Builder defaultValue(String defaultValue) {
            if (defaultValue == null) {
              throw new MissingRequiredPropertyException("PointAttribute", "defaultValue");
            }
        ...
        public Builder internalName(String internalName) {
            if (internalName == null) {
              throw new MissingRequiredPropertyException("PointAttribute", "internalName");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("PointAttribute", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("PointAttribute", "type");
            }
            this.type = type;
            return this;
        }
        public PointAttribute build() {
            final var _resultValue = new PointAttribute();
