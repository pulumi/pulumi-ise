...
package com.pulumi.ise.NetworkAccessPolicy.outputs;

import com.pulumi.core.annotations.CustomType;
import com.pulumi.exceptions.MissingRequiredPropertyException;
import com.pulumi.ise.NetworkAccessPolicy.outputs.GetSetChildren;
...
public final class GetSetResult {
     ...
     * 
     */
    private List<GetSetChildren> childrens;
    /**
     ...
     * 
     */
    public List<GetSetChildren> childrens() {
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder childrens(List<GetSetChildren> childrens) {
            if (childrens == null) {
              throw new MissingRequiredPropertyException("GetSetResult", "childrens");
            }
            this.childrens = childrens;
            return this;
        }
        public Builder childrens(GetSetChildren... childrens) {
        ...
        public Builder conditionAttributeName(String conditionAttributeName) {
            if (conditionAttributeName == null) {
              throw new MissingRequiredPropertyException("GetSetResult", "conditionAttributeName");
            }
        ...
        public Builder conditionAttributeValue(String conditionAttributeValue) {
            if (conditionAttributeValue == null) {
              throw new MissingRequiredPropertyException("GetSetResult", "conditionAttributeValue");
            }
        ...
        public Builder conditionDictionaryName(String conditionDictionaryName) {
            if (conditionDictionaryName == null) {
              throw new MissingRequiredPropertyException("GetSetResult", "conditionDictionaryName");
            }
        ...
        public Builder conditionDictionaryValue(String conditionDictionaryValue) {
            if (conditionDictionaryValue == null) {
              throw new MissingRequiredPropertyException("GetSetResult", "conditionDictionaryValue");
            }
        ...
        public Builder conditionId(String conditionId) {
            if (conditionId == null) {
              throw new MissingRequiredPropertyException("GetSetResult", "conditionId");
            }
        ...
        public Builder conditionIsNegate(Boolean conditionIsNegate) {
            if (conditionIsNegate == null) {
              throw new MissingRequiredPropertyException("GetSetResult", "conditionIsNegate");
            }
        ...
        public Builder conditionOperator(String conditionOperator) {
            if (conditionOperator == null) {
              throw new MissingRequiredPropertyException("GetSetResult", "conditionOperator");
            }
        ...
        public Builder conditionType(String conditionType) {
            if (conditionType == null) {
              throw new MissingRequiredPropertyException("GetSetResult", "conditionType");
            }
        ...
        public Builder default_(Boolean default_) {
            if (default_ == null) {
              throw new MissingRequiredPropertyException("GetSetResult", "default_");
            }
        ...
        public Builder isProxy(Boolean isProxy) {
            if (isProxy == null) {
              throw new MissingRequiredPropertyException("GetSetResult", "isProxy");
            }
        ...
        public Builder rank(Integer rank) {
            if (rank == null) {
              throw new MissingRequiredPropertyException("GetSetResult", "rank");
            }
            this.rank = rank;
            return this;
        }
        ...
        public Builder serviceName(String serviceName) {
            if (serviceName == null) {
              throw new MissingRequiredPropertyException("GetSetResult", "serviceName");
            }
        ...
        public Builder state(String state) {
            if (state == null) {
              throw new MissingRequiredPropertyException("GetSetResult", "state");
            }
            this.state = state;
            return this;
        }
