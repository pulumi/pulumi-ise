...
import com.pulumi.ise.networkaccess.outputs.GetAuthorizationRuleChildrenChildrenChildren;
...
@CustomType
public final class GetAuthorizationRuleChildrenChildren {
    /**
    ...
    private GetAuthorizationRuleChildrenChildren() {}
    /**
     * @return Dictionary attribute name
     * 
     */
    ...
    public static Builder builder(GetAuthorizationRuleChildrenChildren defaults) {
    ...
    public static final class Builder {
        ...
        private String operator;
        public Builder() {}
        public Builder(GetAuthorizationRuleChildrenChildren defaults) {
        ...
        public Builder attributeName(String attributeName) {
            if (attributeName == null) {
              throw new MissingRequiredPropertyException("GetAuthorizationRuleChildrenChildren", "attributeName");
            }
        ...
        public Builder attributeValue(String attributeValue) {
            if (attributeValue == null) {
              throw new MissingRequiredPropertyException("GetAuthorizationRuleChildrenChildren", "attributeValue");
            }
        ...
        public Builder conditionType(String conditionType) {
            if (conditionType == null) {
              throw new MissingRequiredPropertyException("GetAuthorizationRuleChildrenChildren", "conditionType");
            }
        ...
        public Builder dictionaryName(String dictionaryName) {
            if (dictionaryName == null) {
              throw new MissingRequiredPropertyException("GetAuthorizationRuleChildrenChildren", "dictionaryName");
            }
        ...
        public Builder dictionaryValue(String dictionaryValue) {
            if (dictionaryValue == null) {
              throw new MissingRequiredPropertyException("GetAuthorizationRuleChildrenChildren", "dictionaryValue");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetAuthorizationRuleChildrenChildren", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder isNegate(Boolean isNegate) {
            if (isNegate == null) {
              throw new MissingRequiredPropertyException("GetAuthorizationRuleChildrenChildren", "isNegate");
            }
        ...
        public Builder operator(String operator) {
            if (operator == null) {
              throw new MissingRequiredPropertyException("GetAuthorizationRuleChildrenChildren", "operator");
            }
            this.operator = operator;
            return this;
        }
        public GetAuthorizationRuleChildrenChildren build() {
