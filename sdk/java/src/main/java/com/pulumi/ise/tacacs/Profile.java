...
import com.pulumi.ise.tacacs.inputs.ProfileState;
import com.pulumi.ise.tacacs.outputs.ProfileSessionAttribute;
 ...
 * 
 */
@ResourceType(type="ise:tacacs/profile:Profile")
public class Profile extends com.pulumi.resources.CustomResource {
    ...
    @Export(name="sessionAttributes", refs={List.class,ProfileSessionAttribute.class}, tree="[0,1]")
    private Output</* @Nullable */ List<ProfileSessionAttribute>> sessionAttributes;

    public Output<Optional<List<ProfileSessionAttribute>>> sessionAttributes() {
    ...
    public Profile(String name, @Nullable ProfileArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:tacacs/profile:Profile", name, args == null ? ProfileArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private Profile(String name, Output<String> id, @Nullable ProfileState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:tacacs/profile:Profile", name, state, makeResourceOptions(options, id));
    }
