...
import com.pulumi.ise.activeDirectory.JoinPointArgs;
import com.pulumi.ise.activeDirectory.inputs.JoinPointState;
import com.pulumi.ise.activeDirectory.outputs.JoinPointAttribute;
import com.pulumi.ise.activeDirectory.outputs.JoinPointGroup;
import com.pulumi.ise.activeDirectory.outputs.JoinPointRewriteRule;
 ...
 * import com.pulumi.core.Output;
 * import com.pulumi.ise.activeDirectory.JoinPoint;
 * import com.pulumi.ise.activeDirectory.JoinPointArgs;
 * import com.pulumi.ise.activeDirectory.inputs.JoinPointGroupArgs;
 * import com.pulumi.ise.activeDirectory.inputs.JoinPointAttributeArgs;
 * import com.pulumi.ise.activeDirectory.inputs.JoinPointRewriteRuleArgs;
 * import java.util.List;
 ...
 *         var example = new JoinPoint(&#34;example&#34;, JoinPointArgs.builder()        
 *             .name(&#34;cisco.local&#34;)
 *             .description(&#34;My AD join point&#34;)
 *             .domain(&#34;cisco.local&#34;)
 *             .adScopesNames(&#34;Default_Scope&#34;)
 *             .enableDomainAllowedList(true)
 *             .groups(JoinPointGroupArgs.builder()
 *                 .name(&#34;cisco.local/operators&#34;)
 *                 .sid(&#34;S-1-5-32-548&#34;)
 *                 .type(&#34;GLOBAL&#34;)
 *                 .build())
 *             .attributes(JoinPointAttributeArgs.builder()
 *                 .name(&#34;Attribute_1&#34;)
 *                 .type(&#34;STRING&#34;)
 *                 .internal_name(&#34;internal_name&#34;)
 *                 .default_value(&#34;default_string&#34;)
 *                 .build())
 *             .rewriteRules(JoinPointRewriteRuleArgs.builder()
 *                 .row_id(&#34;0&#34;)
 ...
 * 
 */
@ResourceType(type="ise:activeDirectory/joinPoint:JoinPoint")
public class JoinPoint extends com.pulumi.resources.CustomResource {
    /**
     ...
     * 
     */
    @Export(name="attributes", refs={List.class,JoinPointAttribute.class}, tree="[0,1]")
    private Output</* @Nullable */ List<JoinPointAttribute>> attributes;

    /**
     * @return List of AD attributes
     * 
     */
    public Output<Optional<List<JoinPointAttribute>>> attributes() {
     ...
     * 
     */
    @Export(name="groups", refs={List.class,JoinPointGroup.class}, tree="[0,1]")
    private Output</* @Nullable */ List<JoinPointGroup>> groups;

    /**
     * @return List of AD Groups
     * 
     */
    public Output<Optional<List<JoinPointGroup>>> groups() {
     ...
     * 
     */
    @Export(name="rewriteRules", refs={List.class,JoinPointRewriteRule.class}, tree="[0,1]")
    private Output</* @Nullable */ List<JoinPointRewriteRule>> rewriteRules;

    /**
     * @return List of Rewrite rules
     * 
     */
    public Output<Optional<List<JoinPointRewriteRule>>> rewriteRules() {
     ...
     */
    public JoinPoint(String name, JoinPointArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public JoinPoint(String name, JoinPointArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:activeDirectory/joinPoint:JoinPoint", name, args == null ? JoinPointArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private JoinPoint(String name, Output<String> id, @Nullable JoinPointState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:activeDirectory/joinPoint:JoinPoint", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static JoinPoint get(String name, Output<String> id, @Nullable JoinPointState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
