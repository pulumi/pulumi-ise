...
import com.pulumi.ise.identity.InternalUserArgs;
import com.pulumi.ise.identity.inputs.InternalUserState;
 ...
 * import com.pulumi.core.Output;
 * import com.pulumi.ise.identity.InternalUser;
 * import com.pulumi.ise.identity.InternalUserArgs;
 ...
 * 
 * ```sh
 * $ pulumi import ise:identity/internalUser:InternalUser example &#34;76d24097-41c4-4558-a4d0-a8c07ac08470&#34;
 * ```
 * 
 */
@ResourceType(type="ise:identity/internalUser:InternalUser")
public class InternalUser extends com.pulumi.resources.CustomResource {
    ...
    public InternalUser(String name, InternalUserArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:identity/internalUser:InternalUser", name, args == null ? InternalUserArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private InternalUser(String name, Output<String> id, @Nullable InternalUserState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:identity/internalUser:InternalUser", name, state, makeResourceOptions(options, id));
    }
