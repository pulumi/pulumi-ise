...
public final class AccessAuthenticationRuleArgs extends com.pulumi.resources.ResourceArgs {

    public static final AccessAuthenticationRuleArgs Empty = new AccessAuthenticationRuleArgs();
    ...
    private AccessAuthenticationRuleArgs() {}

    private AccessAuthenticationRuleArgs(AccessAuthenticationRuleArgs $) {
    ...
    public static Builder builder(AccessAuthenticationRuleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AccessAuthenticationRuleArgs();
        }

        public Builder(AccessAuthenticationRuleArgs defaults) {
            $ = new AccessAuthenticationRuleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AccessAuthenticationRuleArgs build() {
            if ($.ifAuthFail == null) {
                throw new MissingRequiredPropertyException("AccessAuthenticationRuleArgs", "ifAuthFail");
            }
            if ($.ifProcessFail == null) {
                throw new MissingRequiredPropertyException("AccessAuthenticationRuleArgs", "ifProcessFail");
            }
            if ($.ifUserNotFound == null) {
                throw new MissingRequiredPropertyException("AccessAuthenticationRuleArgs", "ifUserNotFound");
            }
            if ($.policySetId == null) {
                throw new MissingRequiredPropertyException("AccessAuthenticationRuleArgs", "policySetId");
            }
            return $;
        }
    }
