...
package com.pulumi.ise.NetworkAccessAuthorization;
...
import com.pulumi.ise.NetworkAccessAuthorization.inputs.RuleState;
import com.pulumi.ise.NetworkAccessAuthorization.outputs.RuleChildren;
 ...
 * 
 */
@ResourceType(type="ise:NetworkAccessAuthorization/rule:Rule")
public class Rule extends com.pulumi.resources.CustomResource {
    ...
    public Rule(String name, RuleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:NetworkAccessAuthorization/rule:Rule", name, args == null ? RuleArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private Rule(String name, Output<String> id, @Nullable RuleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:NetworkAccessAuthorization/rule:Rule", name, state, makeResourceOptions(options, id));
    }
