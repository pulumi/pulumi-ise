...
public final class IpToSgtMappingArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private IpToSgtMappingArgs() {}

    private IpToSgtMappingArgs(IpToSgtMappingArgs $) {
    ...
    public static Builder builder(IpToSgtMappingArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(IpToSgtMappingArgs defaults) {
            $ = new IpToSgtMappingArgs(Objects.requireNonNull(defaults));
        }
        ...
        public IpToSgtMappingArgs build() {
            return $;
        }
    }
