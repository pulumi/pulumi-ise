...
@CustomType
public final class ActiveDirectoryJoinPointRewriteRule {
    /**
    ...
    public static Builder builder(ActiveDirectoryJoinPointRewriteRule defaults) {
    ...
    public static final class Builder {
        ...
        private String rowId;
        public Builder() {}
        public Builder(ActiveDirectoryJoinPointRewriteRule defaults) {
        ...
        public Builder rewriteMatch(String rewriteMatch) {
            if (rewriteMatch == null) {
              throw new MissingRequiredPropertyException("ActiveDirectoryJoinPointRewriteRule", "rewriteMatch");
            }
        ...
        public Builder rewriteResult(String rewriteResult) {
            if (rewriteResult == null) {
              throw new MissingRequiredPropertyException("ActiveDirectoryJoinPointRewriteRule", "rewriteResult");
            }
        ...
        public Builder rowId(String rowId) {
            if (rowId == null) {
              throw new MissingRequiredPropertyException("ActiveDirectoryJoinPointRewriteRule", "rowId");
            }
            this.rowId = rowId;
            return this;
        }
        public ActiveDirectoryJoinPointRewriteRule build() {
            final var _resultValue = new ActiveDirectoryJoinPointRewriteRule();
