...
import com.pulumi.ise.deviceadmin.inputs.AuthorizationExceptionRuleState;
import com.pulumi.ise.deviceadmin.outputs.AuthorizationExceptionRuleChildren;
 ...
 * 
 */
@ResourceType(type="ise:deviceadmin/authorizationExceptionRule:AuthorizationExceptionRule")
public class AuthorizationExceptionRule extends com.pulumi.resources.CustomResource {
    ...
    public AuthorizationExceptionRule(java.lang.String name, AuthorizationExceptionRuleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:deviceadmin/authorizationExceptionRule:AuthorizationExceptionRule", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private AuthorizationExceptionRule(java.lang.String name, Output<java.lang.String> id, @Nullable AuthorizationExceptionRuleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:deviceadmin/authorizationExceptionRule:AuthorizationExceptionRule", name, state, makeResourceOptions(options, id), false);
    }
