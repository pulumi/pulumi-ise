...
public class AuthenticationRule extends com.pulumi.resources.CustomResource {
    ...
    public AuthenticationRule(java.lang.String name, AuthenticationRuleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:deviceadmin/authenticationRule:AuthenticationRule", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private AuthenticationRule(java.lang.String name, Output<java.lang.String> id, @Nullable AuthenticationRuleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:deviceadmin/authenticationRule:AuthenticationRule", name, state, makeResourceOptions(options, id), false);
    }
