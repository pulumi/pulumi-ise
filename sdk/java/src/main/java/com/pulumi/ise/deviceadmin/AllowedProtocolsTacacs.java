...
public class AllowedProtocolsTacacs extends com.pulumi.resources.CustomResource {
     ...
     */
    public AllowedProtocolsTacacs(java.lang.String name) {
     ...
     */
    public AllowedProtocolsTacacs(java.lang.String name, AllowedProtocolsTacacsArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public AllowedProtocolsTacacs(java.lang.String name, AllowedProtocolsTacacsArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:deviceadmin/allowedProtocolsTacacs:AllowedProtocolsTacacs", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private AllowedProtocolsTacacs(java.lang.String name, Output<java.lang.String> id, @Nullable AllowedProtocolsTacacsState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:deviceadmin/allowedProtocolsTacacs:AllowedProtocolsTacacs", name, state, makeResourceOptions(options, id), false);
    }

    private static AllowedProtocolsTacacsArgs makeArgs(AllowedProtocolsTacacsArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? AllowedProtocolsTacacsArgs.Empty : args;
    }
     ...
     */
    public static AllowedProtocolsTacacs get(java.lang.String name, Output<java.lang.String> id, @Nullable AllowedProtocolsTacacsState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
