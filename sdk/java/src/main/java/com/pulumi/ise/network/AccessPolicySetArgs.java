...
import com.pulumi.ise.network.inputs.AccessPolicySetChildrenArgs;
...
public final class AccessPolicySetArgs extends com.pulumi.resources.ResourceArgs {

    public static final AccessPolicySetArgs Empty = new AccessPolicySetArgs();
    ...
    private @Nullable Output<List<AccessPolicySetChildrenArgs>> childrens;

    /**
     * @return List of child conditions. `condition_type` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
     * 
     */
    public Optional<Output<List<AccessPolicySetChildrenArgs>>> childrens() {
    ...
    private AccessPolicySetArgs() {}

    private AccessPolicySetArgs(AccessPolicySetArgs $) {
    ...
    public static Builder builder(AccessPolicySetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AccessPolicySetArgs();
        }

        public Builder(AccessPolicySetArgs defaults) {
            $ = new AccessPolicySetArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder childrens(@Nullable Output<List<AccessPolicySetChildrenArgs>> childrens) {
            $.childrens = childrens;
            return this;
        }
         ...
         * 
         */
        public Builder childrens(List<AccessPolicySetChildrenArgs> childrens) {
         ...
         * 
         */
        public Builder childrens(AccessPolicySetChildrenArgs... childrens) {
        ...
        public AccessPolicySetArgs build() {
            if ($.serviceName == null) {
                throw new MissingRequiredPropertyException("AccessPolicySetArgs", "serviceName");
            }
            return $;
        }
    }
