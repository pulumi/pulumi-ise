...
import com.pulumi.ise.network.AccessAuthorizationGlobalExceptionRuleArgs;
import com.pulumi.ise.network.inputs.AccessAuthorizationGlobalExceptionRuleState;
import com.pulumi.ise.network.outputs.AccessAuthorizationGlobalExceptionRuleChildren;
 ...
 * import com.pulumi.core.Output;
 * import com.pulumi.ise.network.AccessAuthorizationGlobalExceptionRule;
 * import com.pulumi.ise.network.AccessAuthorizationGlobalExceptionRuleArgs;
 * import java.util.List;
 ...
 *         var example = new AccessAuthorizationGlobalExceptionRule(&#34;example&#34;, AccessAuthorizationGlobalExceptionRuleArgs.builder()        
 *             .name(&#34;Rule1&#34;)
 *             .default_(false)
 *             .rank(0)
 *             .state(&#34;enabled&#34;)
 ...
 * 
 */
@ResourceType(type="ise:network/accessAuthorizationGlobalExceptionRule:AccessAuthorizationGlobalExceptionRule")
public class AccessAuthorizationGlobalExceptionRule extends com.pulumi.resources.CustomResource {
    /**
     * List of child conditions. `condition_type` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
     * 
     */
    @Export(name="childrens", refs={List.class,AccessAuthorizationGlobalExceptionRuleChildren.class}, tree="[0,1]")
    private Output</* @Nullable */ List<AccessAuthorizationGlobalExceptionRuleChildren>> childrens;

    /**
     * @return List of child conditions. `condition_type` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
     * 
     */
    public Output<Optional<List<AccessAuthorizationGlobalExceptionRuleChildren>>> childrens() {
    ...
    private Output</* @Nullable */ List<String>> profiles;

    /**
     * @return The authorization profile(s)
     * 
     */
    public Output<Optional<List<String>>> profiles() {
    ...
    private Output</* @Nullable */ String> securityGroup;

    /**
     * @return Security group used in authorization policies
     * 
     */
    public Output<Optional<String>> securityGroup() {
        return Codegen.optional(this.securityGroup);
    }
    /**
     ...
     */
    public AccessAuthorizationGlobalExceptionRule(String name) {
        this(name, AccessAuthorizationGlobalExceptionRuleArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public AccessAuthorizationGlobalExceptionRule(String name, @Nullable AccessAuthorizationGlobalExceptionRuleArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public AccessAuthorizationGlobalExceptionRule(String name, @Nullable AccessAuthorizationGlobalExceptionRuleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:network/accessAuthorizationGlobalExceptionRule:AccessAuthorizationGlobalExceptionRule", name, args == null ? AccessAuthorizationGlobalExceptionRuleArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private AccessAuthorizationGlobalExceptionRule(String name, Output<String> id, @Nullable AccessAuthorizationGlobalExceptionRuleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:network/accessAuthorizationGlobalExceptionRule:AccessAuthorizationGlobalExceptionRule", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static AccessAuthorizationGlobalExceptionRule get(String name, Output<String> id, @Nullable AccessAuthorizationGlobalExceptionRuleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
