...
public final class AuthorizationExceptionRuleChildrenChildrenChildrenChildrenChildrenChildrenArgs extends com.pulumi.resources.ResourceArgs {

    public static final AuthorizationExceptionRuleChildrenChildrenChildrenChildrenChildrenChildrenArgs Empty = new AuthorizationExceptionRuleChildrenChildrenChildrenChildrenChildrenChildrenArgs();
    ...
    private AuthorizationExceptionRuleChildrenChildrenChildrenChildrenChildrenChildrenArgs() {}

    private AuthorizationExceptionRuleChildrenChildrenChildrenChildrenChildrenChildrenArgs(AuthorizationExceptionRuleChildrenChildrenChildrenChildrenChildrenChildrenArgs $) {
    ...
    public static Builder builder(AuthorizationExceptionRuleChildrenChildrenChildrenChildrenChildrenChildrenArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AuthorizationExceptionRuleChildrenChildrenChildrenChildrenChildrenChildrenArgs();
        }

        public Builder(AuthorizationExceptionRuleChildrenChildrenChildrenChildrenChildrenChildrenArgs defaults) {
            $ = new AuthorizationExceptionRuleChildrenChildrenChildrenChildrenChildrenChildrenArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AuthorizationExceptionRuleChildrenChildrenChildrenChildrenChildrenChildrenArgs build() {
            if ($.conditionType == null) {
                throw new MissingRequiredPropertyException("AuthorizationExceptionRuleChildrenChildrenChildrenChildrenChildrenChildrenArgs", "conditionType");
            }
            return $;
        }
    }
