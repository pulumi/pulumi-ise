...
import com.pulumi.ise.DeviceAdminAuthentication.inputs.GetRulePlainArgs;
import com.pulumi.ise.DeviceAdminAuthentication.outputs.GetRuleResult;
import com.pulumi.ise.Utilities;
import java.util.concurrent.CompletableFuture;

public final class DeviceAdminAuthenticationFunctions {
    /**
    ...
    public static Output<GetRuleResult> getRule(GetRuleArgs args, InvokeOptions options) {
        return Deployment.getInstance().invoke("ise:DeviceAdminAuthentication/getRule:getRule", TypeShape.of(GetRuleResult.class), args, Utilities.withVersion(options));
    }
    /**
     * This data source can read the Device Admin Authentication Rule.
     * 
    ...
    public static CompletableFuture<GetRuleResult> getRulePlain(GetRulePlainArgs args, InvokeOptions options) {
        return Deployment.getInstance().invokeAsync("ise:DeviceAdminAuthentication/getRule:getRule", TypeShape.of(GetRuleResult.class), args, Utilities.withVersion(options));
    }
}
