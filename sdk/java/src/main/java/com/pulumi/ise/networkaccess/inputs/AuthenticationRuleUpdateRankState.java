...
public final class AuthenticationRuleUpdateRankState extends com.pulumi.resources.ResourceArgs {

    public static final AuthenticationRuleUpdateRankState Empty = new AuthenticationRuleUpdateRankState();
    ...
    private AuthenticationRuleUpdateRankState() {}

    private AuthenticationRuleUpdateRankState(AuthenticationRuleUpdateRankState $) {
    ...
    public static Builder builder(AuthenticationRuleUpdateRankState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AuthenticationRuleUpdateRankState();
        }

        public Builder(AuthenticationRuleUpdateRankState defaults) {
            $ = new AuthenticationRuleUpdateRankState(Objects.requireNonNull(defaults));
        }
        ...
        public AuthenticationRuleUpdateRankState build() {
            return $;
        }
    }
