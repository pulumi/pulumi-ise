...
public class AuthorizationGlobalExceptionRule extends com.pulumi.resources.CustomResource {
    ...
    public AuthorizationGlobalExceptionRule(String name, @Nullable AuthorizationGlobalExceptionRuleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:deviceadmin/authorizationGlobalExceptionRule:AuthorizationGlobalExceptionRule", name, args == null ? AuthorizationGlobalExceptionRuleArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private AuthorizationGlobalExceptionRule(String name, Output<String> id, @Nullable AuthorizationGlobalExceptionRuleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:deviceadmin/authorizationGlobalExceptionRule:AuthorizationGlobalExceptionRule", name, state, makeResourceOptions(options, id));
    }
