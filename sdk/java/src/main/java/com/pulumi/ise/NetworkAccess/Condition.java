...
public class Condition extends com.pulumi.resources.CustomResource {
    ...
    public Condition(String name, ConditionArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:NetworkAccess/condition:Condition", name, args == null ? ConditionArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private Condition(String name, Output<String> id, @Nullable ConditionState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:NetworkAccess/condition:Condition", name, state, makeResourceOptions(options, id));
    }
