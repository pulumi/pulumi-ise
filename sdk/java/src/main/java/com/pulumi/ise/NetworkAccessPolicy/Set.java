...
import com.pulumi.ise.NetworkAccessPolicy.inputs.SetState;
import com.pulumi.ise.NetworkAccessPolicy.outputs.SetChildren;
 ...
 * 
 */
@ResourceType(type="ise:NetworkAccessPolicy/set:Set")
public class Set extends com.pulumi.resources.CustomResource {
    ...
    public Set(String name, SetArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:NetworkAccessPolicy/set:Set", name, args == null ? SetArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private Set(String name, Output<String> id, @Nullable SetState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:NetworkAccessPolicy/set:Set", name, state, makeResourceOptions(options, id));
    }
