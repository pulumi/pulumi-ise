...
public final class JoinPointState extends com.pulumi.resources.ResourceArgs {

    public static final JoinPointState Empty = new JoinPointState();
    ...
    private JoinPointState() {}

    private JoinPointState(JoinPointState $) {
    ...
    public static Builder builder(JoinPointState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(JoinPointState defaults) {
            $ = new JoinPointState(Objects.requireNonNull(defaults));
        }
