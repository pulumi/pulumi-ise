...
public final class ProtocolsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ProtocolsArgs Empty = new ProtocolsArgs();
    ...
    private ProtocolsArgs() {}

    private ProtocolsArgs(ProtocolsArgs $) {
    ...
    public static Builder builder(ProtocolsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ProtocolsArgs defaults) {
            $ = new ProtocolsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ProtocolsArgs build() {
            if ($.allowChap == null) {
                throw new MissingRequiredPropertyException("ProtocolsArgs", "allowChap");
            }
            if ($.allowEapFast == null) {
                throw new MissingRequiredPropertyException("ProtocolsArgs", "allowEapFast");
            }
            if ($.allowEapMd5 == null) {
                throw new MissingRequiredPropertyException("ProtocolsArgs", "allowEapMd5");
            }
            if ($.allowEapTls == null) {
                throw new MissingRequiredPropertyException("ProtocolsArgs", "allowEapTls");
            }
            if ($.allowEapTtls == null) {
                throw new MissingRequiredPropertyException("ProtocolsArgs", "allowEapTtls");
            }
            if ($.allowLeap == null) {
                throw new MissingRequiredPropertyException("ProtocolsArgs", "allowLeap");
            }
            if ($.allowMsChapV1 == null) {
                throw new MissingRequiredPropertyException("ProtocolsArgs", "allowMsChapV1");
            }
            if ($.allowMsChapV2 == null) {
                throw new MissingRequiredPropertyException("ProtocolsArgs", "allowMsChapV2");
            }
            if ($.allowPapAscii == null) {
                throw new MissingRequiredPropertyException("ProtocolsArgs", "allowPapAscii");
            }
            if ($.allowPeap == null) {
                throw new MissingRequiredPropertyException("ProtocolsArgs", "allowPeap");
            }
            if ($.allowPreferredEapProtocol == null) {
                throw new MissingRequiredPropertyException("ProtocolsArgs", "allowPreferredEapProtocol");
            }
            if ($.allowTeap == null) {
                throw new MissingRequiredPropertyException("ProtocolsArgs", "allowTeap");
            }
            if ($.allowWeakCiphersForEap == null) {
                throw new MissingRequiredPropertyException("ProtocolsArgs", "allowWeakCiphersForEap");
            }
            if ($.eapTlsLBit == null) {
                throw new MissingRequiredPropertyException("ProtocolsArgs", "eapTlsLBit");
            }
            if ($.processHostLookup == null) {
                throw new MissingRequiredPropertyException("ProtocolsArgs", "processHostLookup");
            }
            if ($.requireMessageAuth == null) {
                throw new MissingRequiredPropertyException("ProtocolsArgs", "requireMessageAuth");
            }
            return $;
        }
    }
