...
import com.pulumi.ise.networkaccess.outputs.AuthorizationGlobalExceptionRuleChildrenChildrenChildrenChildrenChildren;
...
@CustomType
public final class AuthorizationGlobalExceptionRuleChildrenChildrenChildrenChildren {
    /**
     ...
     * 
     */
    private @Nullable List<AuthorizationGlobalExceptionRuleChildrenChildrenChildrenChildrenChildren> childrens;
    /**
    ...
    private AuthorizationGlobalExceptionRuleChildrenChildrenChildrenChildren() {}
    /**
     * @return Dictionary attribute name
     * 
     */
     ...
     * 
     */
    public List<AuthorizationGlobalExceptionRuleChildrenChildrenChildrenChildrenChildren> childrens() {
    ...
    public static Builder builder(AuthorizationGlobalExceptionRuleChildrenChildrenChildrenChildren defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String operator;
        public Builder() {}
        public Builder(AuthorizationGlobalExceptionRuleChildrenChildrenChildrenChildren defaults) {
        ...
        @CustomType.Setter
        public Builder childrens(@Nullable List<AuthorizationGlobalExceptionRuleChildrenChildrenChildrenChildrenChildren> childrens) {

            this.childrens = childrens;
            return this;
        }
        public Builder childrens(AuthorizationGlobalExceptionRuleChildrenChildrenChildrenChildrenChildren... childrens) {
            return childrens(List.of(childrens));
        }
        @CustomType.Setter
        public Builder conditionType(String conditionType) {
            if (conditionType == null) {
              throw new MissingRequiredPropertyException("AuthorizationGlobalExceptionRuleChildrenChildrenChildrenChildren", "conditionType");
            }
        ...
        public AuthorizationGlobalExceptionRuleChildrenChildrenChildrenChildren build() {
            final var _resultValue = new AuthorizationGlobalExceptionRuleChildrenChildrenChildrenChildren();
