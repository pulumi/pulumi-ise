...
package com.pulumi.ise.TrustsecEgressMatrix.outputs;
...
public final class GetCellResult {
    ...
    public static final class Builder {
        ...
        public Builder defaultRule(String defaultRule) {
            if (defaultRule == null) {
              throw new MissingRequiredPropertyException("GetCellResult", "defaultRule");
            }
        ...
        public Builder description(String description) {
            if (description == null) {
              throw new MissingRequiredPropertyException("GetCellResult", "description");
            }
        ...
        public Builder destinationSgtId(String destinationSgtId) {
            if (destinationSgtId == null) {
              throw new MissingRequiredPropertyException("GetCellResult", "destinationSgtId");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetCellResult", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder matrixCellStatus(String matrixCellStatus) {
            if (matrixCellStatus == null) {
              throw new MissingRequiredPropertyException("GetCellResult", "matrixCellStatus");
            }
        ...
        public Builder sgacls(List<String> sgacls) {
            if (sgacls == null) {
              throw new MissingRequiredPropertyException("GetCellResult", "sgacls");
            }
            this.sgacls = sgacls;
            return this;
        }
        ...
        public Builder sourceSgtId(String sourceSgtId) {
            if (sourceSgtId == null) {
              throw new MissingRequiredPropertyException("GetCellResult", "sourceSgtId");
            }
            this.sourceSgtId = sourceSgtId;
            return this;
        }
        public GetCellResult build() {
            final var _resultValue = new GetCellResult();
