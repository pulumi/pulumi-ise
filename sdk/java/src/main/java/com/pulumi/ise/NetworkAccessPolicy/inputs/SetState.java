...
public final class SetState extends com.pulumi.resources.ResourceArgs {

    public static final SetState Empty = new SetState();
    ...
    public static Builder builder(SetState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(SetState defaults) {
            $ = new SetState(Objects.requireNonNull(defaults));
        }
