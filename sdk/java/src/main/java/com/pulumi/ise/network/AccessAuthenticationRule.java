...
import com.pulumi.ise.network.AccessAuthenticationRuleArgs;
import com.pulumi.ise.network.inputs.AccessAuthenticationRuleState;
import com.pulumi.ise.network.outputs.AccessAuthenticationRuleChildren;
 ...
 * import com.pulumi.core.Output;
 * import com.pulumi.ise.network.AccessAuthenticationRule;
 * import com.pulumi.ise.network.AccessAuthenticationRuleArgs;
 * import java.util.List;
 ...
 *         var example = new AccessAuthenticationRule(&#34;example&#34;, AccessAuthenticationRuleArgs.builder()        
 ...
 * 
 */
@ResourceType(type="ise:network/accessAuthenticationRule:AccessAuthenticationRule")
public class AccessAuthenticationRule extends com.pulumi.resources.CustomResource {
    /**
     * List of child conditions. `condition_type` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
     * 
     */
    @Export(name="childrens", refs={List.class,AccessAuthenticationRuleChildren.class}, tree="[0,1]")
    private Output</* @Nullable */ List<AccessAuthenticationRuleChildren>> childrens;

    /**
     * @return List of child conditions. `condition_type` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
     * 
     */
    public Output<Optional<List<AccessAuthenticationRuleChildren>>> childrens() {
     ...
     */
    public AccessAuthenticationRule(String name) {
        this(name, AccessAuthenticationRuleArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public AccessAuthenticationRule(String name, AccessAuthenticationRuleArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public AccessAuthenticationRule(String name, AccessAuthenticationRuleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:network/accessAuthenticationRule:AccessAuthenticationRule", name, args == null ? AccessAuthenticationRuleArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private AccessAuthenticationRule(String name, Output<String> id, @Nullable AccessAuthenticationRuleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:network/accessAuthenticationRule:AccessAuthenticationRule", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static AccessAuthenticationRule get(String name, Output<String> id, @Nullable AccessAuthenticationRuleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
