...
import com.pulumi.ise.NetworkAccessPolicy.outputs.GetSetChildrenChildren;
...
@CustomType
public final class GetSetChildren {
    /**
     ...
     * 
     */
    private List<GetSetChildrenChildren> childrens;
    /**
     ...
     * 
     */
    public List<GetSetChildrenChildren> childrens() {
    ...
    public static Builder builder(GetSetChildren defaults) {
    ...
    public static final class Builder {
        ...
        private String operator;
        public Builder() {}
        public Builder(GetSetChildren defaults) {
        ...
        public Builder attributeName(String attributeName) {
            if (attributeName == null) {
              throw new MissingRequiredPropertyException("GetSetChildren", "attributeName");
            }
        ...
        public Builder attributeValue(String attributeValue) {
            if (attributeValue == null) {
              throw new MissingRequiredPropertyException("GetSetChildren", "attributeValue");
            }
            this.attributeValue = attributeValue;
            return this;
        }
        @CustomType.Setter
        public Builder childrens(List<GetSetChildrenChildren> childrens) {
            if (childrens == null) {
              throw new MissingRequiredPropertyException("GetSetChildren", "childrens");
            }
            this.childrens = childrens;
            return this;
        }
        public Builder childrens(GetSetChildrenChildren... childrens) {
            return childrens(List.of(childrens));
        }
        @CustomType.Setter
        public Builder conditionType(String conditionType) {
            if (conditionType == null) {
              throw new MissingRequiredPropertyException("GetSetChildren", "conditionType");
            }
        ...
        public Builder dictionaryName(String dictionaryName) {
            if (dictionaryName == null) {
              throw new MissingRequiredPropertyException("GetSetChildren", "dictionaryName");
            }
        ...
        public Builder dictionaryValue(String dictionaryValue) {
            if (dictionaryValue == null) {
              throw new MissingRequiredPropertyException("GetSetChildren", "dictionaryValue");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetSetChildren", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder isNegate(Boolean isNegate) {
            if (isNegate == null) {
              throw new MissingRequiredPropertyException("GetSetChildren", "isNegate");
            }
        ...
        public Builder operator(String operator) {
            if (operator == null) {
              throw new MissingRequiredPropertyException("GetSetChildren", "operator");
            }
            this.operator = operator;
            return this;
        }
        public GetSetChildren build() {
            final var _resultValue = new GetSetChildren();
