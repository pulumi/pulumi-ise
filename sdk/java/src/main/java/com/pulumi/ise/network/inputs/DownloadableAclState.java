...
public final class DownloadableAclState extends com.pulumi.resources.ResourceArgs {

    public static final DownloadableAclState Empty = new DownloadableAclState();
     ...
     */
    @Import(name="dacl")
    private @Nullable Output<String> dacl;

    /**
     * @return The DACL content
     * 
     */
    public Optional<Output<String>> dacl() {
        return Optional.ofNullable(this.dacl);
    }
    ...
    private DownloadableAclState() {}

    private DownloadableAclState(DownloadableAclState $) {
        this.dacl = $.dacl;
    ...
    public static Builder builder(DownloadableAclState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DownloadableAclState();
        }

        public Builder(DownloadableAclState defaults) {
            $ = new DownloadableAclState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder dacl(@Nullable Output<String> dacl) {
            $.dacl = dacl;
            return this;
        }
        ...
        public DownloadableAclState build() {
            return $;
        }
    }
