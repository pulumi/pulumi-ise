...
import com.pulumi.ise.TrustsecIpToSgtMapping.inputs.GroupState;
 ...
 * 
 */
@ResourceType(type="ise:TrustsecIpToSgtMapping/group:Group")
public class Group extends com.pulumi.resources.CustomResource {
    ...
    public Group(String name, GroupArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:TrustsecIpToSgtMapping/group:Group", name, args == null ? GroupArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private Group(String name, Output<String> id, @Nullable GroupState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:TrustsecIpToSgtMapping/group:Group", name, state, makeResourceOptions(options, id));
    }
