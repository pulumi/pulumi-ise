...
import com.pulumi.ise.NetworkAccessAuthorizationException.inputs.GetRulePlainArgs;
import com.pulumi.ise.NetworkAccessAuthorizationException.outputs.GetRuleResult;
import com.pulumi.ise.Utilities;
import java.util.concurrent.CompletableFuture;

public final class NetworkAccessAuthorizationExceptionFunctions {
    /**
    ...
    public static Output<GetRuleResult> getRule(GetRuleArgs args, InvokeOptions options) {
        return Deployment.getInstance().invoke("ise:NetworkAccessAuthorizationException/getRule:getRule", TypeShape.of(GetRuleResult.class), args, Utilities.withVersion(options));
    }
    /**
     * This data source can read the Network Access Authorization Exception Rule.
     * 
    ...
    public static CompletableFuture<GetRuleResult> getRulePlain(GetRulePlainArgs args, InvokeOptions options) {
        return Deployment.getInstance().invokeAsync("ise:NetworkAccessAuthorizationException/getRule:getRule", TypeShape.of(GetRuleResult.class), args, Utilities.withVersion(options));
    }
}
