...
public class PolicySet extends com.pulumi.resources.CustomResource {
    ...
    public PolicySet(String name, PolicySetArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:deviceadmin/policySet:PolicySet", name, args == null ? PolicySetArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private PolicySet(String name, Output<String> id, @Nullable PolicySetState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:deviceadmin/policySet:PolicySet", name, state, makeResourceOptions(options, id));
    }
