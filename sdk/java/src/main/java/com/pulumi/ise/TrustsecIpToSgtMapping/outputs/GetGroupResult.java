...
package com.pulumi.ise.TrustsecIpToSgtMapping.outputs;
...
public final class GetGroupResult {
    ...
    public static final class Builder {
        ...
        public Builder deployTo(String deployTo) {
            if (deployTo == null) {
              throw new MissingRequiredPropertyException("GetGroupResult", "deployTo");
            }
        ...
        public Builder deployType(String deployType) {
            if (deployType == null) {
              throw new MissingRequiredPropertyException("GetGroupResult", "deployType");
            }
        ...
        public Builder sgt(String sgt) {
            if (sgt == null) {
              throw new MissingRequiredPropertyException("GetGroupResult", "sgt");
            }
            this.sgt = sgt;
            return this;
        }
