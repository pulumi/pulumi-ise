...
import com.pulumi.ise.identity.CertificateAuthenticationProfileArgs;
import com.pulumi.ise.identity.inputs.CertificateAuthenticationProfileState;
 ...
 * import com.pulumi.core.Output;
 * import com.pulumi.ise.identity.CertificateAuthenticationProfile;
 * import com.pulumi.ise.identity.CertificateAuthenticationProfileArgs;
 ...
 * 
 * ```sh
 * $ pulumi import ise:identity/certificateAuthenticationProfile:CertificateAuthenticationProfile example &#34;76d24097-41c4-4558-a4d0-a8c07ac08470&#34;
 * ```
 * 
 */
@ResourceType(type="ise:identity/certificateAuthenticationProfile:CertificateAuthenticationProfile")
public class CertificateAuthenticationProfile extends com.pulumi.resources.CustomResource {
    ...
    public CertificateAuthenticationProfile(String name, @Nullable CertificateAuthenticationProfileArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:identity/certificateAuthenticationProfile:CertificateAuthenticationProfile", name, args == null ? CertificateAuthenticationProfileArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private CertificateAuthenticationProfile(String name, Output<String> id, @Nullable CertificateAuthenticationProfileState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:identity/certificateAuthenticationProfile:CertificateAuthenticationProfile", name, state, makeResourceOptions(options, id));
    }
