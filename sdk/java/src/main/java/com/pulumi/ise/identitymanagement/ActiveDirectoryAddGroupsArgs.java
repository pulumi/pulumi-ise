...
public final class ActiveDirectoryAddGroupsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ActiveDirectoryAddGroupsArgs Empty = new ActiveDirectoryAddGroupsArgs();
    ...
    private ActiveDirectoryAddGroupsArgs() {}

    private ActiveDirectoryAddGroupsArgs(ActiveDirectoryAddGroupsArgs $) {
    ...
    public static Builder builder(ActiveDirectoryAddGroupsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ActiveDirectoryAddGroupsArgs();
        }

        public Builder(ActiveDirectoryAddGroupsArgs defaults) {
            $ = new ActiveDirectoryAddGroupsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ActiveDirectoryAddGroupsArgs build() {
            if ($.domain == null) {
                throw new MissingRequiredPropertyException("ActiveDirectoryAddGroupsArgs", "domain");
            }
            if ($.joinPointId == null) {
                throw new MissingRequiredPropertyException("ActiveDirectoryAddGroupsArgs", "joinPointId");
            }
            return $;
        }
    }
