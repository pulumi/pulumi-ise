...
@CustomType
public final class GetCertificateAuthenticationProfileResult {
    /**
    ...
    public static Builder builder(GetCertificateAuthenticationProfileResult defaults) {
    ...
    public static final class Builder {
        ...
        private String usernameFrom;
        public Builder() {}
        public Builder(GetCertificateAuthenticationProfileResult defaults) {
        ...
        public Builder allowedAsUserName(Boolean allowedAsUserName) {
            if (allowedAsUserName == null) {
              throw new MissingRequiredPropertyException("GetCertificateAuthenticationProfileResult", "allowedAsUserName");
            }
        ...
        public Builder certificateAttributeName(String certificateAttributeName) {
            if (certificateAttributeName == null) {
              throw new MissingRequiredPropertyException("GetCertificateAuthenticationProfileResult", "certificateAttributeName");
            }
        ...
        public Builder description(String description) {
            if (description == null) {
              throw new MissingRequiredPropertyException("GetCertificateAuthenticationProfileResult", "description");
            }
        ...
        public Builder externalIdentityStoreName(String externalIdentityStoreName) {
            if (externalIdentityStoreName == null) {
              throw new MissingRequiredPropertyException("GetCertificateAuthenticationProfileResult", "externalIdentityStoreName");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetCertificateAuthenticationProfileResult", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder matchMode(String matchMode) {
            if (matchMode == null) {
              throw new MissingRequiredPropertyException("GetCertificateAuthenticationProfileResult", "matchMode");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetCertificateAuthenticationProfileResult", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder usernameFrom(String usernameFrom) {
            if (usernameFrom == null) {
              throw new MissingRequiredPropertyException("GetCertificateAuthenticationProfileResult", "usernameFrom");
            }
            this.usernameFrom = usernameFrom;
            return this;
        }
        public GetCertificateAuthenticationProfileResult build() {
            final var _resultValue = new GetCertificateAuthenticationProfileResult();
