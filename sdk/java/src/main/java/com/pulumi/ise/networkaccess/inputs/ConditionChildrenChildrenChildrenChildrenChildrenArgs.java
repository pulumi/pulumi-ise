...
import com.pulumi.ise.networkaccess.inputs.ConditionChildrenChildrenChildrenChildrenChildrenChildrenArgs;
...
public final class ConditionChildrenChildrenChildrenChildrenChildrenArgs extends com.pulumi.resources.ResourceArgs {

    public static final ConditionChildrenChildrenChildrenChildrenChildrenArgs Empty = new ConditionChildrenChildrenChildrenChildrenChildrenArgs();
    ...
    private @Nullable Output<List<ConditionChildrenChildrenChildrenChildrenChildrenChildrenArgs>> childrens;

    /**
     * @return List of child conditions
     * 
     */
    public Optional<Output<List<ConditionChildrenChildrenChildrenChildrenChildrenChildrenArgs>>> childrens() {
    ...
    private ConditionChildrenChildrenChildrenChildrenChildrenArgs() {}

    private ConditionChildrenChildrenChildrenChildrenChildrenArgs(ConditionChildrenChildrenChildrenChildrenChildrenArgs $) {
    ...
    public static Builder builder(ConditionChildrenChildrenChildrenChildrenChildrenArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ConditionChildrenChildrenChildrenChildrenChildrenArgs();
        }

        public Builder(ConditionChildrenChildrenChildrenChildrenChildrenArgs defaults) {
            $ = new ConditionChildrenChildrenChildrenChildrenChildrenArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder childrens(@Nullable Output<List<ConditionChildrenChildrenChildrenChildrenChildrenChildrenArgs>> childrens) {
            $.childrens = childrens;
            return this;
        }
         ...
         * 
         */
        public Builder childrens(List<ConditionChildrenChildrenChildrenChildrenChildrenChildrenArgs> childrens) {
         ...
         * 
         */
        public Builder childrens(ConditionChildrenChildrenChildrenChildrenChildrenChildrenArgs... childrens) {
        ...
        public ConditionChildrenChildrenChildrenChildrenChildrenArgs build() {
            if ($.conditionType == null) {
                throw new MissingRequiredPropertyException("ConditionChildrenChildrenChildrenChildrenChildrenArgs", "conditionType");
            }
            return $;
        }
    }
