...
import com.pulumi.ise.activeDirectory.outputs.GetJoinPointAttribute;
import com.pulumi.ise.activeDirectory.outputs.GetJoinPointGroup;
import com.pulumi.ise.activeDirectory.outputs.GetJoinPointRewriteRule;
...
@CustomType
public final class GetJoinPointResult {
    /**
     ...
     * 
     */
    private List<GetJoinPointAttribute> attributes;
    /**
     ...
     * 
     */
    private List<GetJoinPointGroup> groups;
    /**
     ...
     * 
     */
    private List<GetJoinPointRewriteRule> rewriteRules;
    /**
     * @return Schema
     * 
     */
     ...
     * 
     */
    public List<GetJoinPointAttribute> attributes() {
     ...
     * 
     */
    public List<GetJoinPointGroup> groups() {
        return this.groups;
    }
    /**
     * @return The id of the object
     ...
     * 
     */
    public List<GetJoinPointRewriteRule> rewriteRules() {
    ...
    public static Builder builder(GetJoinPointResult defaults) {
    ...
    public static final class Builder {
        ...
        private String unreachableDomainsBehaviour;
        public Builder() {}
        public Builder(GetJoinPointResult defaults) {
        ...
        public Builder adScopesNames(String adScopesNames) {
            if (adScopesNames == null) {
              throw new MissingRequiredPropertyException("GetJoinPointResult", "adScopesNames");
            }
        ...
        public Builder agingTime(Integer agingTime) {
            if (agingTime == null) {
              throw new MissingRequiredPropertyException("GetJoinPointResult", "agingTime");
            }
            this.agingTime = agingTime;
            return this;
        }
        @CustomType.Setter
        public Builder attributes(List<GetJoinPointAttribute> attributes) {
            if (attributes == null) {
              throw new MissingRequiredPropertyException("GetJoinPointResult", "attributes");
            }
            this.attributes = attributes;
            return this;
        }
        public Builder attributes(GetJoinPointAttribute... attributes) {
            return attributes(List.of(attributes));
        }
        @CustomType.Setter
        public Builder authProtectionType(String authProtectionType) {
            if (authProtectionType == null) {
              throw new MissingRequiredPropertyException("GetJoinPointResult", "authProtectionType");
            }
        ...
        public Builder country(String country) {
            if (country == null) {
              throw new MissingRequiredPropertyException("GetJoinPointResult", "country");
            }
        ...
        public Builder department(String department) {
            if (department == null) {
              throw new MissingRequiredPropertyException("GetJoinPointResult", "department");
            }
        ...
        public Builder description(String description) {
            if (description == null) {
              throw new MissingRequiredPropertyException("GetJoinPointResult", "description");
            }
        ...
        public Builder domain(String domain) {
            if (domain == null) {
              throw new MissingRequiredPropertyException("GetJoinPointResult", "domain");
            }
            this.domain = domain;
            return this;
        }
        ...
        public Builder email(String email) {
            if (email == null) {
              throw new MissingRequiredPropertyException("GetJoinPointResult", "email");
            }
            this.email = email;
            return this;
        }
        ...
        public Builder enableCallbackForDialinClient(Boolean enableCallbackForDialinClient) {
            if (enableCallbackForDialinClient == null) {
              throw new MissingRequiredPropertyException("GetJoinPointResult", "enableCallbackForDialinClient");
            }
        ...
        public Builder enableDialinPermissionCheck(Boolean enableDialinPermissionCheck) {
            if (enableDialinPermissionCheck == null) {
              throw new MissingRequiredPropertyException("GetJoinPointResult", "enableDialinPermissionCheck");
            }
        ...
        public Builder enableDomainAllowedList(Boolean enableDomainAllowedList) {
            if (enableDomainAllowedList == null) {
              throw new MissingRequiredPropertyException("GetJoinPointResult", "enableDomainAllowedList");
            }
        ...
        public Builder enableFailedAuthProtection(Boolean enableFailedAuthProtection) {
            if (enableFailedAuthProtection == null) {
              throw new MissingRequiredPropertyException("GetJoinPointResult", "enableFailedAuthProtection");
            }
        ...
        public Builder enableMachineAccess(Boolean enableMachineAccess) {
            if (enableMachineAccess == null) {
              throw new MissingRequiredPropertyException("GetJoinPointResult", "enableMachineAccess");
            }
        ...
        public Builder enableMachineAuth(Boolean enableMachineAuth) {
            if (enableMachineAuth == null) {
              throw new MissingRequiredPropertyException("GetJoinPointResult", "enableMachineAuth");
            }
        ...
        public Builder enablePassChange(Boolean enablePassChange) {
            if (enablePassChange == null) {
              throw new MissingRequiredPropertyException("GetJoinPointResult", "enablePassChange");
            }
        ...
        public Builder enableRewrites(Boolean enableRewrites) {
            if (enableRewrites == null) {
              throw new MissingRequiredPropertyException("GetJoinPointResult", "enableRewrites");
            }
        ...
        public Builder failedAuthThreshold(Integer failedAuthThreshold) {
            if (failedAuthThreshold == null) {
              throw new MissingRequiredPropertyException("GetJoinPointResult", "failedAuthThreshold");
            }
        ...
        public Builder firstName(String firstName) {
            if (firstName == null) {
              throw new MissingRequiredPropertyException("GetJoinPointResult", "firstName");
            }
            this.firstName = firstName;
            return this;
        }
        @CustomType.Setter
        public Builder groups(List<GetJoinPointGroup> groups) {
            if (groups == null) {
              throw new MissingRequiredPropertyException("GetJoinPointResult", "groups");
            }
            this.groups = groups;
            return this;
        }
        public Builder groups(GetJoinPointGroup... groups) {
            return groups(List.of(groups));
        }
        @CustomType.Setter
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetJoinPointResult", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder identityNotInAdBehaviour(String identityNotInAdBehaviour) {
            if (identityNotInAdBehaviour == null) {
              throw new MissingRequiredPropertyException("GetJoinPointResult", "identityNotInAdBehaviour");
            }
        ...
        public Builder jobTitle(String jobTitle) {
            if (jobTitle == null) {
              throw new MissingRequiredPropertyException("GetJoinPointResult", "jobTitle");
            }
        ...
        public Builder lastName(String lastName) {
            if (lastName == null) {
              throw new MissingRequiredPropertyException("GetJoinPointResult", "lastName");
            }
        ...
        public Builder locality(String locality) {
            if (locality == null) {
              throw new MissingRequiredPropertyException("GetJoinPointResult", "locality");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetJoinPointResult", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder organizationalUnit(String organizationalUnit) {
            if (organizationalUnit == null) {
              throw new MissingRequiredPropertyException("GetJoinPointResult", "organizationalUnit");
            }
        ...
        public Builder plaintextAuth(Boolean plaintextAuth) {
            if (plaintextAuth == null) {
              throw new MissingRequiredPropertyException("GetJoinPointResult", "plaintextAuth");
            }
            this.plaintextAuth = plaintextAuth;
            return this;
        }
        @CustomType.Setter
        public Builder rewriteRules(List<GetJoinPointRewriteRule> rewriteRules) {
            if (rewriteRules == null) {
              throw new MissingRequiredPropertyException("GetJoinPointResult", "rewriteRules");
            }
            this.rewriteRules = rewriteRules;
            return this;
        }
        public Builder rewriteRules(GetJoinPointRewriteRule... rewriteRules) {
            return rewriteRules(List.of(rewriteRules));
        }
        @CustomType.Setter
        public Builder schema(String schema) {
            if (schema == null) {
              throw new MissingRequiredPropertyException("GetJoinPointResult", "schema");
            }
            this.schema = schema;
            return this;
        }
        ...
        public Builder stateOrProvince(String stateOrProvince) {
            if (stateOrProvince == null) {
              throw new MissingRequiredPropertyException("GetJoinPointResult", "stateOrProvince");
            }
        ...
        public Builder streetAddress(String streetAddress) {
            if (streetAddress == null) {
              throw new MissingRequiredPropertyException("GetJoinPointResult", "streetAddress");
            }
        ...
        public Builder telephone(String telephone) {
            if (telephone == null) {
              throw new MissingRequiredPropertyException("GetJoinPointResult", "telephone");
            }
        ...
        public Builder unreachableDomainsBehaviour(String unreachableDomainsBehaviour) {
            if (unreachableDomainsBehaviour == null) {
              throw new MissingRequiredPropertyException("GetJoinPointResult", "unreachableDomainsBehaviour");
            }
            this.unreachableDomainsBehaviour = unreachableDomainsBehaviour;
            return this;
        }
        public GetJoinPointResult build() {
            final var _resultValue = new GetJoinPointResult();
