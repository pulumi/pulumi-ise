...
import com.pulumi.ise.DeviceAdminTimeAndDate.inputs.GetConditionPlainArgs;
import com.pulumi.ise.DeviceAdminTimeAndDate.outputs.GetConditionResult;
import com.pulumi.ise.Utilities;
import java.util.concurrent.CompletableFuture;

public final class DeviceAdminTimeAndDateFunctions {
    /**
    ...
    public static Output<GetConditionResult> getCondition(GetConditionArgs args, InvokeOptions options) {
        return Deployment.getInstance().invoke("ise:DeviceAdminTimeAndDate/getCondition:getCondition", TypeShape.of(GetConditionResult.class), args, Utilities.withVersion(options));
    }
    /**
     * This data source can read the Device Admin Time And Date Condition.
     * 
    ...
    public static CompletableFuture<GetConditionResult> getConditionPlain(GetConditionPlainArgs args, InvokeOptions options) {
        return Deployment.getInstance().invokeAsync("ise:DeviceAdminTimeAndDate/getCondition:getCondition", TypeShape.of(GetConditionResult.class), args, Utilities.withVersion(options));
    }
}
