...
public final class JoinPointAttributeArgs extends com.pulumi.resources.ResourceArgs {

    public static final JoinPointAttributeArgs Empty = new JoinPointAttributeArgs();
    ...
    private JoinPointAttributeArgs() {}

    private JoinPointAttributeArgs(JoinPointAttributeArgs $) {
    ...
    public static Builder builder(JoinPointAttributeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new JoinPointAttributeArgs();
        }

        public Builder(JoinPointAttributeArgs defaults) {
            $ = new JoinPointAttributeArgs(Objects.requireNonNull(defaults));
        }
        ...
        public JoinPointAttributeArgs build() {
            if ($.defaultValue == null) {
                throw new MissingRequiredPropertyException("JoinPointAttributeArgs", "defaultValue");
            }
            if ($.internalName == null) {
                throw new MissingRequiredPropertyException("JoinPointAttributeArgs", "internalName");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("JoinPointAttributeArgs", "name");
            }
            if ($.type == null) {
                throw new MissingRequiredPropertyException("JoinPointAttributeArgs", "type");
            }
            return $;
        }
    }
