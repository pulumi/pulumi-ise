...
import com.pulumi.ise.EndpointIdentity.inputs.GroupState;
 ...
 * 
 */
@ResourceType(type="ise:EndpointIdentity/group:Group")
public class Group extends com.pulumi.resources.CustomResource {
    ...
    public Group(String name, @Nullable GroupArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:EndpointIdentity/group:Group", name, args == null ? GroupArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private Group(String name, Output<String> id, @Nullable GroupState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:EndpointIdentity/group:Group", name, state, makeResourceOptions(options, id));
    }
