...
import com.pulumi.ise.deviceadmin.outputs.GetAuthorizationGlobalExceptionRuleChildrenChildrenChildren;
...
public final class GetAuthorizationGlobalExceptionRuleChildrenChildren {
    ...
    private GetAuthorizationGlobalExceptionRuleChildrenChildren() {}
    /**
     * @return Dictionary attribute name
     * 
     */
    ...
    public static Builder builder(GetAuthorizationGlobalExceptionRuleChildrenChildren defaults) {
    ...
    public static final class Builder {
        ...
        private String operator;
        public Builder() {}
        public Builder(GetAuthorizationGlobalExceptionRuleChildrenChildren defaults) {
        ...
        public Builder attributeName(String attributeName) {
            if (attributeName == null) {
              throw new MissingRequiredPropertyException("GetAuthorizationGlobalExceptionRuleChildrenChildren", "attributeName");
            }
        ...
        public Builder attributeValue(String attributeValue) {
            if (attributeValue == null) {
              throw new MissingRequiredPropertyException("GetAuthorizationGlobalExceptionRuleChildrenChildren", "attributeValue");
            }
        ...
        public Builder conditionType(String conditionType) {
            if (conditionType == null) {
              throw new MissingRequiredPropertyException("GetAuthorizationGlobalExceptionRuleChildrenChildren", "conditionType");
            }
        ...
        public Builder dictionaryName(String dictionaryName) {
            if (dictionaryName == null) {
              throw new MissingRequiredPropertyException("GetAuthorizationGlobalExceptionRuleChildrenChildren", "dictionaryName");
            }
        ...
        public Builder dictionaryValue(String dictionaryValue) {
            if (dictionaryValue == null) {
              throw new MissingRequiredPropertyException("GetAuthorizationGlobalExceptionRuleChildrenChildren", "dictionaryValue");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetAuthorizationGlobalExceptionRuleChildrenChildren", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder isNegate(Boolean isNegate) {
            if (isNegate == null) {
              throw new MissingRequiredPropertyException("GetAuthorizationGlobalExceptionRuleChildrenChildren", "isNegate");
            }
        ...
        public Builder operator(String operator) {
            if (operator == null) {
              throw new MissingRequiredPropertyException("GetAuthorizationGlobalExceptionRuleChildrenChildren", "operator");
            }
            this.operator = operator;
            return this;
        }
        public GetAuthorizationGlobalExceptionRuleChildrenChildren build() {
