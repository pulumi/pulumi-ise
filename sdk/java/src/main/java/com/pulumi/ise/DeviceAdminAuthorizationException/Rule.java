...
package com.pulumi.ise.DeviceAdminAuthorizationException;
...
import com.pulumi.ise.DeviceAdminAuthorizationException.inputs.RuleState;
import com.pulumi.ise.DeviceAdminAuthorizationException.outputs.RuleChildren;
 ...
 * 
 */
@ResourceType(type="ise:DeviceAdminAuthorizationException/rule:Rule")
public class Rule extends com.pulumi.resources.CustomResource {
    ...
    public Rule(String name, RuleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:DeviceAdminAuthorizationException/rule:Rule", name, args == null ? RuleArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private Rule(String name, Output<String> id, @Nullable RuleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:DeviceAdminAuthorizationException/rule:Rule", name, state, makeResourceOptions(options, id));
    }
