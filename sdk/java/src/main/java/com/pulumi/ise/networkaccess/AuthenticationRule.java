...
import com.pulumi.ise.networkaccess.inputs.AuthenticationRuleState;
import com.pulumi.ise.networkaccess.outputs.AuthenticationRuleChildren;
 ...
 * 
 */
@ResourceType(type="ise:networkaccess/authenticationRule:AuthenticationRule")
public class AuthenticationRule extends com.pulumi.resources.CustomResource {
    ...
    public AuthenticationRule(String name, AuthenticationRuleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:networkaccess/authenticationRule:AuthenticationRule", name, args == null ? AuthenticationRuleArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private AuthenticationRule(String name, Output<String> id, @Nullable AuthenticationRuleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:networkaccess/authenticationRule:AuthenticationRule", name, state, makeResourceOptions(options, id));
    }
