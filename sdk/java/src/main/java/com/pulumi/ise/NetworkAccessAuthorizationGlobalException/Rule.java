...
package com.pulumi.ise.NetworkAccessAuthorizationGlobalException;
...
import com.pulumi.ise.NetworkAccessAuthorizationGlobalException.inputs.RuleState;
import com.pulumi.ise.NetworkAccessAuthorizationGlobalException.outputs.RuleChildren;
 ...
 * 
 */
@ResourceType(type="ise:NetworkAccessAuthorizationGlobalException/rule:Rule")
public class Rule extends com.pulumi.resources.CustomResource {
    /**
     * List of child conditions. `condition_type` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
     * 
     */
    @Export(name="childrens", refs={List.class,RuleChildren.class}, tree="[0,1]")
    private Output</* @Nullable */ List<RuleChildren>> childrens;

    /**
     * @return List of child conditions. `condition_type` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
     * 
     */
    public Output<Optional<List<RuleChildren>>> childrens() {
    ...
    public Rule(String name, @Nullable RuleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:NetworkAccessAuthorizationGlobalException/rule:Rule", name, args == null ? RuleArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private Rule(String name, Output<String> id, @Nullable RuleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:NetworkAccessAuthorizationGlobalException/rule:Rule", name, state, makeResourceOptions(options, id));
    }
