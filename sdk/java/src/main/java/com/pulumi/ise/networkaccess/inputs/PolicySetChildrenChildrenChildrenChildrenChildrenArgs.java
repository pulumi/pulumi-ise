...
import com.pulumi.ise.networkaccess.inputs.PolicySetChildrenChildrenChildrenChildrenChildrenChildrenArgs;
...
public final class PolicySetChildrenChildrenChildrenChildrenChildrenArgs extends com.pulumi.resources.ResourceArgs {

    public static final PolicySetChildrenChildrenChildrenChildrenChildrenArgs Empty = new PolicySetChildrenChildrenChildrenChildrenChildrenArgs();
    ...
    private @Nullable Output<List<PolicySetChildrenChildrenChildrenChildrenChildrenChildrenArgs>> childrens;

    /**
     * @return List of child conditions
     * 
     */
    public Optional<Output<List<PolicySetChildrenChildrenChildrenChildrenChildrenChildrenArgs>>> childrens() {
    ...
    private PolicySetChildrenChildrenChildrenChildrenChildrenArgs() {}

    private PolicySetChildrenChildrenChildrenChildrenChildrenArgs(PolicySetChildrenChildrenChildrenChildrenChildrenArgs $) {
    ...
    public static Builder builder(PolicySetChildrenChildrenChildrenChildrenChildrenArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PolicySetChildrenChildrenChildrenChildrenChildrenArgs();
        }

        public Builder(PolicySetChildrenChildrenChildrenChildrenChildrenArgs defaults) {
            $ = new PolicySetChildrenChildrenChildrenChildrenChildrenArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder childrens(@Nullable Output<List<PolicySetChildrenChildrenChildrenChildrenChildrenChildrenArgs>> childrens) {
            $.childrens = childrens;
            return this;
        }
         ...
         * 
         */
        public Builder childrens(List<PolicySetChildrenChildrenChildrenChildrenChildrenChildrenArgs> childrens) {
         ...
         * 
         */
        public Builder childrens(PolicySetChildrenChildrenChildrenChildrenChildrenChildrenArgs... childrens) {
        ...
        public PolicySetChildrenChildrenChildrenChildrenChildrenArgs build() {
            if ($.conditionType == null) {
                throw new MissingRequiredPropertyException("PolicySetChildrenChildrenChildrenChildrenChildrenArgs", "conditionType");
            }
            return $;
        }
    }
