...
@CustomType
public final class JoinPointRewriteRule {
    /**
    ...
    public static Builder builder(JoinPointRewriteRule defaults) {
    ...
    public static final class Builder {
        ...
        private String rowId;
        public Builder() {}
        public Builder(JoinPointRewriteRule defaults) {
        ...
        public Builder rewriteMatch(String rewriteMatch) {
            if (rewriteMatch == null) {
              throw new MissingRequiredPropertyException("JoinPointRewriteRule", "rewriteMatch");
            }
        ...
        public Builder rewriteResult(String rewriteResult) {
            if (rewriteResult == null) {
              throw new MissingRequiredPropertyException("JoinPointRewriteRule", "rewriteResult");
            }
        ...
        public Builder rowId(String rowId) {
            if (rowId == null) {
              throw new MissingRequiredPropertyException("JoinPointRewriteRule", "rowId");
            }
            this.rowId = rowId;
            return this;
        }
        public JoinPointRewriteRule build() {
            final var _resultValue = new JoinPointRewriteRule();
