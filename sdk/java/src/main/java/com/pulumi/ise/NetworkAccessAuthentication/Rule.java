...
import com.pulumi.ise.NetworkAccessAuthentication.inputs.RuleState;
import com.pulumi.ise.NetworkAccessAuthentication.outputs.RuleChildren;
 ...
 * 
 */
@ResourceType(type="ise:NetworkAccessAuthentication/rule:Rule")
public class Rule extends com.pulumi.resources.CustomResource {
    ...
    public Rule(String name, RuleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:NetworkAccessAuthentication/rule:Rule", name, args == null ? RuleArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private Rule(String name, Output<String> id, @Nullable RuleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:NetworkAccessAuthentication/rule:Rule", name, state, makeResourceOptions(options, id));
    }
