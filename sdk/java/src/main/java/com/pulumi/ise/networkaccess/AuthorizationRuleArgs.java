...
import com.pulumi.ise.networkaccess.inputs.AuthorizationRuleChildrenArgs;
...
public final class AuthorizationRuleArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder childrens(@Nullable Output<List<AuthorizationRuleChildrenArgs>> childrens) {
            $.childrens = childrens;
            return this;
        }
         ...
         * 
         */
        public Builder childrens(List<AuthorizationRuleChildrenArgs> childrens) {
         ...
         * 
         */
        public Builder childrens(AuthorizationRuleChildrenArgs... childrens) {
        ...
        public AuthorizationRuleArgs build() {
            if ($.policySetId == null) {
                throw new MissingRequiredPropertyException("AuthorizationRuleArgs", "policySetId");
            }
            return $;
        }
    }
