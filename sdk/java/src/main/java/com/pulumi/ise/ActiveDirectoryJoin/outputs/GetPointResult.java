...
import com.pulumi.ise.ActiveDirectoryJoin.outputs.GetPointAttribute;
import com.pulumi.ise.ActiveDirectoryJoin.outputs.GetPointGroup;
import com.pulumi.ise.ActiveDirectoryJoin.outputs.GetPointRewriteRule;
...
@CustomType
public final class GetPointResult {
    /**
     ...
     * 
     */
    private List<GetPointAttribute> attributes;
    /**
     ...
     * 
     */
    private List<GetPointGroup> groups;
    /**
     ...
     * 
     */
    private List<GetPointRewriteRule> rewriteRules;
    /**
     * @return Schema
     * 
     */
     ...
     * 
     */
    public List<GetPointAttribute> attributes() {
     ...
     * 
     */
    public List<GetPointGroup> groups() {
        return this.groups;
    }
    /**
     * @return The id of the object
     ...
     * 
     */
    public List<GetPointRewriteRule> rewriteRules() {
    ...
    public static Builder builder(GetPointResult defaults) {
    ...
    public static final class Builder {
        ...
        private String unreachableDomainsBehaviour;
        public Builder() {}
        public Builder(GetPointResult defaults) {
        ...
        public Builder adScopesNames(String adScopesNames) {
            if (adScopesNames == null) {
              throw new MissingRequiredPropertyException("GetPointResult", "adScopesNames");
            }
        ...
        public Builder agingTime(Integer agingTime) {
            if (agingTime == null) {
              throw new MissingRequiredPropertyException("GetPointResult", "agingTime");
            }
            this.agingTime = agingTime;
            return this;
        }
        @CustomType.Setter
        public Builder attributes(List<GetPointAttribute> attributes) {
            if (attributes == null) {
              throw new MissingRequiredPropertyException("GetPointResult", "attributes");
            }
            this.attributes = attributes;
            return this;
        }
        public Builder attributes(GetPointAttribute... attributes) {
            return attributes(List.of(attributes));
        }
        @CustomType.Setter
        public Builder authProtectionType(String authProtectionType) {
            if (authProtectionType == null) {
              throw new MissingRequiredPropertyException("GetPointResult", "authProtectionType");
            }
        ...
        public Builder country(String country) {
            if (country == null) {
              throw new MissingRequiredPropertyException("GetPointResult", "country");
            }
        ...
        public Builder department(String department) {
            if (department == null) {
              throw new MissingRequiredPropertyException("GetPointResult", "department");
            }
        ...
        public Builder description(String description) {
            if (description == null) {
              throw new MissingRequiredPropertyException("GetPointResult", "description");
            }
        ...
        public Builder domain(String domain) {
            if (domain == null) {
              throw new MissingRequiredPropertyException("GetPointResult", "domain");
            }
            this.domain = domain;
            return this;
        }
        ...
        public Builder email(String email) {
            if (email == null) {
              throw new MissingRequiredPropertyException("GetPointResult", "email");
            }
            this.email = email;
            return this;
        }
        ...
        public Builder enableCallbackForDialinClient(Boolean enableCallbackForDialinClient) {
            if (enableCallbackForDialinClient == null) {
              throw new MissingRequiredPropertyException("GetPointResult", "enableCallbackForDialinClient");
            }
        ...
        public Builder enableDialinPermissionCheck(Boolean enableDialinPermissionCheck) {
            if (enableDialinPermissionCheck == null) {
              throw new MissingRequiredPropertyException("GetPointResult", "enableDialinPermissionCheck");
            }
        ...
        public Builder enableDomainAllowedList(Boolean enableDomainAllowedList) {
            if (enableDomainAllowedList == null) {
              throw new MissingRequiredPropertyException("GetPointResult", "enableDomainAllowedList");
            }
        ...
        public Builder enableFailedAuthProtection(Boolean enableFailedAuthProtection) {
            if (enableFailedAuthProtection == null) {
              throw new MissingRequiredPropertyException("GetPointResult", "enableFailedAuthProtection");
            }
        ...
        public Builder enableMachineAccess(Boolean enableMachineAccess) {
            if (enableMachineAccess == null) {
              throw new MissingRequiredPropertyException("GetPointResult", "enableMachineAccess");
            }
        ...
        public Builder enableMachineAuth(Boolean enableMachineAuth) {
            if (enableMachineAuth == null) {
              throw new MissingRequiredPropertyException("GetPointResult", "enableMachineAuth");
            }
        ...
        public Builder enablePassChange(Boolean enablePassChange) {
            if (enablePassChange == null) {
              throw new MissingRequiredPropertyException("GetPointResult", "enablePassChange");
            }
        ...
        public Builder enableRewrites(Boolean enableRewrites) {
            if (enableRewrites == null) {
              throw new MissingRequiredPropertyException("GetPointResult", "enableRewrites");
            }
        ...
        public Builder failedAuthThreshold(Integer failedAuthThreshold) {
            if (failedAuthThreshold == null) {
              throw new MissingRequiredPropertyException("GetPointResult", "failedAuthThreshold");
            }
        ...
        public Builder firstName(String firstName) {
            if (firstName == null) {
              throw new MissingRequiredPropertyException("GetPointResult", "firstName");
            }
            this.firstName = firstName;
            return this;
        }
        @CustomType.Setter
        public Builder groups(List<GetPointGroup> groups) {
            if (groups == null) {
              throw new MissingRequiredPropertyException("GetPointResult", "groups");
            }
            this.groups = groups;
            return this;
        }
        public Builder groups(GetPointGroup... groups) {
            return groups(List.of(groups));
        }
        @CustomType.Setter
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetPointResult", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder identityNotInAdBehaviour(String identityNotInAdBehaviour) {
            if (identityNotInAdBehaviour == null) {
              throw new MissingRequiredPropertyException("GetPointResult", "identityNotInAdBehaviour");
            }
        ...
        public Builder jobTitle(String jobTitle) {
            if (jobTitle == null) {
              throw new MissingRequiredPropertyException("GetPointResult", "jobTitle");
            }
        ...
        public Builder lastName(String lastName) {
            if (lastName == null) {
              throw new MissingRequiredPropertyException("GetPointResult", "lastName");
            }
        ...
        public Builder locality(String locality) {
            if (locality == null) {
              throw new MissingRequiredPropertyException("GetPointResult", "locality");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetPointResult", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder organizationalUnit(String organizationalUnit) {
            if (organizationalUnit == null) {
              throw new MissingRequiredPropertyException("GetPointResult", "organizationalUnit");
            }
        ...
        public Builder plaintextAuth(Boolean plaintextAuth) {
            if (plaintextAuth == null) {
              throw new MissingRequiredPropertyException("GetPointResult", "plaintextAuth");
            }
            this.plaintextAuth = plaintextAuth;
            return this;
        }
        @CustomType.Setter
        public Builder rewriteRules(List<GetPointRewriteRule> rewriteRules) {
            if (rewriteRules == null) {
              throw new MissingRequiredPropertyException("GetPointResult", "rewriteRules");
            }
            this.rewriteRules = rewriteRules;
            return this;
        }
        public Builder rewriteRules(GetPointRewriteRule... rewriteRules) {
            return rewriteRules(List.of(rewriteRules));
        }
        @CustomType.Setter
        public Builder schema(String schema) {
            if (schema == null) {
              throw new MissingRequiredPropertyException("GetPointResult", "schema");
            }
            this.schema = schema;
            return this;
        }
        ...
        public Builder stateOrProvince(String stateOrProvince) {
            if (stateOrProvince == null) {
              throw new MissingRequiredPropertyException("GetPointResult", "stateOrProvince");
            }
        ...
        public Builder streetAddress(String streetAddress) {
            if (streetAddress == null) {
              throw new MissingRequiredPropertyException("GetPointResult", "streetAddress");
            }
        ...
        public Builder telephone(String telephone) {
            if (telephone == null) {
              throw new MissingRequiredPropertyException("GetPointResult", "telephone");
            }
        ...
        public Builder unreachableDomainsBehaviour(String unreachableDomainsBehaviour) {
            if (unreachableDomainsBehaviour == null) {
              throw new MissingRequiredPropertyException("GetPointResult", "unreachableDomainsBehaviour");
            }
            this.unreachableDomainsBehaviour = unreachableDomainsBehaviour;
            return this;
        }
        public GetPointResult build() {
            final var _resultValue = new GetPointResult();
