...
import com.pulumi.ise.networkaccess.outputs.ConditionChildrenChildrenChildrenChildrenChildrenChildren;
...
@CustomType
public final class ConditionChildrenChildrenChildrenChildrenChildren {
    /**
     ...
     * 
     */
    private @Nullable List<ConditionChildrenChildrenChildrenChildrenChildrenChildren> childrens;
    /**
    ...
    private ConditionChildrenChildrenChildrenChildrenChildren() {}
    /**
     * @return Dictionary attribute name
     * 
     */
     ...
     * 
     */
    public List<ConditionChildrenChildrenChildrenChildrenChildrenChildren> childrens() {
    ...
    public static Builder builder(ConditionChildrenChildrenChildrenChildrenChildren defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String operator;
        public Builder() {}
        public Builder(ConditionChildrenChildrenChildrenChildrenChildren defaults) {
        ...
        @CustomType.Setter
        public Builder childrens(@Nullable List<ConditionChildrenChildrenChildrenChildrenChildrenChildren> childrens) {

            this.childrens = childrens;
            return this;
        }
        public Builder childrens(ConditionChildrenChildrenChildrenChildrenChildrenChildren... childrens) {
            return childrens(List.of(childrens));
        }
        @CustomType.Setter
        public Builder conditionType(String conditionType) {
            if (conditionType == null) {
              throw new MissingRequiredPropertyException("ConditionChildrenChildrenChildrenChildrenChildren", "conditionType");
            }
        ...
        public ConditionChildrenChildrenChildrenChildrenChildren build() {
            final var _resultValue = new ConditionChildrenChildrenChildrenChildrenChildren();
