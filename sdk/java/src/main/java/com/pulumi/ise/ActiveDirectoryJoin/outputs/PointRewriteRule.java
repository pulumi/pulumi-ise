...
@CustomType
public final class PointRewriteRule {
    /**
    ...
    public static Builder builder(PointRewriteRule defaults) {
    ...
    public static final class Builder {
        ...
        private String rowId;
        public Builder() {}
        public Builder(PointRewriteRule defaults) {
        ...
        public Builder rewriteMatch(String rewriteMatch) {
            if (rewriteMatch == null) {
              throw new MissingRequiredPropertyException("PointRewriteRule", "rewriteMatch");
            }
        ...
        public Builder rewriteResult(String rewriteResult) {
            if (rewriteResult == null) {
              throw new MissingRequiredPropertyException("PointRewriteRule", "rewriteResult");
            }
        ...
        public Builder rowId(String rowId) {
            if (rowId == null) {
              throw new MissingRequiredPropertyException("PointRewriteRule", "rowId");
            }
            this.rowId = rowId;
            return this;
        }
        public PointRewriteRule build() {
            final var _resultValue = new PointRewriteRule();
