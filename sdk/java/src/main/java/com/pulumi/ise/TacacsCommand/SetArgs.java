...
public final class SetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<List<SetCommandArgs>> commands;

    public Optional<Output<List<SetCommandArgs>>> commands() {
    ...
    public static final class Builder {
        ...
        public Builder commands(@Nullable Output<List<SetCommandArgs>> commands) {
            $.commands = commands;
            return this;
        }

        public Builder commands(List<SetCommandArgs> commands) {
            return commands(Output.of(commands));
        }

        public Builder commands(SetCommandArgs... commands) {
