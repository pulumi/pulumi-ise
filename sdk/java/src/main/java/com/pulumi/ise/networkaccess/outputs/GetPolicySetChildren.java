...
import com.pulumi.ise.networkaccess.outputs.GetPolicySetChildrenChildren;
...
@CustomType
public final class GetPolicySetChildren {
    /**
    ...
    public static Builder builder(GetPolicySetChildren defaults) {
    ...
    public static final class Builder {
        ...
        private String operator;
        public Builder() {}
        public Builder(GetPolicySetChildren defaults) {
        ...
        public Builder attributeName(String attributeName) {
            if (attributeName == null) {
              throw new MissingRequiredPropertyException("GetPolicySetChildren", "attributeName");
            }
        ...
        public Builder attributeValue(String attributeValue) {
            if (attributeValue == null) {
              throw new MissingRequiredPropertyException("GetPolicySetChildren", "attributeValue");
            }
            this.attributeValue = attributeValue;
            return this;
        }
        @CustomType.Setter
        public Builder childrens(List<GetPolicySetChildrenChildren> childrens) {
            if (childrens == null) {
              throw new MissingRequiredPropertyException("GetPolicySetChildren", "childrens");
            }
            this.childrens = childrens;
            return this;
        }
        public Builder childrens(GetPolicySetChildrenChildren... childrens) {
            return childrens(List.of(childrens));
        }
        @CustomType.Setter
        public Builder conditionType(String conditionType) {
            if (conditionType == null) {
              throw new MissingRequiredPropertyException("GetPolicySetChildren", "conditionType");
            }
        ...
        public Builder dictionaryName(String dictionaryName) {
            if (dictionaryName == null) {
              throw new MissingRequiredPropertyException("GetPolicySetChildren", "dictionaryName");
            }
        ...
        public Builder dictionaryValue(String dictionaryValue) {
            if (dictionaryValue == null) {
              throw new MissingRequiredPropertyException("GetPolicySetChildren", "dictionaryValue");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetPolicySetChildren", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder isNegate(Boolean isNegate) {
            if (isNegate == null) {
              throw new MissingRequiredPropertyException("GetPolicySetChildren", "isNegate");
            }
        ...
        public Builder operator(String operator) {
            if (operator == null) {
              throw new MissingRequiredPropertyException("GetPolicySetChildren", "operator");
            }
            this.operator = operator;
            return this;
        }
        public GetPolicySetChildren build() {
            final var _resultValue = new GetPolicySetChildren();
