...
import com.pulumi.ise.networkaccess.inputs.AuthorizationRuleChildrenChildrenChildrenChildrenChildrenChildrenArgs;
...
public final class AuthorizationRuleChildrenChildrenChildrenChildrenChildrenArgs extends com.pulumi.resources.ResourceArgs {

    public static final AuthorizationRuleChildrenChildrenChildrenChildrenChildrenArgs Empty = new AuthorizationRuleChildrenChildrenChildrenChildrenChildrenArgs();
    ...
    private @Nullable Output<List<AuthorizationRuleChildrenChildrenChildrenChildrenChildrenChildrenArgs>> childrens;

    /**
     * @return List of child conditions
     * 
     */
    public Optional<Output<List<AuthorizationRuleChildrenChildrenChildrenChildrenChildrenChildrenArgs>>> childrens() {
    ...
    private AuthorizationRuleChildrenChildrenChildrenChildrenChildrenArgs() {}

    private AuthorizationRuleChildrenChildrenChildrenChildrenChildrenArgs(AuthorizationRuleChildrenChildrenChildrenChildrenChildrenArgs $) {
    ...
    public static Builder builder(AuthorizationRuleChildrenChildrenChildrenChildrenChildrenArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AuthorizationRuleChildrenChildrenChildrenChildrenChildrenArgs();
        }

        public Builder(AuthorizationRuleChildrenChildrenChildrenChildrenChildrenArgs defaults) {
            $ = new AuthorizationRuleChildrenChildrenChildrenChildrenChildrenArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder childrens(@Nullable Output<List<AuthorizationRuleChildrenChildrenChildrenChildrenChildrenChildrenArgs>> childrens) {
            $.childrens = childrens;
            return this;
        }
         ...
         * 
         */
        public Builder childrens(List<AuthorizationRuleChildrenChildrenChildrenChildrenChildrenChildrenArgs> childrens) {
         ...
         * 
         */
        public Builder childrens(AuthorizationRuleChildrenChildrenChildrenChildrenChildrenChildrenArgs... childrens) {
        ...
        public AuthorizationRuleChildrenChildrenChildrenChildrenChildrenArgs build() {
            if ($.conditionType == null) {
                throw new MissingRequiredPropertyException("AuthorizationRuleChildrenChildrenChildrenChildrenChildrenArgs", "conditionType");
            }
            return $;
        }
    }
