...
import com.pulumi.ise.networkaccess.outputs.PolicySetChildrenChildrenChildrenChildrenChildrenChildren;
...
@CustomType
public final class PolicySetChildrenChildrenChildrenChildrenChildren {
    /**
     ...
     * 
     */
    private @Nullable List<PolicySetChildrenChildrenChildrenChildrenChildrenChildren> childrens;
    /**
    ...
    private PolicySetChildrenChildrenChildrenChildrenChildren() {}
    /**
     * @return Dictionary attribute name
     * 
     */
     ...
     * 
     */
    public List<PolicySetChildrenChildrenChildrenChildrenChildrenChildren> childrens() {
    ...
    public static Builder builder(PolicySetChildrenChildrenChildrenChildrenChildren defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String operator;
        public Builder() {}
        public Builder(PolicySetChildrenChildrenChildrenChildrenChildren defaults) {
        ...
        @CustomType.Setter
        public Builder childrens(@Nullable List<PolicySetChildrenChildrenChildrenChildrenChildrenChildren> childrens) {

            this.childrens = childrens;
            return this;
        }
        public Builder childrens(PolicySetChildrenChildrenChildrenChildrenChildrenChildren... childrens) {
            return childrens(List.of(childrens));
        }
        @CustomType.Setter
        public Builder conditionType(String conditionType) {
            if (conditionType == null) {
              throw new MissingRequiredPropertyException("PolicySetChildrenChildrenChildrenChildrenChildren", "conditionType");
            }
        ...
        public PolicySetChildrenChildrenChildrenChildrenChildren build() {
            final var _resultValue = new PolicySetChildrenChildrenChildrenChildrenChildren();
