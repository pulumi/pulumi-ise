...
import com.pulumi.ise.TrustsecSecurity.inputs.GetGroupPlainArgs;
import com.pulumi.ise.TrustsecSecurity.outputs.GetGroupResult;
import com.pulumi.ise.Utilities;
import java.util.concurrent.CompletableFuture;

public final class TrustsecSecurityFunctions {
    /**
    ...
    public static Output<GetGroupResult> getGroup(GetGroupArgs args, InvokeOptions options) {
        return Deployment.getInstance().invoke("ise:TrustsecSecurity/getGroup:getGroup", TypeShape.of(GetGroupResult.class), args, Utilities.withVersion(options));
    }
    /**
     * This data source can read the TrustSec Security Group.
     * 
    ...
    public static CompletableFuture<GetGroupResult> getGroupPlain(GetGroupPlainArgs args, InvokeOptions options) {
        return Deployment.getInstance().invokeAsync("ise:TrustsecSecurity/getGroup:getGroup", TypeShape.of(GetGroupResult.class), args, Utilities.withVersion(options));
    }
}
