...
import com.pulumi.ise.networkaccess.inputs.AuthenticationRuleChildrenChildrenChildrenArgs;
...
public final class AuthenticationRuleChildrenChildrenArgs extends com.pulumi.resources.ResourceArgs {

    public static final AuthenticationRuleChildrenChildrenArgs Empty = new AuthenticationRuleChildrenChildrenArgs();
    ...
    private @Nullable Output<List<AuthenticationRuleChildrenChildrenChildrenArgs>> childrens;

    /**
     * @return List of child conditions
     * 
     */
    public Optional<Output<List<AuthenticationRuleChildrenChildrenChildrenArgs>>> childrens() {
    ...
    private AuthenticationRuleChildrenChildrenArgs(AuthenticationRuleChildrenChildrenArgs $) {
    ...
    public static Builder builder(AuthenticationRuleChildrenChildrenArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AuthenticationRuleChildrenChildrenArgs();
        }

        public Builder(AuthenticationRuleChildrenChildrenArgs defaults) {
            $ = new AuthenticationRuleChildrenChildrenArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder childrens(@Nullable Output<List<AuthenticationRuleChildrenChildrenChildrenArgs>> childrens) {
            $.childrens = childrens;
            return this;
        }
         ...
         * 
         */
        public Builder childrens(List<AuthenticationRuleChildrenChildrenChildrenArgs> childrens) {
         ...
         * 
         */
        public Builder childrens(AuthenticationRuleChildrenChildrenChildrenArgs... childrens) {
        ...
        public AuthenticationRuleChildrenChildrenArgs build() {
            if ($.conditionType == null) {
                throw new MissingRequiredPropertyException("AuthenticationRuleChildrenChildrenArgs", "conditionType");
            }
            return $;
        }
    }
