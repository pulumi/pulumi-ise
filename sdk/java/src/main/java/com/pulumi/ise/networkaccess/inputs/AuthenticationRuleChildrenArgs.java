...
import com.pulumi.ise.networkaccess.inputs.AuthenticationRuleChildrenChildrenArgs;
...
public final class AuthenticationRuleChildrenArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<List<AuthenticationRuleChildrenChildrenArgs>> childrens;

    /**
     * @return List of child conditions. `condition_type` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
     * 
     */
    public Optional<Output<List<AuthenticationRuleChildrenChildrenArgs>>> childrens() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder childrens(@Nullable Output<List<AuthenticationRuleChildrenChildrenArgs>> childrens) {
            $.childrens = childrens;
            return this;
        }
         ...
         * 
         */
        public Builder childrens(List<AuthenticationRuleChildrenChildrenArgs> childrens) {
