...
public final class RuleArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public RuleArgs build() {
            if ($.ifAuthFail == null) {
                throw new MissingRequiredPropertyException("RuleArgs", "ifAuthFail");
            }
            if ($.ifProcessFail == null) {
                throw new MissingRequiredPropertyException("RuleArgs", "ifProcessFail");
            }
            if ($.ifUserNotFound == null) {
                throw new MissingRequiredPropertyException("RuleArgs", "ifUserNotFound");
            }
            if ($.policySetId == null) {
                throw new MissingRequiredPropertyException("RuleArgs", "policySetId");
            }
            return $;
        }
    }
