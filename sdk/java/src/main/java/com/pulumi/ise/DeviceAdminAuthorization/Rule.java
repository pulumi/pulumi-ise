...
package com.pulumi.ise.DeviceAdminAuthorization;
...
import com.pulumi.ise.DeviceAdminAuthorization.inputs.RuleState;
import com.pulumi.ise.DeviceAdminAuthorization.outputs.RuleChildren;
 ...
 * 
 */
@ResourceType(type="ise:DeviceAdminAuthorization/rule:Rule")
public class Rule extends com.pulumi.resources.CustomResource {
    ...
    public Rule(String name, RuleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:DeviceAdminAuthorization/rule:Rule", name, args == null ? RuleArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private Rule(String name, Output<String> id, @Nullable RuleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:DeviceAdminAuthorization/rule:Rule", name, state, makeResourceOptions(options, id));
    }
