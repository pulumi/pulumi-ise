...
public final class DownloadableAclArgs extends com.pulumi.resources.ResourceArgs {

    public static final DownloadableAclArgs Empty = new DownloadableAclArgs();
    ...
    private DownloadableAclArgs() {}

    private DownloadableAclArgs(DownloadableAclArgs $) {
        this.dacl = $.dacl;
    ...
    public static Builder builder(DownloadableAclArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DownloadableAclArgs();
        }

        public Builder(DownloadableAclArgs defaults) {
            $ = new DownloadableAclArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DownloadableAclArgs build() {
            if ($.dacl == null) {
                throw new MissingRequiredPropertyException("DownloadableAclArgs", "dacl");
            }
            return $;
        }
    }
