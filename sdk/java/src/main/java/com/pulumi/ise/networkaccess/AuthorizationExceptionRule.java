...
public class AuthorizationExceptionRule extends com.pulumi.resources.CustomResource {
     ...
     */
    public AuthorizationExceptionRule(String name) {
     ...
     */
    public AuthorizationExceptionRule(String name, AuthorizationExceptionRuleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:networkaccess/authorizationExceptionRule:AuthorizationExceptionRule", name, args == null ? AuthorizationExceptionRuleArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private AuthorizationExceptionRule(String name, Output<String> id, @Nullable AuthorizationExceptionRuleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:networkaccess/authorizationExceptionRule:AuthorizationExceptionRule", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static AuthorizationExceptionRule get(String name, Output<String> id, @Nullable AuthorizationExceptionRuleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
