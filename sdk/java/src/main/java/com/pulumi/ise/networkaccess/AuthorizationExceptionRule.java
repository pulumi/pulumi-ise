...
import com.pulumi.ise.networkaccess.inputs.AuthorizationExceptionRuleState;
import com.pulumi.ise.networkaccess.outputs.AuthorizationExceptionRuleChildren;
 ...
 * 
 */
@ResourceType(type="ise:networkaccess/authorizationExceptionRule:AuthorizationExceptionRule")
public class AuthorizationExceptionRule extends com.pulumi.resources.CustomResource {
    /**
     * List of child conditions. `conditionType` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
     * 
     */
    @Export(name="childrens", refs={List.class,AuthorizationExceptionRuleChildren.class}, tree="[0,1]")
    private Output</* @Nullable */ List<AuthorizationExceptionRuleChildren>> childrens;

    /**
     * @return List of child conditions. `conditionType` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
     * 
     */
    public Output<Optional<List<AuthorizationExceptionRuleChildren>>> childrens() {
     ...
     */
    public AuthorizationExceptionRule(java.lang.String name) {
        this(name, AuthorizationExceptionRuleArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public AuthorizationExceptionRule(java.lang.String name, AuthorizationExceptionRuleArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public AuthorizationExceptionRule(java.lang.String name, AuthorizationExceptionRuleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:networkaccess/authorizationExceptionRule:AuthorizationExceptionRule", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private AuthorizationExceptionRule(java.lang.String name, Output<java.lang.String> id, @Nullable AuthorizationExceptionRuleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:networkaccess/authorizationExceptionRule:AuthorizationExceptionRule", name, state, makeResourceOptions(options, id), false);
    }

    private static AuthorizationExceptionRuleArgs makeArgs(AuthorizationExceptionRuleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? AuthorizationExceptionRuleArgs.Empty : args;
    }
     ...
     */
    public static AuthorizationExceptionRule get(java.lang.String name, Output<java.lang.String> id, @Nullable AuthorizationExceptionRuleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
