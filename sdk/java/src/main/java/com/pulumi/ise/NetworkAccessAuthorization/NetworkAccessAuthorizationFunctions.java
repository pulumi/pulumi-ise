...
import com.pulumi.ise.NetworkAccessAuthorization.inputs.GetRulePlainArgs;
import com.pulumi.ise.NetworkAccessAuthorization.outputs.GetRuleResult;
import com.pulumi.ise.Utilities;
import java.util.concurrent.CompletableFuture;

public final class NetworkAccessAuthorizationFunctions {
    /**
    ...
    public static Output<GetRuleResult> getRule(GetRuleArgs args, InvokeOptions options) {
        return Deployment.getInstance().invoke("ise:NetworkAccessAuthorization/getRule:getRule", TypeShape.of(GetRuleResult.class), args, Utilities.withVersion(options));
    }
    /**
     * This data source can read the Network Access Authorization Rule.
     * 
    ...
    public static CompletableFuture<GetRuleResult> getRulePlain(GetRulePlainArgs args, InvokeOptions options) {
        return Deployment.getInstance().invokeAsync("ise:NetworkAccessAuthorization/getRule:getRule", TypeShape.of(GetRuleResult.class), args, Utilities.withVersion(options));
    }
}
