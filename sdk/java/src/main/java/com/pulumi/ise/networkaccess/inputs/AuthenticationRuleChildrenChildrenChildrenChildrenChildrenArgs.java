...
import com.pulumi.ise.networkaccess.inputs.AuthenticationRuleChildrenChildrenChildrenChildrenChildrenChildrenArgs;
...
public final class AuthenticationRuleChildrenChildrenChildrenChildrenChildrenArgs extends com.pulumi.resources.ResourceArgs {

    public static final AuthenticationRuleChildrenChildrenChildrenChildrenChildrenArgs Empty = new AuthenticationRuleChildrenChildrenChildrenChildrenChildrenArgs();
    ...
    private @Nullable Output<List<AuthenticationRuleChildrenChildrenChildrenChildrenChildrenChildrenArgs>> childrens;

    /**
     * @return List of child conditions
     * 
     */
    public Optional<Output<List<AuthenticationRuleChildrenChildrenChildrenChildrenChildrenChildrenArgs>>> childrens() {
    ...
    private AuthenticationRuleChildrenChildrenChildrenChildrenChildrenArgs() {}

    private AuthenticationRuleChildrenChildrenChildrenChildrenChildrenArgs(AuthenticationRuleChildrenChildrenChildrenChildrenChildrenArgs $) {
    ...
    public static Builder builder(AuthenticationRuleChildrenChildrenChildrenChildrenChildrenArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AuthenticationRuleChildrenChildrenChildrenChildrenChildrenArgs();
        }

        public Builder(AuthenticationRuleChildrenChildrenChildrenChildrenChildrenArgs defaults) {
            $ = new AuthenticationRuleChildrenChildrenChildrenChildrenChildrenArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder childrens(@Nullable Output<List<AuthenticationRuleChildrenChildrenChildrenChildrenChildrenChildrenArgs>> childrens) {
            $.childrens = childrens;
            return this;
        }
         ...
         * 
         */
        public Builder childrens(List<AuthenticationRuleChildrenChildrenChildrenChildrenChildrenChildrenArgs> childrens) {
         ...
         * 
         */
        public Builder childrens(AuthenticationRuleChildrenChildrenChildrenChildrenChildrenChildrenArgs... childrens) {
        ...
        public AuthenticationRuleChildrenChildrenChildrenChildrenChildrenArgs build() {
            if ($.conditionType == null) {
                throw new MissingRequiredPropertyException("AuthenticationRuleChildrenChildrenChildrenChildrenChildrenArgs", "conditionType");
            }
            return $;
        }
    }
