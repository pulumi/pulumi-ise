...
import com.pulumi.ise.network.AccessAuthorizationExceptionRuleArgs;
import com.pulumi.ise.network.inputs.AccessAuthorizationExceptionRuleState;
import com.pulumi.ise.network.outputs.AccessAuthorizationExceptionRuleChildren;
 ...
 * import com.pulumi.core.Output;
 * import com.pulumi.ise.network.AccessAuthorizationExceptionRule;
 * import com.pulumi.ise.network.AccessAuthorizationExceptionRuleArgs;
 * import java.util.List;
 ...
 *         var example = new AccessAuthorizationExceptionRule(&#34;example&#34;, AccessAuthorizationExceptionRuleArgs.builder()        
 ...
 * 
 */
@ResourceType(type="ise:network/accessAuthorizationExceptionRule:AccessAuthorizationExceptionRule")
public class AccessAuthorizationExceptionRule extends com.pulumi.resources.CustomResource {
    /**
     * List of child conditions. `condition_type` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
     * 
     */
    @Export(name="childrens", refs={List.class,AccessAuthorizationExceptionRuleChildren.class}, tree="[0,1]")
    private Output</* @Nullable */ List<AccessAuthorizationExceptionRuleChildren>> childrens;

    /**
     * @return List of child conditions. `condition_type` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
     * 
     */
    public Output<Optional<List<AccessAuthorizationExceptionRuleChildren>>> childrens() {
     ...
     */
    public AccessAuthorizationExceptionRule(String name) {
        this(name, AccessAuthorizationExceptionRuleArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public AccessAuthorizationExceptionRule(String name, AccessAuthorizationExceptionRuleArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public AccessAuthorizationExceptionRule(String name, AccessAuthorizationExceptionRuleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:network/accessAuthorizationExceptionRule:AccessAuthorizationExceptionRule", name, args == null ? AccessAuthorizationExceptionRuleArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private AccessAuthorizationExceptionRule(String name, Output<String> id, @Nullable AccessAuthorizationExceptionRuleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:network/accessAuthorizationExceptionRule:AccessAuthorizationExceptionRule", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static AccessAuthorizationExceptionRule get(String name, Output<String> id, @Nullable AccessAuthorizationExceptionRuleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
