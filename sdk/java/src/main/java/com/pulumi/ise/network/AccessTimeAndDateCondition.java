...
import com.pulumi.ise.network.AccessTimeAndDateConditionArgs;
import com.pulumi.ise.network.inputs.AccessTimeAndDateConditionState;
 ...
 * import com.pulumi.core.Output;
 * import com.pulumi.ise.network.AccessTimeAndDateCondition;
 * import com.pulumi.ise.network.AccessTimeAndDateConditionArgs;
 * import java.util.List;
 ...
 *         var example = new AccessTimeAndDateCondition(&#34;example&#34;, AccessTimeAndDateConditionArgs.builder()        
 *             .name(&#34;Cond1&#34;)
 ...
 * 
 */
@ResourceType(type="ise:network/accessTimeAndDateCondition:AccessTimeAndDateCondition")
public class AccessTimeAndDateCondition extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public AccessTimeAndDateCondition(String name) {
        this(name, AccessTimeAndDateConditionArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public AccessTimeAndDateCondition(String name, @Nullable AccessTimeAndDateConditionArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public AccessTimeAndDateCondition(String name, @Nullable AccessTimeAndDateConditionArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:network/accessTimeAndDateCondition:AccessTimeAndDateCondition", name, args == null ? AccessTimeAndDateConditionArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private AccessTimeAndDateCondition(String name, Output<String> id, @Nullable AccessTimeAndDateConditionState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:network/accessTimeAndDateCondition:AccessTimeAndDateCondition", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static AccessTimeAndDateCondition get(String name, Output<String> id, @Nullable AccessTimeAndDateConditionState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
