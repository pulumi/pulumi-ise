...
import com.pulumi.ise.networkaccess.inputs.TimeAndDateConditionState;
 ...
 * 
 */
@ResourceType(type="ise:networkaccess/timeAndDateCondition:TimeAndDateCondition")
public class TimeAndDateCondition extends com.pulumi.resources.CustomResource {
     ...
     */
    public TimeAndDateCondition(java.lang.String name) {
     ...
     */
    public TimeAndDateCondition(java.lang.String name, @Nullable TimeAndDateConditionArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public TimeAndDateCondition(java.lang.String name, @Nullable TimeAndDateConditionArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:networkaccess/timeAndDateCondition:TimeAndDateCondition", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private TimeAndDateCondition(java.lang.String name, Output<java.lang.String> id, @Nullable TimeAndDateConditionState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:networkaccess/timeAndDateCondition:TimeAndDateCondition", name, state, makeResourceOptions(options, id), false);
    }

    private static TimeAndDateConditionArgs makeArgs(@Nullable TimeAndDateConditionArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? TimeAndDateConditionArgs.Empty : args;
    }
     ...
     */
    public static TimeAndDateCondition get(java.lang.String name, Output<java.lang.String> id, @Nullable TimeAndDateConditionState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
