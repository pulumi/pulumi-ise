...
import com.pulumi.ise.networkaccess.inputs.PolicySetUpdateRankState;
 ...
 * 
 */
@ResourceType(type="ise:networkaccess/policySetUpdateRank:PolicySetUpdateRank")
public class PolicySetUpdateRank extends com.pulumi.resources.CustomResource {
    ...
    public PolicySetUpdateRank(java.lang.String name, PolicySetUpdateRankArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:networkaccess/policySetUpdateRank:PolicySetUpdateRank", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private PolicySetUpdateRank(java.lang.String name, Output<java.lang.String> id, @Nullable PolicySetUpdateRankState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:networkaccess/policySetUpdateRank:PolicySetUpdateRank", name, state, makeResourceOptions(options, id), false);
    }
