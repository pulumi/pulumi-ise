...
package com.pulumi.ise.ActiveDirectoryGroupsBy.inputs;
...
public final class GetDomainArgs extends com.pulumi.resources.InvokeArgs {
    ...
    public static final class Builder {
        ...
        public GetDomainArgs build() {
            if ($.domain == null) {
                throw new MissingRequiredPropertyException("GetDomainArgs", "domain");
            }
            if ($.joinPointId == null) {
                throw new MissingRequiredPropertyException("GetDomainArgs", "joinPointId");
            }
            return $;
        }
    }
