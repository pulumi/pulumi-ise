...
public final class AuthorizationGlobalExceptionRuleChildrenChildrenChildrenChildrenChildrenChildrenArgs extends com.pulumi.resources.ResourceArgs {

    public static final AuthorizationGlobalExceptionRuleChildrenChildrenChildrenChildrenChildrenChildrenArgs Empty = new AuthorizationGlobalExceptionRuleChildrenChildrenChildrenChildrenChildrenChildrenArgs();
    ...
    private AuthorizationGlobalExceptionRuleChildrenChildrenChildrenChildrenChildrenChildrenArgs() {}

    private AuthorizationGlobalExceptionRuleChildrenChildrenChildrenChildrenChildrenChildrenArgs(AuthorizationGlobalExceptionRuleChildrenChildrenChildrenChildrenChildrenChildrenArgs $) {
    ...
    public static Builder builder(AuthorizationGlobalExceptionRuleChildrenChildrenChildrenChildrenChildrenChildrenArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AuthorizationGlobalExceptionRuleChildrenChildrenChildrenChildrenChildrenChildrenArgs();
        }

        public Builder(AuthorizationGlobalExceptionRuleChildrenChildrenChildrenChildrenChildrenChildrenArgs defaults) {
            $ = new AuthorizationGlobalExceptionRuleChildrenChildrenChildrenChildrenChildrenChildrenArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AuthorizationGlobalExceptionRuleChildrenChildrenChildrenChildrenChildrenChildrenArgs build() {
            if ($.conditionType == null) {
                throw new MissingRequiredPropertyException("AuthorizationGlobalExceptionRuleChildrenChildrenChildrenChildrenChildrenChildrenArgs", "conditionType");
            }
            return $;
        }
    }
