...
import com.pulumi.ise.DeviceAdminAuthorizationGlobalException.inputs.RuleChildrenChildrenArgs;
...
public final class RuleChildrenArgs extends com.pulumi.resources.ResourceArgs {

    public static final RuleChildrenArgs Empty = new RuleChildrenArgs();
    ...
    private @Nullable Output<List<RuleChildrenChildrenArgs>> childrens;

    /**
     * @return List of child conditions. `condition_type` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
     * 
     */
    public Optional<Output<List<RuleChildrenChildrenArgs>>> childrens() {
    ...
    private RuleChildrenArgs() {}

    private RuleChildrenArgs(RuleChildrenArgs $) {
    ...
    public static Builder builder(RuleChildrenArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RuleChildrenArgs();
        }

        public Builder(RuleChildrenArgs defaults) {
            $ = new RuleChildrenArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder childrens(@Nullable Output<List<RuleChildrenChildrenArgs>> childrens) {
            $.childrens = childrens;
            return this;
        }
         ...
         * 
         */
        public Builder childrens(List<RuleChildrenChildrenArgs> childrens) {
         ...
         * 
         */
        public Builder childrens(RuleChildrenChildrenArgs... childrens) {
        ...
        public RuleChildrenArgs build() {
            if ($.conditionType == null) {
                throw new MissingRequiredPropertyException("RuleChildrenArgs", "conditionType");
            }
            return $;
        }
    }
