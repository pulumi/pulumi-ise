...
import com.pulumi.ise.networkaccess.outputs.AuthorizationGlobalExceptionRuleChildrenChildrenChildrenChildrenChildrenChildren;
...
@CustomType
public final class AuthorizationGlobalExceptionRuleChildrenChildrenChildrenChildrenChildren {
    /**
     ...
     * 
     */
    private @Nullable List<AuthorizationGlobalExceptionRuleChildrenChildrenChildrenChildrenChildrenChildren> childrens;
    /**
    ...
    private AuthorizationGlobalExceptionRuleChildrenChildrenChildrenChildrenChildren() {}
    /**
     * @return Dictionary attribute name
     * 
     */
     ...
     * 
     */
    public List<AuthorizationGlobalExceptionRuleChildrenChildrenChildrenChildrenChildrenChildren> childrens() {
    ...
    public static Builder builder(AuthorizationGlobalExceptionRuleChildrenChildrenChildrenChildrenChildren defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String operator;
        public Builder() {}
        public Builder(AuthorizationGlobalExceptionRuleChildrenChildrenChildrenChildrenChildren defaults) {
        ...
        @CustomType.Setter
        public Builder childrens(@Nullable List<AuthorizationGlobalExceptionRuleChildrenChildrenChildrenChildrenChildrenChildren> childrens) {

            this.childrens = childrens;
            return this;
        }
        public Builder childrens(AuthorizationGlobalExceptionRuleChildrenChildrenChildrenChildrenChildrenChildren... childrens) {
            return childrens(List.of(childrens));
        }
        @CustomType.Setter
        public Builder conditionType(String conditionType) {
            if (conditionType == null) {
              throw new MissingRequiredPropertyException("AuthorizationGlobalExceptionRuleChildrenChildrenChildrenChildrenChildren", "conditionType");
            }
        ...
        public AuthorizationGlobalExceptionRuleChildrenChildrenChildrenChildrenChildren build() {
            final var _resultValue = new AuthorizationGlobalExceptionRuleChildrenChildrenChildrenChildrenChildren();
