...
public final class GetActiveDirectoryGroupsByDomainPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetActiveDirectoryGroupsByDomainPlainArgs Empty = new GetActiveDirectoryGroupsByDomainPlainArgs();
    ...
    private GetActiveDirectoryGroupsByDomainPlainArgs() {}

    private GetActiveDirectoryGroupsByDomainPlainArgs(GetActiveDirectoryGroupsByDomainPlainArgs $) {
        this.domain = $.domain;
        this.filter = $.filter;
    ...
    public static Builder builder(GetActiveDirectoryGroupsByDomainPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetActiveDirectoryGroupsByDomainPlainArgs();
        }

        public Builder(GetActiveDirectoryGroupsByDomainPlainArgs defaults) {
            $ = new GetActiveDirectoryGroupsByDomainPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetActiveDirectoryGroupsByDomainPlainArgs build() {
            if ($.domain == null) {
                throw new MissingRequiredPropertyException("GetActiveDirectoryGroupsByDomainPlainArgs", "domain");
            }
            if ($.joinPointId == null) {
                throw new MissingRequiredPropertyException("GetActiveDirectoryGroupsByDomainPlainArgs", "joinPointId");
            }
            return $;
        }
    }
