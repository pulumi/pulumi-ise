...
public final class ProtocolsState extends com.pulumi.resources.ResourceArgs {

    public static final ProtocolsState Empty = new ProtocolsState();
    ...
    private ProtocolsState() {}

    private ProtocolsState(ProtocolsState $) {
    ...
    public static Builder builder(ProtocolsState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ProtocolsState defaults) {
            $ = new ProtocolsState(Objects.requireNonNull(defaults));
        }
