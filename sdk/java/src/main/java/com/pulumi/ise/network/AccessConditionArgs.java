...
import com.pulumi.ise.network.inputs.AccessConditionChildrenArgs;
...
public final class AccessConditionArgs extends com.pulumi.resources.ResourceArgs {

    public static final AccessConditionArgs Empty = new AccessConditionArgs();
    ...
    private @Nullable Output<List<AccessConditionChildrenArgs>> childrens;

    /**
     * @return List of child conditions. `condition_type` must be one of `LibraryConditionAndBlock` or `LibraryConditionOrBlock`.
     * 
     */
    public Optional<Output<List<AccessConditionChildrenArgs>>> childrens() {
    ...
    private AccessConditionArgs() {}

    private AccessConditionArgs(AccessConditionArgs $) {
    ...
    public static Builder builder(AccessConditionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AccessConditionArgs();
        }

        public Builder(AccessConditionArgs defaults) {
            $ = new AccessConditionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder childrens(@Nullable Output<List<AccessConditionChildrenArgs>> childrens) {
            $.childrens = childrens;
            return this;
        }
         ...
         * 
         */
        public Builder childrens(List<AccessConditionChildrenArgs> childrens) {
         ...
         * 
         */
        public Builder childrens(AccessConditionChildrenArgs... childrens) {
        ...
        public AccessConditionArgs build() {
            if ($.conditionType == null) {
                throw new MissingRequiredPropertyException("AccessConditionArgs", "conditionType");
            }
            return $;
        }
    }
