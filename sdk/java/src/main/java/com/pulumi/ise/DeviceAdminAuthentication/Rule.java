...
package com.pulumi.ise.DeviceAdminAuthentication;
...
import com.pulumi.ise.DeviceAdminAuthentication.inputs.RuleState;
import com.pulumi.ise.DeviceAdminAuthentication.outputs.RuleChildren;
 ...
 * 
 */
@ResourceType(type="ise:DeviceAdminAuthentication/rule:Rule")
public class Rule extends com.pulumi.resources.CustomResource {
    ...
    public Rule(String name, RuleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:DeviceAdminAuthentication/rule:Rule", name, args == null ? RuleArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private Rule(String name, Output<String> id, @Nullable RuleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ise:DeviceAdminAuthentication/rule:Rule", name, state, makeResourceOptions(options, id));
    }
