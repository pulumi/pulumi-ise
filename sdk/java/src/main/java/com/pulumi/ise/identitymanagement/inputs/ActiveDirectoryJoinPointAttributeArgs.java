...
public final class ActiveDirectoryJoinPointAttributeArgs extends com.pulumi.resources.ResourceArgs {

    public static final ActiveDirectoryJoinPointAttributeArgs Empty = new ActiveDirectoryJoinPointAttributeArgs();
    ...
    private ActiveDirectoryJoinPointAttributeArgs() {}

    private ActiveDirectoryJoinPointAttributeArgs(ActiveDirectoryJoinPointAttributeArgs $) {
    ...
    public static Builder builder(ActiveDirectoryJoinPointAttributeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ActiveDirectoryJoinPointAttributeArgs();
        }

        public Builder(ActiveDirectoryJoinPointAttributeArgs defaults) {
            $ = new ActiveDirectoryJoinPointAttributeArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ActiveDirectoryJoinPointAttributeArgs build() {
            if ($.defaultValue == null) {
                throw new MissingRequiredPropertyException("ActiveDirectoryJoinPointAttributeArgs", "defaultValue");
            }
            if ($.internalName == null) {
                throw new MissingRequiredPropertyException("ActiveDirectoryJoinPointAttributeArgs", "internalName");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("ActiveDirectoryJoinPointAttributeArgs", "name");
            }
            if ($.type == null) {
                throw new MissingRequiredPropertyException("ActiveDirectoryJoinPointAttributeArgs", "type");
            }
            return $;
        }
    }
