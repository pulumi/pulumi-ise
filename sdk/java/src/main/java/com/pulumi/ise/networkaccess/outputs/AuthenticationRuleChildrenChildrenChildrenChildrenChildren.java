...
import com.pulumi.ise.networkaccess.outputs.AuthenticationRuleChildrenChildrenChildrenChildrenChildrenChildren;
...
@CustomType
public final class AuthenticationRuleChildrenChildrenChildrenChildrenChildren {
    /**
     ...
     * 
     */
    private @Nullable List<AuthenticationRuleChildrenChildrenChildrenChildrenChildrenChildren> childrens;
    /**
    ...
    private AuthenticationRuleChildrenChildrenChildrenChildrenChildren() {}
    /**
     * @return Dictionary attribute name
     * 
     */
     ...
     * 
     */
    public List<AuthenticationRuleChildrenChildrenChildrenChildrenChildrenChildren> childrens() {
    ...
    public static Builder builder(AuthenticationRuleChildrenChildrenChildrenChildrenChildren defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String operator;
        public Builder() {}
        public Builder(AuthenticationRuleChildrenChildrenChildrenChildrenChildren defaults) {
        ...
        @CustomType.Setter
        public Builder childrens(@Nullable List<AuthenticationRuleChildrenChildrenChildrenChildrenChildrenChildren> childrens) {

            this.childrens = childrens;
            return this;
        }
        public Builder childrens(AuthenticationRuleChildrenChildrenChildrenChildrenChildrenChildren... childrens) {
            return childrens(List.of(childrens));
        }
        @CustomType.Setter
        public Builder conditionType(String conditionType) {
            if (conditionType == null) {
              throw new MissingRequiredPropertyException("AuthenticationRuleChildrenChildrenChildrenChildrenChildren", "conditionType");
            }
        ...
        public AuthenticationRuleChildrenChildrenChildrenChildrenChildren build() {
            final var _resultValue = new AuthenticationRuleChildrenChildrenChildrenChildrenChildren();
