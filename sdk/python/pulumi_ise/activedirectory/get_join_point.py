...
__all__ = [
    'GetJoinPointResult',
    'AwaitableGetJoinPointResult',
    'get_join_point',
    'get_join_point_output',
]

@pulumi.output_type
class GetJoinPointResult:
    """
    ...
    @property
    @pulumi.getter
    def attributes(self) -> Sequence['outputs.GetJoinPointAttributeResult']:
        """
    ...
    @property
    @pulumi.getter
    def groups(self) -> Sequence['outputs.GetJoinPointGroupResult']:
        """
        List of AD Groups
        """
    ...
    def rewrite_rules(self) -> Sequence['outputs.GetJoinPointRewriteRuleResult']:
        """
...
class AwaitableGetJoinPointResult(GetJoinPointResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetJoinPointResult(
...
def get_join_point(id: Optional[str] = None,
                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetJoinPointResult:
    """
    ...
    example = ise.activeDirectory.get_join_point(id="76d24097-41c4-4558-a4d0-a8c07ac08470")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('ise:activeDirectory/getJoinPoint:getJoinPoint', __args__, opts=opts, typ=GetJoinPointResult).value

    return AwaitableGetJoinPointResult(
...
@_utilities.lift_output_func(get_join_point)
def get_join_point_output(id: Optional[pulumi.Input[str]] = None,
                          opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetJoinPointResult]:
    """
    This data source can read the Active Directory Join Point.
