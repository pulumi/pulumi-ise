...
@pulumi.input_type
class JoinDomainWithAllNodesAdditionalDataArgs:
    def __init__(__self__, *,
                 name: pulumi.Input[str],
...
@pulumi.input_type
class JoinPointRewriteRuleArgs:
    def __init__(__self__, *,
