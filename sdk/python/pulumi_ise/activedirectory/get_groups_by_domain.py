...
__all__ = [
    'GetGroupsByDomainResult',
    'AwaitableGetGroupsByDomainResult',
    'get_groups_by_domain',
    'get_groups_by_domain_output',
]

@pulumi.output_type
class GetGroupsByDomainResult:
    """
    ...
    @property
    @pulumi.getter
    def groups(self) -> Sequence['outputs.GetGroupsByDomainGroupResult']:
        """
        List of groups
        """
...
class AwaitableGetGroupsByDomainResult(GetGroupsByDomainResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetGroupsByDomainResult(
            domain=self.domain,
            filter=self.filter,
            groups=self.groups,
            id=self.id,
...
def get_groups_by_domain(domain: Optional[str] = None,
                         filter: Optional[str] = None,
                         join_point_id: Optional[str] = None,
                         sid_filter: Optional[str] = None,
                         type_filter: Optional[str] = None,
                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetGroupsByDomainResult:
    """
    ...
    example = ise.activeDirectory.get_groups_by_domain(join_point_id="73808580-b6e6-11ee-8960-de6d7692bc40",
        domain="cisco.com",
    ...
    __ret__ = pulumi.runtime.invoke('ise:activeDirectory/getGroupsByDomain:getGroupsByDomain', __args__, opts=opts, typ=GetGroupsByDomainResult).value

    return AwaitableGetGroupsByDomainResult(
...
@_utilities.lift_output_func(get_groups_by_domain)
def get_groups_by_domain_output(domain: Optional[pulumi.Input[str]] = None,
                                ...
                                opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetGroupsByDomainResult]:
    """
    This data source can read the Active Directory Groups By Domain.
