...
__all__ = [
    'GetAccessTimeAndDateConditionResult',
    'AwaitableGetAccessTimeAndDateConditionResult',
    'get_access_time_and_date_condition',
    'get_access_time_and_date_condition_output',
]

@pulumi.output_type
class GetAccessTimeAndDateConditionResult:
    """
...
class AwaitableGetAccessTimeAndDateConditionResult(GetAccessTimeAndDateConditionResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetAccessTimeAndDateConditionResult(
...
def get_access_time_and_date_condition(id: Optional[str] = None,
                                       name: Optional[str] = None,
                                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAccessTimeAndDateConditionResult:
    """
    ...
    example = ise.network.get_access_time_and_date_condition(id="76d24097-41c4-4558-a4d0-a8c07ac08470")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('ise:network/getAccessTimeAndDateCondition:getAccessTimeAndDateCondition', __args__, opts=opts, typ=GetAccessTimeAndDateConditionResult).value

    return AwaitableGetAccessTimeAndDateConditionResult(
...
@_utilities.lift_output_func(get_access_time_and_date_condition)
def get_access_time_and_date_condition_output(id: Optional[pulumi.Input[Optional[str]]] = None,
                                              name: Optional[pulumi.Input[Optional[str]]] = None,
                                              opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetAccessTimeAndDateConditionResult]:
    """
    This data source can read the Network Access Time And Date Condition.
