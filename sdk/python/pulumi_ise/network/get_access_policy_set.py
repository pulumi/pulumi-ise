...
__all__ = [
    'GetAccessPolicySetResult',
    'AwaitableGetAccessPolicySetResult',
    'get_access_policy_set',
    'get_access_policy_set_output',
]

@pulumi.output_type
class GetAccessPolicySetResult:
    """
    ...
    @property
    @pulumi.getter
    def childrens(self) -> Sequence['outputs.GetAccessPolicySetChildrenResult']:
        """
...
class AwaitableGetAccessPolicySetResult(GetAccessPolicySetResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetAccessPolicySetResult(
...
def get_access_policy_set(id: Optional[str] = None,
                          name: Optional[str] = None,
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAccessPolicySetResult:
    """
    ...
    example = ise.network.get_access_policy_set(id="76d24097-41c4-4558-a4d0-a8c07ac08470")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('ise:network/getAccessPolicySet:getAccessPolicySet', __args__, opts=opts, typ=GetAccessPolicySetResult).value

    return AwaitableGetAccessPolicySetResult(
...
@_utilities.lift_output_func(get_access_policy_set)
def get_access_policy_set_output(id: Optional[pulumi.Input[Optional[str]]] = None,
                                 name: Optional[pulumi.Input[Optional[str]]] = None,
                                 opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetAccessPolicySetResult]:
    """
    This data source can read the Network Access Policy Set.
