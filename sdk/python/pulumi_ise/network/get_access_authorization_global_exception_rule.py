...
__all__ = [
    'GetAccessAuthorizationGlobalExceptionRuleResult',
    'AwaitableGetAccessAuthorizationGlobalExceptionRuleResult',
    'get_access_authorization_global_exception_rule',
    'get_access_authorization_global_exception_rule_output',
]

@pulumi.output_type
class GetAccessAuthorizationGlobalExceptionRuleResult:
    """
    ...
    @property
    @pulumi.getter
    def childrens(self) -> Sequence['outputs.GetAccessAuthorizationGlobalExceptionRuleChildrenResult']:
        """
...
class AwaitableGetAccessAuthorizationGlobalExceptionRuleResult(GetAccessAuthorizationGlobalExceptionRuleResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetAccessAuthorizationGlobalExceptionRuleResult(
...
def get_access_authorization_global_exception_rule(id: Optional[str] = None,
                                                   name: Optional[str] = None,
                                                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAccessAuthorizationGlobalExceptionRuleResult:
    """
    ...
    example = ise.network.get_access_authorization_global_exception_rule(id="76d24097-41c4-4558-a4d0-a8c07ac08470")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('ise:network/getAccessAuthorizationGlobalExceptionRule:getAccessAuthorizationGlobalExceptionRule', __args__, opts=opts, typ=GetAccessAuthorizationGlobalExceptionRuleResult).value

    return AwaitableGetAccessAuthorizationGlobalExceptionRuleResult(
...
@_utilities.lift_output_func(get_access_authorization_global_exception_rule)
def get_access_authorization_global_exception_rule_output(id: Optional[pulumi.Input[Optional[str]]] = None,
                                                          name: Optional[pulumi.Input[Optional[str]]] = None,
                                                          opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetAccessAuthorizationGlobalExceptionRuleResult]:
    """
    This data source can read the Network Access Authorization Global Exception Rule.
