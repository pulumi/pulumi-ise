...
def get_allowed_protocols(id: Optional[str] = None,
    ...
    example = ise.network.get_allowed_protocols(id="76d24097-41c4-4558-a4d0-a8c07ac08470")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('ise:network/getAllowedProtocols:getAllowedProtocols', __args__, opts=opts, typ=GetAllowedProtocolsResult).value
