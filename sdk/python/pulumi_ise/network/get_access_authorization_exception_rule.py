...
__all__ = [
    'GetAccessAuthorizationExceptionRuleResult',
    'AwaitableGetAccessAuthorizationExceptionRuleResult',
    'get_access_authorization_exception_rule',
    'get_access_authorization_exception_rule_output',
]

@pulumi.output_type
class GetAccessAuthorizationExceptionRuleResult:
    """
    ...
    @property
    @pulumi.getter
    def childrens(self) -> Sequence['outputs.GetAccessAuthorizationExceptionRuleChildrenResult']:
        """
...
class AwaitableGetAccessAuthorizationExceptionRuleResult(GetAccessAuthorizationExceptionRuleResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetAccessAuthorizationExceptionRuleResult(
...
def get_access_authorization_exception_rule(id: Optional[str] = None,
                                            name: Optional[str] = None,
                                            policy_set_id: Optional[str] = None,
                                            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAccessAuthorizationExceptionRuleResult:
    """
    ...
    example = ise.network.get_access_authorization_exception_rule(id="76d24097-41c4-4558-a4d0-a8c07ac08470",
    ...
    __ret__ = pulumi.runtime.invoke('ise:network/getAccessAuthorizationExceptionRule:getAccessAuthorizationExceptionRule', __args__, opts=opts, typ=GetAccessAuthorizationExceptionRuleResult).value

    return AwaitableGetAccessAuthorizationExceptionRuleResult(
...
@_utilities.lift_output_func(get_access_authorization_exception_rule)
def get_access_authorization_exception_rule_output(id: Optional[pulumi.Input[Optional[str]]] = None,
                                                   name: Optional[pulumi.Input[Optional[str]]] = None,
                                                   policy_set_id: Optional[pulumi.Input[str]] = None,
                                                   opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetAccessAuthorizationExceptionRuleResult]:
    """
    This data source can read the Network Access Authorization Exception Rule.
