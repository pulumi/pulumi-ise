...
def get_downloadable_acl(id: Optional[str] = None,
    ...
    example = ise.network.get_downloadable_acl(id="76d24097-41c4-4558-a4d0-a8c07ac08470")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('ise:network/getDownloadableAcl:getDownloadableAcl', __args__, opts=opts, typ=GetDownloadableAclResult).value
