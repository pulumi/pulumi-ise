...
def get_authorization_profile(id: Optional[str] = None,
    ...
    example = ise.network.get_authorization_profile(id="76d24097-41c4-4558-a4d0-a8c07ac08470")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('ise:network/getAuthorizationProfile:getAuthorizationProfile', __args__, opts=opts, typ=GetAuthorizationProfileResult).value
