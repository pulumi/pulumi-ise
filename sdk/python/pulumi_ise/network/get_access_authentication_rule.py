...
__all__ = [
    'GetAccessAuthenticationRuleResult',
    'AwaitableGetAccessAuthenticationRuleResult',
    'get_access_authentication_rule',
    'get_access_authentication_rule_output',
]

@pulumi.output_type
class GetAccessAuthenticationRuleResult:
    """
    ...
    @property
    @pulumi.getter
    def childrens(self) -> Sequence['outputs.GetAccessAuthenticationRuleChildrenResult']:
        """
...
class AwaitableGetAccessAuthenticationRuleResult(GetAccessAuthenticationRuleResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetAccessAuthenticationRuleResult(
...
def get_access_authentication_rule(id: Optional[str] = None,
                                   name: Optional[str] = None,
                                   policy_set_id: Optional[str] = None,
                                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAccessAuthenticationRuleResult:
    """
    ...
    example = ise.network.get_access_authentication_rule(id="76d24097-41c4-4558-a4d0-a8c07ac08470",
    ...
    __ret__ = pulumi.runtime.invoke('ise:network/getAccessAuthenticationRule:getAccessAuthenticationRule', __args__, opts=opts, typ=GetAccessAuthenticationRuleResult).value

    return AwaitableGetAccessAuthenticationRuleResult(
...
@_utilities.lift_output_func(get_access_authentication_rule)
def get_access_authentication_rule_output(id: Optional[pulumi.Input[Optional[str]]] = None,
                                          name: Optional[pulumi.Input[Optional[str]]] = None,
                                          policy_set_id: Optional[pulumi.Input[str]] = None,
                                          opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetAccessAuthenticationRuleResult]:
    """
    This data source can read the Network Access Authentication Rule.
