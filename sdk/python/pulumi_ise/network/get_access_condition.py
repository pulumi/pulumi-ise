...
__all__ = [
    'GetAccessConditionResult',
    'AwaitableGetAccessConditionResult',
    'get_access_condition',
    'get_access_condition_output',
]

@pulumi.output_type
class GetAccessConditionResult:
    """
    ...
    @property
    @pulumi.getter
    def childrens(self) -> Sequence['outputs.GetAccessConditionChildrenResult']:
        """
...
class AwaitableGetAccessConditionResult(GetAccessConditionResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetAccessConditionResult(
...
def get_access_condition(id: Optional[str] = None,
                         name: Optional[str] = None,
                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAccessConditionResult:
    """
    ...
    example = ise.network.get_access_condition(id="76d24097-41c4-4558-a4d0-a8c07ac08470")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('ise:network/getAccessCondition:getAccessCondition', __args__, opts=opts, typ=GetAccessConditionResult).value

    return AwaitableGetAccessConditionResult(
...
@_utilities.lift_output_func(get_access_condition)
def get_access_condition_output(id: Optional[pulumi.Input[Optional[str]]] = None,
                                name: Optional[pulumi.Input[Optional[str]]] = None,
                                opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetAccessConditionResult]:
    """
    This data source can read the Network Access Condition.
