...
__all__ = [
    'GetAccessAuthorizationRuleResult',
    'AwaitableGetAccessAuthorizationRuleResult',
    'get_access_authorization_rule',
    'get_access_authorization_rule_output',
]

@pulumi.output_type
class GetAccessAuthorizationRuleResult:
    """
    ...
    @property
    @pulumi.getter
    def childrens(self) -> Sequence['outputs.GetAccessAuthorizationRuleChildrenResult']:
        """
...
class AwaitableGetAccessAuthorizationRuleResult(GetAccessAuthorizationRuleResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetAccessAuthorizationRuleResult(
...
def get_access_authorization_rule(id: Optional[str] = None,
                                  name: Optional[str] = None,
                                  policy_set_id: Optional[str] = None,
                                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAccessAuthorizationRuleResult:
    """
    ...
    example = ise.network.get_access_authorization_rule(id="76d24097-41c4-4558-a4d0-a8c07ac08470",
    ...
    __ret__ = pulumi.runtime.invoke('ise:network/getAccessAuthorizationRule:getAccessAuthorizationRule', __args__, opts=opts, typ=GetAccessAuthorizationRuleResult).value

    return AwaitableGetAccessAuthorizationRuleResult(
...
@_utilities.lift_output_func(get_access_authorization_rule)
def get_access_authorization_rule_output(id: Optional[pulumi.Input[Optional[str]]] = None,
                                         name: Optional[pulumi.Input[Optional[str]]] = None,
                                         policy_set_id: Optional[pulumi.Input[str]] = None,
                                         opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetAccessAuthorizationRuleResult]:
    """
    This data source can read the Network Access Authorization Rule.
