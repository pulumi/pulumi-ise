...
class AuthorizationRuleArgs:
    def __init__(__self__, *,
                 ...
                 childrens: pulumi.Input[Optional[Sequence[pulumi.Input['AuthorizationRuleChildrenArgs']]]] = None,
                 command_sets: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['AuthorizationRuleChildrenArgs']]] childrens: List of child conditions
    ...
    @_builtins.property
    @pulumi.getter
    def childrens(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['AuthorizationRuleChildrenArgs']]]]:
        """
    ...
    @childrens.setter
    def childrens(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['AuthorizationRuleChildrenArgs']]]]):
        pulumi.set(self, "childrens", value)

    @_builtins.property
    @pulumi.getter(name="commandSets")
    def command_sets(self) -> pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]:
        """
    ...
    @command_sets.setter
    def command_sets(self, value: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]):
...
class AuthorizationRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 childrens: pulumi.Input[Optional[Sequence[pulumi.Input[Union['AuthorizationRuleChildrenArgs', 'AuthorizationRuleChildrenArgsDict']]]]] = None,
                 command_sets: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 condition_attribute_name: pulumi.Input[Optional[_builtins.str]] = None,
                 condition_attribute_value: pulumi.Input[Optional[_builtins.str]] = None,
                 condition_dictionary_name: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union['AuthorizationRuleChildrenArgs', 'AuthorizationRuleChildrenArgsDict']]]] childrens: List of child conditions
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] command_sets: Command sets enforce the specified list of commands that can be executed by a device administrator
        :param pulumi.Input[_builtins.str] condition_attribute_name: Dictionary attribute name
        :param pulumi.Input[_builtins.str] condition_attribute_value: Attribute value for condition. Value type is specified in dictionary object.
        :param pulumi.Input[_builtins.str] condition_dictionary_name: Dictionary name
    ...
    def get(resource_name: str,
            ...
            profile: pulumi.Input[Optional[_builtins.str]] = None,
            rank: pulumi.Input[Optional[_builtins.int]] = None,
            state: pulumi.Input[Optional[_builtins.str]] = None) -> 'AuthorizationRule':
        """
