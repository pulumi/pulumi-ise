...
def get_identity_source_sequence(id: Optional[str] = None,
    ...
    example = ise.identity.get_identity_source_sequence(id="76d24097-41c4-4558-a4d0-a8c07ac08470")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('ise:identity/getIdentitySourceSequence:getIdentitySourceSequence', __args__, opts=opts, typ=GetIdentitySourceSequenceResult).value
