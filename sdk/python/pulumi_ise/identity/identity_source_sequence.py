...
class IdentitySourceSequence(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example = ise.identity.IdentitySourceSequence("example",
            name="Sequence1",
            ...
            identity_sources=[ise.identity.IdentitySourceSequenceIdentitySourceArgs(
                name="Internal Users",
                order=1,
            )])
        ```
    ...
    def _internal_init(__self__,
        ...
        super(IdentitySourceSequence, __self__).__init__(
            'ise:identity/identitySourceSequence:IdentitySourceSequence',
            resource_name,
            __props__,
            opts)
