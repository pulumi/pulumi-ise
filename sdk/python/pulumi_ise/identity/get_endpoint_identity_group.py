...
def get_endpoint_identity_group(id: Optional[str] = None,
    ...
    example = ise.identity.get_endpoint_identity_group(id="76d24097-41c4-4558-a4d0-a8c07ac08470")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('ise:identity/getEndpointIdentityGroup:getEndpointIdentityGroup', __args__, opts=opts, typ=GetEndpointIdentityGroupResult).value
