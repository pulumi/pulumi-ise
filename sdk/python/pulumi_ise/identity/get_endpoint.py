...
def get_endpoint(id: Optional[str] = None,
    ...
    example = ise.identity.get_endpoint(id="76d24097-41c4-4558-a4d0-a8c07ac08470")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('ise:identity/getEndpoint:getEndpoint', __args__, opts=opts, typ=GetEndpointResult).value
