...
def get_certificate_authentication_profile(id: Optional[str] = None,
    ...
    example = ise.identity.get_certificate_authentication_profile(id="76d24097-41c4-4558-a4d0-a8c07ac08470")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('ise:identity/getCertificateAuthenticationProfile:getCertificateAuthenticationProfile', __args__, opts=opts, typ=GetCertificateAuthenticationProfileResult).value
