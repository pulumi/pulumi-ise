...
def get_internal_user(id: Optional[str] = None,
    ...
    example = ise.identity.get_internal_user(id="76d24097-41c4-4558-a4d0-a8c07ac08470")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('ise:identity/getInternalUser:getInternalUser', __args__, opts=opts, typ=GetInternalUserResult).value
