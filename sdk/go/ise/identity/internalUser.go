...
//			_, err := identity.NewInternalUser(ctx, "example", &identity.InternalUserArgs{
...
func NewInternalUser(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("ise:identity/internalUser:InternalUser", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInternalUser(ctx *pulumi.Context,
	...
	var resource InternalUser
	err := ctx.ReadResource("ise:identity/internalUser:InternalUser", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
