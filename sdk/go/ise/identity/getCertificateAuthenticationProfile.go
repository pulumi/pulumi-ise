...
//			_, err := identity.LookupCertificateAuthenticationProfile(ctx, &identity.LookupCertificateAuthenticationProfileArgs{
...
func LookupCertificateAuthenticationProfile(ctx *pulumi.Context, args *LookupCertificateAuthenticationProfileArgs, opts ...pulumi.InvokeOption) (*LookupCertificateAuthenticationProfileResult, error) {
	...
	err := ctx.Invoke("ise:identity/getCertificateAuthenticationProfile:getCertificateAuthenticationProfile", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
