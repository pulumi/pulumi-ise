...
//			_, err := identity.NewCertificateAuthenticationProfile(ctx, "example", &identity.CertificateAuthenticationProfileArgs{
...
func NewCertificateAuthenticationProfile(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("ise:identity/certificateAuthenticationProfile:CertificateAuthenticationProfile", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCertificateAuthenticationProfile(ctx *pulumi.Context,
	...
	var resource CertificateAuthenticationProfile
	err := ctx.ReadResource("ise:identity/certificateAuthenticationProfile:CertificateAuthenticationProfile", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
