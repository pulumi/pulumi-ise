...
//			_, err := identity.LookupInternalUser(ctx, &identity.LookupInternalUserArgs{
...
func LookupInternalUser(ctx *pulumi.Context, args *LookupInternalUserArgs, opts ...pulumi.InvokeOption) (*LookupInternalUserResult, error) {
	...
	err := ctx.Invoke("ise:identity/getInternalUser:getInternalUser", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupInternalUserOutput(ctx *pulumi.Context, args LookupInternalUserOutputArgs, opts ...pulumi.InvokeOption) LookupInternalUserResultOutput {
	return pulumi.ToOutputWithContext(context.Background(), args).
		ApplyT(func(v interface{}) (LookupInternalUserResult, error) {
			args := v.(LookupInternalUserArgs)
			r, err := LookupInternalUser(ctx, &args, opts...)
			var s LookupInternalUserResult
			if r != nil {
				s = *r
			}
			return s, err
