...
//			_, err := identity.NewIdentitySourceSequence(ctx, "example", &identity.IdentitySourceSequenceArgs{
...
//				IdentitySources: identity.IdentitySourceSequenceIdentitySourceArray{
//					&identity.IdentitySourceSequenceIdentitySourceArgs{
...
func NewIdentitySourceSequence(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("ise:identity/identitySourceSequence:IdentitySourceSequence", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIdentitySourceSequence(ctx *pulumi.Context,
	...
	var resource IdentitySourceSequence
	err := ctx.ReadResource("ise:identity/identitySourceSequence:IdentitySourceSequence", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
