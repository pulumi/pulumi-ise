...
//			_, err := identity.LookupUserIdentityGroup(ctx, &identity.LookupUserIdentityGroupArgs{
...
func LookupUserIdentityGroup(ctx *pulumi.Context, args *LookupUserIdentityGroupArgs, opts ...pulumi.InvokeOption) (*LookupUserIdentityGroupResult, error) {
	...
	err := ctx.Invoke("ise:identity/getUserIdentityGroup:getUserIdentityGroup", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupUserIdentityGroupOutput(ctx *pulumi.Context, args LookupUserIdentityGroupOutputArgs, opts ...pulumi.InvokeOption) LookupUserIdentityGroupResultOutput {
	return pulumi.ToOutputWithContext(context.Background(), args).
		ApplyT(func(v interface{}) (LookupUserIdentityGroupResult, error) {
			args := v.(LookupUserIdentityGroupArgs)
			r, err := LookupUserIdentityGroup(ctx, &args, opts...)
			var s LookupUserIdentityGroupResult
			if r != nil {
				s = *r
			}
			return s, err
