...
func NewGroup(ctx *pulumi.Context,
	...
	var resource Group
	err := ctx.RegisterResource("ise:TrustsecSecurity/group:Group", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGroup(ctx *pulumi.Context,
	...
	var resource Group
	err := ctx.ReadResource("ise:TrustsecSecurity/group:Group", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Read-only - Default value: `false`
func (o GroupOutput) IsReadOnly() pulumi.BoolOutput {
	return o.ApplyT(func(v *Group) pulumi.BoolOutput { return v.IsReadOnly }).(pulumi.BoolOutput)
}
...
// Propagate to APIC (ACI)
func (o GroupOutput) PropogateToApic() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *Group) pulumi.BoolPtrOutput { return v.PropogateToApic }).(pulumi.BoolPtrOutput)
}

// `-1` to auto-generate - Range: `-1`-`65519`
func (o GroupOutput) Value() pulumi.IntOutput {
	return o.ApplyT(func(v *Group) pulumi.IntOutput { return v.Value }).(pulumi.IntOutput)
}
