...
func NewRule(ctx *pulumi.Context,
	...
	var resource Rule
	err := ctx.RegisterResource("ise:NetworkAccessAuthentication/rule:Rule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRule(ctx *pulumi.Context,
	...
	var resource Rule
	err := ctx.ReadResource("ise:NetworkAccessAuthentication/rule:Rule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Identity source name from the identity stores
func (o RuleOutput) IdentitySourceName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Rule) pulumi.StringPtrOutput { return v.IdentitySourceName }).(pulumi.StringPtrOutput)
}

// Action to perform when authentication fails such as Bad credentials, disabled user and so on - Choices: `REJECT`,
// `DROP`, `CONTINUE`
func (o RuleOutput) IfAuthFail() pulumi.StringOutput {
	return o.ApplyT(func(v *Rule) pulumi.StringOutput { return v.IfAuthFail }).(pulumi.StringOutput)
}

// Action to perform when ISE is uanble to access the identity database - Choices: `REJECT`, `DROP`, `CONTINUE`
func (o RuleOutput) IfProcessFail() pulumi.StringOutput {
	return o.ApplyT(func(v *Rule) pulumi.StringOutput { return v.IfProcessFail }).(pulumi.StringOutput)
}

// Action to perform when user is not found in any of identity stores - Choices: `REJECT`, `DROP`, `CONTINUE`
func (o RuleOutput) IfUserNotFound() pulumi.StringOutput {
	return o.ApplyT(func(v *Rule) pulumi.StringOutput { return v.IfUserNotFound }).(pulumi.StringOutput)
}
