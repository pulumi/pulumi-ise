...
func NewRule(ctx *pulumi.Context,
	...
	var resource Rule
	err := ctx.RegisterResource("ise:NetworkAccessAuthorizationException/rule:Rule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRule(ctx *pulumi.Context,
	...
	var resource Rule
	err := ctx.ReadResource("ise:NetworkAccessAuthorizationException/rule:Rule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The authorization profile(s)
func (o RuleOutput) Profiles() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *Rule) pulumi.StringArrayOutput { return v.Profiles }).(pulumi.StringArrayOutput)
}
...
// Security group used in authorization policies
func (o RuleOutput) SecurityGroup() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Rule) pulumi.StringPtrOutput { return v.SecurityGroup }).(pulumi.StringPtrOutput)
}
