...
func NewSet(ctx *pulumi.Context,
	...
	var resource Set
	err := ctx.RegisterResource("ise:NetworkAccessPolicy/set:Set", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSet(ctx *pulumi.Context,
	...
	var resource Set
	err := ctx.ReadResource("ise:NetworkAccessPolicy/set:Set", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
