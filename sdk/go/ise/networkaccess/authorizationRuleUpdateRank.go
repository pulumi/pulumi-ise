...
func NewAuthorizationRuleUpdateRank(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("ise:networkaccess/authorizationRuleUpdateRank:AuthorizationRuleUpdateRank", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAuthorizationRuleUpdateRank(ctx *pulumi.Context,
	...
	var resource AuthorizationRuleUpdateRank
	err := ctx.ReadResource("ise:networkaccess/authorizationRuleUpdateRank:AuthorizationRuleUpdateRank", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
