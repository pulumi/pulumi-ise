...
func LookupAuthorizationRule(ctx *pulumi.Context, args *LookupAuthorizationRuleArgs, opts ...pulumi.InvokeOption) (*LookupAuthorizationRuleResult, error) {
	...
	err := ctx.Invoke("ise:networkaccess/getAuthorizationRule:getAuthorizationRule", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupAuthorizationRuleOutput(ctx *pulumi.Context, args LookupAuthorizationRuleOutputArgs, opts ...pulumi.InvokeOption) LookupAuthorizationRuleResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupAuthorizationRuleResultOutput, error) {
			...
			return ctx.InvokeOutput("ise:networkaccess/getAuthorizationRule:getAuthorizationRule", args, LookupAuthorizationRuleResultOutput{}, options).(LookupAuthorizationRuleResultOutput), nil
...
// The authorization profile(s)
func (o LookupAuthorizationRuleResultOutput) Profiles() pulumi.StringArrayOutput {
	return o.ApplyT(func(v LookupAuthorizationRuleResult) []string { return v.Profiles }).(pulumi.StringArrayOutput)
}
...
// Security group used in authorization policies
func (o LookupAuthorizationRuleResultOutput) SecurityGroup() pulumi.StringOutput {
	return o.ApplyT(func(v LookupAuthorizationRuleResult) string { return v.SecurityGroup }).(pulumi.StringOutput)
}
