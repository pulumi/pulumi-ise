...
func LookupAuthenticationRule(ctx *pulumi.Context, args *LookupAuthenticationRuleArgs, opts ...pulumi.InvokeOption) (*LookupAuthenticationRuleResult, error) {
	...
	err := ctx.Invoke("ise:networkaccess/getAuthenticationRule:getAuthenticationRule", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupAuthenticationRuleOutput(ctx *pulumi.Context, args LookupAuthenticationRuleOutputArgs, opts ...pulumi.InvokeOption) LookupAuthenticationRuleResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupAuthenticationRuleResultOutput, error) {
			...
			return ctx.InvokeOutput("ise:networkaccess/getAuthenticationRule:getAuthenticationRule", args, LookupAuthenticationRuleResultOutput{}, options).(LookupAuthenticationRuleResultOutput), nil
