...
func NewPolicySetUpdateRank(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("ise:networkaccess/policySetUpdateRank:PolicySetUpdateRank", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPolicySetUpdateRank(ctx *pulumi.Context,
	...
	var resource PolicySetUpdateRank
	err := ctx.ReadResource("ise:networkaccess/policySetUpdateRank:PolicySetUpdateRank", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
