...
func NewPolicySetUpdateRanks(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("ise:networkaccess/policySetUpdateRanks:PolicySetUpdateRanks", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPolicySetUpdateRanks(ctx *pulumi.Context,
	...
	var resource PolicySetUpdateRanks
	err := ctx.ReadResource("ise:networkaccess/policySetUpdateRanks:PolicySetUpdateRanks", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
