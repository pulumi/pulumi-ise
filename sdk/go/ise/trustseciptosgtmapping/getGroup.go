...
func LookupGroup(ctx *pulumi.Context, args *LookupGroupArgs, opts ...pulumi.InvokeOption) (*LookupGroupResult, error) {
	...
	err := ctx.Invoke("ise:TrustsecIpToSgtMapping/getGroup:getGroup", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
// Mandatory unless `deployType` is `ALL`
func (o LookupGroupResultOutput) DeployTo() pulumi.StringOutput {
	return o.ApplyT(func(v LookupGroupResult) string { return v.DeployTo }).(pulumi.StringOutput)
}

// Deploy Type
func (o LookupGroupResultOutput) DeployType() pulumi.StringOutput {
	return o.ApplyT(func(v LookupGroupResult) string { return v.DeployType }).(pulumi.StringOutput)
}
...
// Trustsec Security Group ID
func (o LookupGroupResultOutput) Sgt() pulumi.StringOutput {
	return o.ApplyT(func(v LookupGroupResult) string { return v.Sgt }).(pulumi.StringOutput)
}
