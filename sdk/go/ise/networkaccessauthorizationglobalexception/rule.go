...
func NewRule(ctx *pulumi.Context,
	...
	var resource Rule
	err := ctx.RegisterResource("ise:NetworkAccessAuthorizationGlobalException/rule:Rule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRule(ctx *pulumi.Context,
	...
	var resource Rule
	err := ctx.ReadResource("ise:NetworkAccessAuthorizationGlobalException/rule:Rule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
