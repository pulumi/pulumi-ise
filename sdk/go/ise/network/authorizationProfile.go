...
//
// ```sh
// $ pulumi import ise:network/authorizationProfile:AuthorizationProfile example "76d24097-41c4-4558-a4d0-a8c07ac08470"
// ```
...
func NewAuthorizationProfile(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("ise:network/authorizationProfile:AuthorizationProfile", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAuthorizationProfile(ctx *pulumi.Context,
	...
	var resource AuthorizationProfile
	err := ctx.ReadResource("ise:network/authorizationProfile:AuthorizationProfile", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
