...
//			_, err := network.NewDownloadableAcl(ctx, "example", &network.DownloadableAclArgs{
...
func NewDownloadableAcl(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("ise:network/downloadableAcl:DownloadableAcl", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDownloadableAcl(ctx *pulumi.Context,
	...
	var resource DownloadableAcl
	err := ctx.ReadResource("ise:network/downloadableAcl:DownloadableAcl", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
