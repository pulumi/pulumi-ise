...
//			_, err := network.NewAllowedProtocols(ctx, "example", &network.AllowedProtocolsArgs{
...
func NewAllowedProtocols(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("ise:network/allowedProtocols:AllowedProtocols", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAllowedProtocols(ctx *pulumi.Context,
	...
	var resource AllowedProtocols
	err := ctx.ReadResource("ise:network/allowedProtocols:AllowedProtocols", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
