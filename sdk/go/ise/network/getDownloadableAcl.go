...
//			_, err := network.LookupDownloadableAcl(ctx, &network.LookupDownloadableAclArgs{
...
func LookupDownloadableAcl(ctx *pulumi.Context, args *LookupDownloadableAclArgs, opts ...pulumi.InvokeOption) (*LookupDownloadableAclResult, error) {
	...
	err := ctx.Invoke("ise:network/getDownloadableAcl:getDownloadableAcl", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
