...
func NewAuthenticationRuleUpdateRank(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("ise:deviceadmin/authenticationRuleUpdateRank:AuthenticationRuleUpdateRank", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAuthenticationRuleUpdateRank(ctx *pulumi.Context,
	...
	var resource AuthenticationRuleUpdateRank
	err := ctx.ReadResource("ise:deviceadmin/authenticationRuleUpdateRank:AuthenticationRuleUpdateRank", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
