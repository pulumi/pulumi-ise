...
func NewAuthorizationRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("ise:deviceadmin/authorizationRule:AuthorizationRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAuthorizationRule(ctx *pulumi.Context,
	...
	var resource AuthorizationRule
	err := ctx.ReadResource("ise:deviceadmin/authorizationRule:AuthorizationRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o AuthorizationRuleOutput) CommandSets() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *AuthorizationRule) pulumi.StringArrayOutput { return v.CommandSets }).(pulumi.StringArrayOutput)
}
...
func (o AuthorizationRuleOutput) Profile() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *AuthorizationRule) pulumi.StringPtrOutput { return v.Profile }).(pulumi.StringPtrOutput)
}
