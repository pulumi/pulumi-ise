...
//			_, err := deviceAdmin.GetTimeAndDateCondition(ctx, &deviceadmin.GetTimeAndDateConditionArgs{
...
func LookupTimeAndDateCondition(ctx *pulumi.Context, args *LookupTimeAndDateConditionArgs, opts ...pulumi.InvokeOption) (*LookupTimeAndDateConditionResult, error) {
	...
	err := ctx.Invoke("ise:deviceAdmin/getTimeAndDateCondition:getTimeAndDateCondition", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
