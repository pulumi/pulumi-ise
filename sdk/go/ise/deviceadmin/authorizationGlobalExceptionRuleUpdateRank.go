...
func NewAuthorizationGlobalExceptionRuleUpdateRank(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("ise:deviceadmin/authorizationGlobalExceptionRuleUpdateRank:AuthorizationGlobalExceptionRuleUpdateRank", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAuthorizationGlobalExceptionRuleUpdateRank(ctx *pulumi.Context,
	...
	var resource AuthorizationGlobalExceptionRuleUpdateRank
	err := ctx.ReadResource("ise:deviceadmin/authorizationGlobalExceptionRuleUpdateRank:AuthorizationGlobalExceptionRuleUpdateRank", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
