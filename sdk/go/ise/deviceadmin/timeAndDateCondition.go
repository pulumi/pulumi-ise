...
func NewTimeAndDateCondition(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("ise:deviceadmin/timeAndDateCondition:TimeAndDateCondition", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTimeAndDateCondition(ctx *pulumi.Context,
	...
	var resource TimeAndDateCondition
	err := ctx.ReadResource("ise:deviceadmin/timeAndDateCondition:TimeAndDateCondition", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
