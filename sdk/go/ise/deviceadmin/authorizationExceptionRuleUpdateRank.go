...
func NewAuthorizationExceptionRuleUpdateRank(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("ise:deviceadmin/authorizationExceptionRuleUpdateRank:AuthorizationExceptionRuleUpdateRank", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAuthorizationExceptionRuleUpdateRank(ctx *pulumi.Context,
	...
	var resource AuthorizationExceptionRuleUpdateRank
	err := ctx.ReadResource("ise:deviceadmin/authorizationExceptionRuleUpdateRank:AuthorizationExceptionRuleUpdateRank", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
