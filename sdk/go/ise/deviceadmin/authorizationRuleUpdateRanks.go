...
func NewAuthorizationRuleUpdateRanks(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("ise:deviceadmin/authorizationRuleUpdateRanks:AuthorizationRuleUpdateRanks", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAuthorizationRuleUpdateRanks(ctx *pulumi.Context,
	...
	var resource AuthorizationRuleUpdateRanks
	err := ctx.ReadResource("ise:deviceadmin/authorizationRuleUpdateRanks:AuthorizationRuleUpdateRanks", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
